try:
    from add_types import IngestionInput, Chunking
...
class IngestAnything:
    ...
    Attributes:
        ...
        collection_name : str, default="IngestAnythingCollection"
    ...
    """
    def __init__(self, qdrant_client: Optional[QdrantClient] = None, async_qdrant_client: Optional[AsyncQdrantClient] = None, collection_name: str = "IngestAnythingCollection", hybrid_search: bool = False, fastembed_model: str = "Qdrant/bm25"):
    ...
    def ingest(
        ...
        docs = SimpleDirectoryReader(input_files=ingestion_input.files_or_dir).load_data()
