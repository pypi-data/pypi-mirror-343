...
import MetaRagTool.Utils.Constants as Constants
import wandb
...
def god_eval(encoder_name, sample_size, qa_sample_ratio, local_mode=False, multi_hop_hardness_factor=0,
    ...
    ragConfig = MyUtils.Init(encoder_name=encoder_name, top_k=top_k, sample_size=sample_size,
                             ...
                             multi_hop_hardness_factor=multi_hop_hardness_factor, judged=judged, useTool=useTool,multi_hop=True)
...
def all_encoders(sample_size=200, qa_sample_ratio=0.5, local_mode=False, multi_hop_hardness_factor=0,
    ...
    for n in names:
        god_eval(encoder_name=n, sample_size=sample_size, qa_sample_ratio=qa_sample_ratio,multi_hop_hardness_factor=multi_hop_hardness_factor,
