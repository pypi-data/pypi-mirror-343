...
import faiss
import numpy as np
from Scripts.RAG.DocumentStructs import MySentence, MyDocument, MyParagraph, MyChunk, ChunkingMethod
from Scripts.Encoders.MyEncoder import MyEncoder
from Scripts.LLM.LLMIdentity import LLMIdentity
from langchain_text_splitters import RecursiveCharacterTextSplitter
import matplotlib.pyplot as plt
from hazm import Normalizer
from Scripts.Encoders.MyReranker import MyReranker
from Scripts.Utils.MyUtils import capped_sent_tokenize, token_len, reflect_vector, remove_duplicates
from Scripts.Utils.MetaRagConfig import MetaRagConfig
...
class MetaRAG:
    ...
    def apply_config(self, ragConfig:MetaRagConfig):
    ...
    def retrieve(self, query, top_k=20, force_basics=False, sum_of_retrieved_token_length_limit=-1):
        ...
        if self.rerank:
            scores = MyReranker.rerank(query, retrieved_chunks)
