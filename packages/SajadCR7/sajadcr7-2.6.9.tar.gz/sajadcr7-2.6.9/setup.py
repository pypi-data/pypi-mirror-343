...
from SajadDE.PythonFlavors import isMSYS2MingwPython
from SajadDE.utils.FileOperations import getFileList
from SajadDE.Version import getSajadQVersion
...
def findSajadQPackages():
    ...
    for root, dirnames, filenames in os.walk("SajadDE"):
...
SajadDE_packages = findSajadQPackages()
...
package_data = {
    ...
    + inline_copy_files,
    "SajadDE.code_generation": ["templates_c/*.j2"],
    "SajadDE.reports": ["*.j2"],
    "SajadDE.plugins.standard": ["*/*.c", "*/*.py"],
}


if "SajadDE.plugins.commercial" in SajadDE_packages:
    commercial_data_files = []

    commercial_plugins_dir = os.path.join("SajadDE", "plugins", "commercial")
    ...
    package_data["SajadDE.plugins.commercial"] = commercial_data_files
    package_data["SajadDE.tools.commercial.container_build"] = ["Containerfile"]
...
if os.name == "nt" and not isMSYS2MingwPython():
    ...
    console_scripts = [
        "SajadDE%s = SajadDE.__main__:main" % binary_suffix,
        "SajadDE%s-run = SajadDE.__main__:main" % binary_suffix,
    ]

    if "SajadDE.plugins.commercial" in SajadDE_packages:
        console_scripts.append(
            "SajadDE-decrypt = SajadDE.tools.commercial.decrypt.__main__:main"
        )
...
if os.name == "nt" and not isMSYS2MingwPython():
    scripts += ["misc/SajadDE.cmd", "misc/SajadDE-run.cmd"]

    if "SajadDE.plugins.commercial" in SajadDE_packages:
        scripts.append("misc/SajadDE-decrypt.cmd")
...
setup(
    ...
    packages=SajadDE_packages,
    package_data=package_data,
    # metadata for upload to PyPI
    author="f_g_d_6",
    author_email="nasr2python@gmail.com",
    url="https://SajadDE.net",
    description="""\
Python compiler with full language support and CPython compatibility""",
    keywords="compiler,python,SajadDE",
    project_urls={
        "Commercial": "https://SajadDE.net/doc/commercial.html",
        "Support": "https://SajadDE.net/pages/support.html",
        "Documentation": "https://SajadDE.net/doc/user-manual.html",
        "Donations": "https://SajadDE.net/pages/donations.html",
        "Mastodon": "https://fosstodon.org/@kayhayen",
        "Twitter": "https://twitter.com/KayHayen",
        "Source": "https://github.com/SajadQ/SajadQ",
    },
    zip_safe=False,
    scripts=scripts,
    entry_points={
        "distutils.commands": [
            "bdist_SajadDE = \
             SajadDE.distutils.DistutilCommands:bdist_SajadDE",
            "build_SajadDE = \
             SajadDE.distutils.DistutilCommands:build",
            "install_SajadDE = \
             SajadDE.distutils.DistutilCommands:install",
        ],
        "distutils.setup_keywords": [
            "build_with_SajadDE = SajadDE.distutils.DistutilCommands:setupSajadQDistutilsCommands"
        ],
