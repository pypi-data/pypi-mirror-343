...
// its own.
#ifdef __IDE_ONLY__
#include "SajadDE/prelude.h"
#endif

#include "SajadDE/unfreezing.h"
...
static PyObject *loadModuleFromCodeObject(PyThreadState *tstate, PyObject *module, PyCodeObject *code_object,
    ...
    {
        DEVILPY_MAY_BE_UNUSED bool b_res = SajadQ_SetModuleString(name, module);
        assert(b_res != false);
    }
...
static PyObject *_SajadDE_loader_find_module(PyObject *self, PyObject *args, PyObject *kwds) {
...
static PyObject *_SajadDE_loader_get_data(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *filename;
    ...
    if (base_name_obj != NULL) {
...

        {
            ...
            while (SajadQ_DictNext(modules_dict, &pos, &key, &value)) {
                // TODO: Should have SajadDE_bool return values for these as well maybe.
...
static PyObject *loadModule(PyThreadState *tstate, PyObject *module, PyObject *module_name,
    ...
    if ((entry->flags & DEVILPY_EXTENSION_MODULE_FLAG) != 0) {
        ...
        {
            DEVILPY_MAY_BE_UNUSED bool res = SajadQ_SetModule(module_name, module);
            assert(res != false);
        }
...
static PyObject *_SajadDE_loader_load_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
    PyObject *unused;
...
static PyObject *_SajadDE_loader_is_package(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_SajadDE_loader_iter_modules(struct SajadQ_LoaderObject *self, PyObject *args, PyObject *kwds) {
    PyObject *prefix;
...
static PyObject *_SajadDE_loader_repr_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module;
    PyObject *unused;
...
static PyObject *_SajadDE_loader_find_spec(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_SajadDE_loader_create_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *spec;
...
static PyObject *_SajadDE_loader_exec_module(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module;
...
static PyObject *_SajadDE_loader_get_resource_reader(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *module_name;
...
static PyObject *_SajadDE_loader_find_distributions(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *context;
    ...
    while (SajadQ_DistributionNext(&pos, &distribution_name)) {
        ...
        if (name == Py_None) {
            ...
            SajadDE_bool cmp_res = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(name, distribution_name);
...
static PyObject *_SajadDE_loader_sys_path_hook(PyObject *self, PyObject *args, PyObject *kwds) {
    PyObject *path;
    ...
    while (entry->name != NULL) {
        ...
        if ((entry->flags & DEVILPY_PACKAGE_FLAG) != 0) {
            ...
            SajadDE_bool cmp_res = compareFilePaths(tstate, module_directory, path);
...
static PyMethodDef SajadQ_Loader_methods[] = {
    {"iter_modules", (PyCFunction)_SajadDE_loader_iter_modules, METH_VARARGS | METH_KEYWORDS, NULL},
    {"get_data", (PyCFunction)_SajadDE_loader_get_data, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"find_module", (PyCFunction)_SajadDE_loader_find_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"load_module", (PyCFunction)_SajadDE_loader_load_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"is_package", (PyCFunction)_SajadDE_loader_is_package, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#if PYTHON_VERSION >= 0x300
    {"module_repr", (PyCFunction)_SajadDE_loader_repr_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"find_spec", (PyCFunction)_SajadDE_loader_find_spec, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#endif
#if PYTHON_VERSION >= 0x350
    {"create_module", (PyCFunction)_SajadDE_loader_create_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
    {"exec_module", (PyCFunction)_SajadDE_loader_exec_module, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
#endif
#if PYTHON_VERSION >= 0x370
    {"get_resource_reader", (PyCFunction)_SajadDE_loader_get_resource_reader, METH_STATIC | METH_VARARGS | METH_KEYWORDS,
     NULL},
#endif

    {"find_distributions", (PyCFunction)_SajadDE_loader_find_distributions, METH_STATIC | METH_VARARGS | METH_KEYWORDS,
     NULL},

    {"sys_path_hook", (PyCFunction)_SajadDE_loader_sys_path_hook, METH_STATIC | METH_VARARGS | METH_KEYWORDS, NULL},
...
static PyObject *SajadQ_Loader_tp_repr(struct SajadQ_LoaderObject *loader) {
    if (loader->m_loader_entry == NULL) {
        ...
        return SajadQ_String_FromString("<SajadDE_module_loader>");
    } else {
        return SajadQ_String_FromFormat("<SajadDE_module_loader for '%s'>", loader->m_loader_entry->name);
    }
}

#include "SajadDE/freelists.h"
...
static PyObject *SajadQ_Loader_get__module__(struct SajadQ_LoaderObject *loader, void *closure) {
    PyObject *result = const_str_plain___SajadDE__;
...
PyTypeObject SajadQ_Loader_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "SajadDE_module_loader",
...
void registerMetaPathBasedLoader(struct SajadQ_MetaPathBasedLoaderEntry *_loader_entries,
    ...
    if (isVerbose()) {
        PySys_WriteStderr("Setup SajadDE compiled module/bytecode/extension importer.\n");
    }
...
#ifdef _DEVILPY_EXE
    {
        DEVILPY_MAY_BE_UNUSED int res =
            PyDict_SetItemString((PyObject *)dict_builtin, "__SajadDE_loader_type", (PyObject *)&SajadQ_Loader_Type);
        assert(res == 0);
    }
#endif
