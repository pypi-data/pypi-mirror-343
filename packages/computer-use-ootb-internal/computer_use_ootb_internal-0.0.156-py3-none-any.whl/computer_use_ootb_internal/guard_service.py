    ...
    def _trigger_start_for_user(self, username):
        ...
        try:
            ...
            try:
                ...
                # Format for array element: '<content_with_quotes_escaped_for_inner_single_quotes>'
                cmd_k_second_arg_content = f'""{target_exe_for_ps}"" --port {calculated_port} --target_user ''{user}''' # Doubled single quotes for user
