    ...
    def _trigger_start_for_user(self, username):
        ...
        try:
            ...
            try:
                ...
                # Format exactly like the working command: "<exe_path>" --port <port> --target_user ''<user>''
                cmd_k_second_arg_content = f'""{target_exe_for_ps}"" --port {calculated_port} --target_user ''{user}''' # Use Python's f-string interpolation correctly
