...
def run_preparation(state):
    ...
    try:
        ...
        click_x_1 = int(screen_width * (1210 / 1280))
        click_y_1 = int(screen_height * (80 / 720))
        log.info(f"Calculated click coordinates for closing the browser warning: ({click_x_1}, {click_y_1})")
        click_x_2 = int(screen_width * (1036 / 1280))
        click_y_2 = int(screen_height * (500 / 720))
        log.info(f"Calculated click coordinates for starting the game: ({click_x_2}, {click_y_2})")
        ...
        time.sleep(2)
        pyautogui.click(click_x_2, click_y_2) # Double click?
