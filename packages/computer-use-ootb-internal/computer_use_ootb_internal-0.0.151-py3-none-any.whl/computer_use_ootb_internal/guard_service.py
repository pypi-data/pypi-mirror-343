    ...
    def _trigger_start_for_user(self, username):
        ...
        try:
            ...
            try:
                ...
                # Arguments as a simple string, ensure username is single-quoted
                arguments_for_ps = f'--port {calculated_port} --target_user \'{user}\''.replace("'", "''") # Escape single quotes for PS
