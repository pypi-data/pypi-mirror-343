...
const FMViewComponent = (props, ref) => {
    ...
    const onActionComplete = (args) => {
        ...
        if (args.action === "read" && args.cwd && Array.isArray(args.files)) {
            ...
            const depth = path.split("/").filter((seg) => seg).length;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "control-section", style: { height: "100%", width: '100%' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_syncfusion_ej2_react_filemanager__WEBPACK_IMPORTED_MODULE_1__.FileManagerComponent, { ref: fileManagerRef, id: "file", ajaxSettings: ajaxSettings, beforeSend: onBeforeSend.bind(undefined), success: onActionComplete.bind(undefined), toolbarSettings: {
...
//# sourceMappingURL=lib_index_js.a3f628bc924d37593271.js.map