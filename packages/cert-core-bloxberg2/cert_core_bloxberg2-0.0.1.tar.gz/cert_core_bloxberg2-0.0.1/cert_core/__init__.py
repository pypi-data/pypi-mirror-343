...
CHAIN_ARBITRUM_SEPOLIA = 'arbitrumSepolia'
SYS_CHAIN_ARBITRUM_SEPOLIA = 'arbitrum_sepolia'
...
class Chain(Enum):
    ...
    arbitrum_sepolia = 8, BlockchainType.ethereum, CHAIN_ARBITRUM_SEPOLIA
    ...
    def parse_from_chain(chain_string):
        ...
        elif chain_string == SYS_CHAIN_ARBITRUM_SEPOLIA:
