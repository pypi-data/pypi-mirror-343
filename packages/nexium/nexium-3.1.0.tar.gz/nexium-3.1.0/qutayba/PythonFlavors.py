...
def isnexiumPython():
    """Is this our own fork of CPython named nexium-Python."""

    # spell-checker: ignore qutaybapython

    if python_version >= 0x300:
        return sys.implementation.name == "qutaybapython"
    else:
        return sys.subversion[0] == "qutaybapython"
