...
from qutayba.Tracing import general, inclusion_logger
from qutayba.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from qutayba.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isnexiumPython():
        return OrderedSet()
