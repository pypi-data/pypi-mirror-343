...
In the "qutayba.tree.TreeHelpers" module, the dispatching is happening. One function
...
from qutayba import ModuleRegistry, OutputDirectories, SourceCodeReferences
from qutayba.__past__ import long, unicode
from qutayba.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from qutayba.Bytecodes import loadCodeObjectData
from qutayba.containers.OrderedSets import OrderedSet
from qutayba.Errors import CodeTooComplexCode
from qutayba.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from qutayba.importing import Importing
from qutayba.importing.ImportCache import addImportedModule
from qutayba.importing.PreloadedPackages import getPthImportedPackages
...
from qutayba.nodes.BuiltinRefNodes import quick_names
from qutayba.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
...
from qutayba.nodes.GeneratorNodes import (
...
from qutayba.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from qutayba.nodes.ModuleNodes import (
...
from qutayba.nodes.OperatorNodesUnary import makeExpressionOperationUnary
from qutayba.nodes.ReturnNodes import makeStatementReturn
from qutayba.nodes.SliceNodes import makeExpressionBuiltinSlice
from qutayba.nodes.StatementNodes import StatementExpressionOnly
from qutayba.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from qutayba.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from qutayba.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from qutayba.pgo.PGO import decideCompilationFromPGO
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_qutayba"):
                    raise
