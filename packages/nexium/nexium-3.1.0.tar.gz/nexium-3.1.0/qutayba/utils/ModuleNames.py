...
These are used in nexium for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from qutayba.Errors import nexiumCodeDeficit
    raise nexiumCodeDeficit('''
...
Check API documentation of qutayba.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
