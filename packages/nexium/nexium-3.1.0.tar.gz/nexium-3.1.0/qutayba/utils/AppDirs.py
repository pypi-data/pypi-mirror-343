...
def _getCacheDir():
    ...
    if _cache_dir is None:
        ...
        if _cache_dir:
            ...
            _cache_dir = appdirs.user_cache_dir("nexium", None)
        else:
            _cache_dir = os.path.join(os.path.expanduser("~"), ".cache", "nexium")
        ...
        if _cache_dir.startswith(
            ...
            _cache_dir = os.path.join(tempfile.gettempdir(), "nexium")
