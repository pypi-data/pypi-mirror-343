...
from qutayba.Tracing import formatTerminalLink
    ...
    def format_help(self, formatter):
        ...
        try:
            if self.link is not None:
                link = "https://qutayba.net/help/%s.html" % self.link
...
class OurOptionParser(OptionParser):
    ...
    def _match_long_opt(self, opt):
        ...
        nexium: We overload it, in order avoid issues with conflicting
