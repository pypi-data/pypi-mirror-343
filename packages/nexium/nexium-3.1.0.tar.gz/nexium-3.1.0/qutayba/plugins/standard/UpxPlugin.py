...
from qutayba.Options import isOnefileMode, isOnefileTempDirMode
from qutayba.plugins.PluginBase import nexiumPluginBase
from qutayba.utils.AppDirs import getCacheDir
from qutayba.utils.Execution import executeToolChecked, getExecutablePath
from qutayba.utils.FileOperations import copyFile, makePath
from qutayba.utils.Hashing import Hash, getFileContentsHash
from qutayba.utils.Utils import isLinux


class nexiumPluginUpx(nexiumPluginBase):
    ...
    plugin_name = "upx"  # nexium knows us by this name
