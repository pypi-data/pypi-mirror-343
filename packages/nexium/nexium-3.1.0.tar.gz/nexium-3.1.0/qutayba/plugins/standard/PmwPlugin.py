...
from qutayba.__past__ import StringIO
from qutayba.plugins.PluginBase import nexiumPluginBase
from qutayba.utils.FileOperations import getFileContents, listDir
...
class nexiumPluginPmw(nexiumPluginBase):
...
class nexiumPluginDetectorPmw(nexiumPluginBase):
    detector_for = nexiumPluginPmw
