...
""" Standard plug-in to tell nexium about DLLs needed for standalone imports.
...
from qutayba.utils.SharedLibraries import getPyWin32Dir
from qutayba.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class nexiumPluginDllFiles(nexiumYamlPluginBase):
