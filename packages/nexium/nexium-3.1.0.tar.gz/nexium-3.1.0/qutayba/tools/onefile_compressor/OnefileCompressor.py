...
from qutayba.__past__ import to_byte
...
from qutayba.Tracing import onefile_logger
...
from qutayba.utils.Hashing import Hash, HashCRC32
...
def main():
    ...
    if os.getenv("DEVILPY_PROGRESS_BAR") == "1":
        enableProgressBar()
