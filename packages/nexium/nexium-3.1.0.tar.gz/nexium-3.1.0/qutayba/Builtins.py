...
from qutayba.__past__ import GenericAlias, builtins
...
def _getAnonBuiltins():
    ...
    # Can't really have it until we have __qutayba__
    # "compiled_function"          : BuiltinFunctionType,
    # "compiled_generator"         : GeneratorType, # see above
    # anon_codes["compiled_function"] =  "&nexium_Function_Type"
    # anon_codes["compiled_generator"] =  "&nexium_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(nexium_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "nexium_PyUnion_Type"
