...
from qutayba import OutputDirectories
from qutayba.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from qutayba.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<qutayba.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in qutayba.Builtins
