...
from qutayba.utils.FileOperations import getFileContents, isFilenameBelowPath
...
def getStandardLibraryPaths():
    ...
    if not hasattr(getStandardLibraryPaths, "result"):
        ...
        if isWin32OrPosixWindows():
            from qutayba.Options import shallUseStaticLibPython
...
_stdlib_no_auto_inclusion_list = (
    ...
    # the nexium plugin "multiprocessing" that is always enabled.
