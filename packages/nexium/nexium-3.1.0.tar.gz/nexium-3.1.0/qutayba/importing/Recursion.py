...
from qutayba import ModuleRegistry, Options
...
from qutayba.importing import ImportCache, StandardLibrary
from qutayba.ModuleRegistry import addUsedModule, getRootTopModule
from qutayba.pgo.PGO import decideInclusionFromPGO
...
from qutayba.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from qutayba.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from qutayba.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except nexiumForbiddenImportEncounter as e:
