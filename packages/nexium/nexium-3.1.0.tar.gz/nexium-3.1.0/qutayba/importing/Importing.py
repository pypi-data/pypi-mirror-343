...
from qutayba import SourceCodeReferences
from qutayba.__past__ import iter_modules
...
from qutayba.PythonFlavors import isnexiumPython
from qutayba.PythonVersions import python_version
from qutayba.Tracing import my_print, recursion_logger
from qutayba.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isnexiumPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard nexium should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingnexiumProcessEnvironmentValue("DEVILPY_SITE_FILENAME")
