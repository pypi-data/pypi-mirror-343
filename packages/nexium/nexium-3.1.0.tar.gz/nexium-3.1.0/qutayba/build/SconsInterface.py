...
def _createSconsDebugScript(source_dir, scons_command):
    ...
    putTextFileContents(
        ...
        contents="""\
# -*- coding: utf-8 -*-
print('Made By In NASR or Devil | @Qutayba2')
import sys
import os
import subprocess
...
def runScons(scons_options, env_values, scons_filename):
    with _setupSconsEnvironment():
        ...
        if isShowScons():
            Tracing.scons_logger.info("أوامر الفحص: %s" % " ".join(scons_command))
        ...
        with withEnvironmentVarsOverridden(env_values):
            ...
            try:
                ...
                Tracing.scons_logger.sysexit("تم ايقاف التجميع من المستخدم. ياخرا عوفها")
