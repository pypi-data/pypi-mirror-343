...
from qutayba.Tracing import my_print, scons_logger
from qutayba.utils.Execution import executeProcess
from qutayba.utils.FileOperations import getReportPath
...
nexium with '--clean-cache=%s' once to repair it, or else will
surely happen again."""
        % cache_name
    )
