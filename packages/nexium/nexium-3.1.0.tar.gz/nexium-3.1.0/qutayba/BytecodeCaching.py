...
from qutayba.ModuleRegistry import getModuleOptimizationTimingInfos
from qutayba.plugins.Plugins import Plugins
from qutayba.utils.AppDirs import getCacheDir
from qutayba.utils.FileOperations import makePath
from qutayba.utils.Hashing import Hash, getStringHash
from qutayba.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take nexium and Python version into account as well, ought to catch code changes.
