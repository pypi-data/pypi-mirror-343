...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct nexium_AsyncgenObject *asyncgen, PyObject *yield_return_value) {
...
template_asyncgen_exception_exit = """\
    DEVILPY_CANNOT_GET_HERE("return must be present");
