...
from qutayba.nodes.NodeMetaClasses import nexiumNodeDesignError
from qutayba.Options import shallTraceExecution
from qutayba.PythonVersions import python_version
from qutayba.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "qutayba_bool":
