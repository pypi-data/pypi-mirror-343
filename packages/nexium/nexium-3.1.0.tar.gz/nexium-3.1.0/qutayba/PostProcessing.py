...
from qutayba.build.DataComposerInterface import getConstantBlobFilename
from qutayba.ModuleRegistry import getImportedModuleNames
from qutayba.PythonFlavors import isSelfCompiledPythonUninstalled
from qutayba.PythonVersions import getTargetPythonDLLPath, python_version
from qutayba.Tracing import postprocessing_logger
from qutayba.utils.Execution import wrapCommandForDebuggerForExec
...
from qutayba.utils.Images import convertImageToIconFormat
from qutayba.utils.Importing import importFromInlineCopy
from qutayba.utils.MacOSApp import createPlistInfoFile
...
from qutayba.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from qutayba.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by nexium to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set PYTHONHOME=%(python_home)s
set DEVILPY_PYTHONPATH=%(python_path)s
...
export PYTHONHOME
DEVILPY_PYTHONPATH="%(python_path)s"
export DEVILPY_PYTHONPATH
...
Error, expected 'libpython dependency not found. Please report the bug."""
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        contents = """\
# This file was generated by nexium
"""
