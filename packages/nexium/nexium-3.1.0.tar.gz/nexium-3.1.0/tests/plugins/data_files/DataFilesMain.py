...
# qutayba-project: --user-package-configuration-file={MAIN_DIRECTORY}/test_case.qutayba-package.config.yml
# qutayba-project-if: {Commercial} is not None:
#   qutayba-project: --embed-data-files-runtime-pattern=lala.txt
