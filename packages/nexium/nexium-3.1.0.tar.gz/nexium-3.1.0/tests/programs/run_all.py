...
""" Runner for program tests of nexium.
...
def main():
    ...
    extra_options = os.environ.get("DEVILPY_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["DEVILPY_EXTRA_OPTIONS"] = (
            ...
            os.environ["DEVILPY_EXTRA_OPTIONS"] = extra_options
