...
class DocxProperties:
    ...
    def set_property(self, property_name: str, property_value: Any) -> bool:
        """
        ...
        """
        return self.set_custom_property(property_name, property_value)
    
    def set_custom_property(self, property_name: str, property_value: Any) -> bool:
        """
        Sets a custom property in the Word document.
