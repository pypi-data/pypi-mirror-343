...
@LastEditTime: 2025-04-25 09:46:22
...
class OrderBaseModel(FrameBaseModel):
    ...
    def get_horseracelamp_list(self, app_id, act_id, module_id, is_search_module=False, condition="", params=[], page_size=30):
        ...
        prize_roster_model = PrizeRosterModel(context=self.context).set_sub_table(app_id)
        prize_roster_list = prize_roster_model.get_cache_dict_list(condition_where.to_string(), "", "create_date desc", str(page_size), "user_id,user_nick,prize_name,tag_id,tag_name,module_name", params_list, cache_expire=60)
