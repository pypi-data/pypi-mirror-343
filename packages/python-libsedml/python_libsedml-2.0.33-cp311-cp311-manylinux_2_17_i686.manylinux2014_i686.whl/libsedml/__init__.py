...
class ASTNodeList(object):
    r"""Proxy of C++ ListWrapper< ASTNode > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(ASTNodeList self) -> ASTNodeList"""
        _libsedml.ASTNodeList_swiginit(self, _libsedml.new_ASTNodeList())
    __swig_destroy__ = _libsedml.delete_ASTNodeList

    def add(self, item):
        r"""add(ASTNodeList self, ASTNode item)"""
        return _libsedml.ASTNodeList_add(self, item)

    def get(self, n):
        r"""get(ASTNodeList self, unsigned int n) -> ASTNode"""
        return _libsedml.ASTNodeList_get(self, n)

    def prepend(self, item):
        r"""prepend(ASTNodeList self, ASTNode item)"""
        return _libsedml.ASTNodeList_prepend(self, item)

    def remove(self, n):
        r"""remove(ASTNodeList self, unsigned int n) -> ASTNode"""
        return _libsedml.ASTNodeList_remove(self, n)

    def getSize(self):
        r"""getSize(ASTNodeList self) -> unsigned int"""
        return _libsedml.ASTNodeList_getSize(self)

    def __len__(self):
        r"""__len__(ASTNodeList self) -> int"""
        return _libsedml.ASTNodeList___len__(self)

    def __getitem__(self, index):
        r"""__getitem__(ASTNodeList self, unsigned int index) -> ASTNode"""
        return _libsedml.ASTNodeList___getitem__(self, index)
...
class SedNamespacesList(object, metaclass=AutoProperty):
    r"""Proxy of C++ ListWrapper< SedNamespaces > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(SedNamespacesList self) -> SedNamespacesList"""
    ...
    def add(self, item):
        r"""add(SedNamespacesList self, SedNamespaces item)"""
        return _libsedml.SedNamespacesList_add(self, item)

    def get(self, n):
        r"""get(SedNamespacesList self, unsigned int n) -> SedNamespaces"""
        return _libsedml.SedNamespacesList_get(self, n)

    def prepend(self, item):
        r"""prepend(SedNamespacesList self, SedNamespaces item)"""
        return _libsedml.SedNamespacesList_prepend(self, item)

    def remove(self, n):
        r"""remove(SedNamespacesList self, unsigned int n) -> SedNamespaces"""
        return _libsedml.SedNamespacesList_remove(self, n)

    def getSize(self):
        r"""getSize(SedNamespacesList self) -> unsigned int"""
        return _libsedml.SedNamespacesList_getSize(self)

    def __len__(self):
        r"""__len__(SedNamespacesList self) -> int"""
        return _libsedml.SedNamespacesList___len__(self)

    def __getitem__(self, index):
        r"""__getitem__(SedNamespacesList self, unsigned int index) -> SedNamespaces"""
        return _libsedml.SedNamespacesList___getitem__(self, index)

# Register SedNamespacesList in _libsedml:
_libsedml.SedNamespacesList_swigregister(SedNamespacesList)
class SedBaseList(object, metaclass=AutoProperty):
    r"""Proxy of C++ ListWrapper< SedBase > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(SedBaseList self) -> SedBaseList"""
        _libsedml.SedBaseList_swiginit(self, _libsedml.new_SedBaseList())
    __swig_destroy__ = _libsedml.delete_SedBaseList

    def add(self, item):
        r"""add(SedBaseList self, SedBase item)"""
        return _libsedml.SedBaseList_add(self, item)

    def get(self, n):
        r"""get(SedBaseList self, unsigned int n) -> SedBase"""
        return _libsedml.SedBaseList_get(self, n)

    def prepend(self, item):
        r"""prepend(SedBaseList self, SedBase item)"""
        return _libsedml.SedBaseList_prepend(self, item)

    def remove(self, n):
        r"""remove(SedBaseList self, unsigned int n) -> SedBase"""
        return _libsedml.SedBaseList_remove(self, n)

    def getSize(self):
        r"""getSize(SedBaseList self) -> unsigned int"""
        return _libsedml.SedBaseList_getSize(self)

    def __len__(self):
        r"""__len__(SedBaseList self) -> int"""
        return _libsedml.SedBaseList___len__(self)

    def __getitem__(self, index):
        r"""__getitem__(SedBaseList self, unsigned int index) -> SedBase"""
        return _libsedml.SedBaseList___getitem__(self, index)
...
class SBaseList(object):
    ...
    def __init__(self):
        r"""__init__(SBaseList self) -> SBaseList"""
        _libsedml.SBaseList_swiginit(self, _libsedml.new_SBaseList())
    __swig_destroy__ = _libsedml.delete_SBaseList

    def add(self, item):
        r"""add(SBaseList self, SBase * item)"""
        return _libsedml.SBaseList_add(self, item)

    def get(self, n):
        r"""get(SBaseList self, unsigned int n) -> SBase *"""
        return _libsedml.SBaseList_get(self, n)

    def prepend(self, item):
        r"""prepend(SBaseList self, SBase * item)"""
        return _libsedml.SBaseList_prepend(self, item)

    def remove(self, n):
        r"""remove(SBaseList self, unsigned int n) -> SBase *"""
        return _libsedml.SBaseList_remove(self, n)

    def getSize(self):
        r"""getSize(SBaseList self) -> unsigned int"""
        return _libsedml.SBaseList_getSize(self)

    def __len__(self):
        r"""__len__(SBaseList self) -> int"""
        return _libsedml.SBaseList___len__(self)

    def __getitem__(self, index):
        r"""__getitem__(SBaseList self, unsigned int index) -> SBase *"""
        return _libsedml.SBaseList___getitem__(self, index)
...
class SedNamespaces(object, metaclass=AutoProperty):
...
class SedChange(SedBase):
    ...
    def getAlgorithm(self, *args):
        r"""
        getAlgorithm(SedChange self) -> SedAlgorithm
        getAlgorithm(SedChange self) -> SedAlgorithm
        """
        return _libsedml.SedChange_getAlgorithm(self, *args)

    def isSetAlgorithm(self):
        r"""isSetAlgorithm(SedChange self) -> bool"""
        return _libsedml.SedChange_isSetAlgorithm(self)

    def setAlgorithm(self, algorithm):
        r"""setAlgorithm(SedChange self, SedAlgorithm algorithm) -> int"""
        return _libsedml.SedChange_setAlgorithm(self, algorithm)

    def createAlgorithm(self):
        r"""createAlgorithm(SedChange self) -> SedAlgorithm"""
        return _libsedml.SedChange_createAlgorithm(self)

    def unsetAlgorithm(self):
        r"""unsetAlgorithm(SedChange self) -> int"""
        return _libsedml.SedChange_unsetAlgorithm(self)
    ...
    def connectToChild(self):
        r"""connectToChild(SedChange self)"""
        return _libsedml.SedChange_connectToChild(self)

    def getElementBySId(self, id):
        r"""getElementBySId(SedChange self, string id) -> SedBase"""
        return _libsedml.SedChange_getElementBySId(self, id)
...
class SedAbstractTask(SedBase):
    ...
    def getAlgorithm(self, *args):
        r"""
        getAlgorithm(SedAbstractTask self) -> SedAlgorithm
        getAlgorithm(SedAbstractTask self) -> SedAlgorithm
        """
        return _libsedml.SedAbstractTask_getAlgorithm(self, *args)

    def isSetAlgorithm(self):
        r"""isSetAlgorithm(SedAbstractTask self) -> bool"""
        return _libsedml.SedAbstractTask_isSetAlgorithm(self)

    def setAlgorithm(self, algorithm):
        r"""setAlgorithm(SedAbstractTask self, SedAlgorithm algorithm) -> int"""
        return _libsedml.SedAbstractTask_setAlgorithm(self, algorithm)

    def createAlgorithm(self):
        r"""createAlgorithm(SedAbstractTask self) -> SedAlgorithm"""
        return _libsedml.SedAbstractTask_createAlgorithm(self)

    def unsetAlgorithm(self):
        r"""unsetAlgorithm(SedAbstractTask self) -> int"""
        return _libsedml.SedAbstractTask_unsetAlgorithm(self)
    ...
    def connectToChild(self):
        r"""connectToChild(SedAbstractTask self)"""
        return _libsedml.SedAbstractTask_connectToChild(self)

    def getElementBySId(self, id):
        r"""getElementBySId(SedAbstractTask self, string id) -> SedBase"""
        return _libsedml.SedAbstractTask_getElementBySId(self, id)
...
class SedOutput(SedBase):
    ...
    def getAlgorithm(self, *args):
        r"""
        getAlgorithm(SedOutput self) -> SedAlgorithm
        getAlgorithm(SedOutput self) -> SedAlgorithm
        """
        return _libsedml.SedOutput_getAlgorithm(self, *args)

    def isSetAlgorithm(self):
        r"""isSetAlgorithm(SedOutput self) -> bool"""
        return _libsedml.SedOutput_isSetAlgorithm(self)

    def setAlgorithm(self, algorithm):
        r"""setAlgorithm(SedOutput self, SedAlgorithm algorithm) -> int"""
        return _libsedml.SedOutput_setAlgorithm(self, algorithm)

    def createAlgorithm(self):
        r"""createAlgorithm(SedOutput self) -> SedAlgorithm"""
        return _libsedml.SedOutput_createAlgorithm(self)

    def unsetAlgorithm(self):
        r"""unsetAlgorithm(SedOutput self) -> int"""
        return _libsedml.SedOutput_unsetAlgorithm(self)
    ...
    def connectToChild(self):
        r"""connectToChild(SedOutput self)"""
        return _libsedml.SedOutput_connectToChild(self)

    def getElementBySId(self, id):
        r"""getElementBySId(SedOutput self, string id) -> SedBase"""
        return _libsedml.SedOutput_getElementBySId(self, id)
...
class SedRange(SedBase):
    ...
    def getAlgorithm(self, *args):
        r"""
        getAlgorithm(SedRange self) -> SedAlgorithm
        getAlgorithm(SedRange self) -> SedAlgorithm
        """
        return _libsedml.SedRange_getAlgorithm(self, *args)

    def isSetAlgorithm(self):
        r"""isSetAlgorithm(SedRange self) -> bool"""
        return _libsedml.SedRange_isSetAlgorithm(self)

    def setAlgorithm(self, algorithm):
        r"""setAlgorithm(SedRange self, SedAlgorithm algorithm) -> int"""
        return _libsedml.SedRange_setAlgorithm(self, algorithm)

    def createAlgorithm(self):
        r"""createAlgorithm(SedRange self) -> SedAlgorithm"""
        return _libsedml.SedRange_createAlgorithm(self)

    def unsetAlgorithm(self):
        r"""unsetAlgorithm(SedRange self) -> int"""
        return _libsedml.SedRange_unsetAlgorithm(self)
    ...
    def connectToChild(self):
        r"""connectToChild(SedRange self)"""
        return _libsedml.SedRange_connectToChild(self)

    def getElementBySId(self, id):
        r"""getElementBySId(SedRange self, string id) -> SedBase"""
        return _libsedml.SedRange_getElementBySId(self, id)
...
class XMLNode(XMLToken):
    ...
    def readXMLNodeFromFile(filename):
        ...
        return _libsedml.XMLNode_readXMLNodeFromFile(filename)
...
class ASTNode(object):
    ...
    def removeChild(self, n, delremoved=False):
        ...
        return _libsedml.ASTNode_removeChild(self, n, delremoved)
    ...
    def replaceArguments(self, bvars, args):
        r"""replaceArguments(ASTNode self, std::vector< std::string,std::allocator< std::string > > const & bvars, std::vector< ASTNode *,std::allocator< ASTNode * > > & args)"""
        return _libsedml.ASTNode_replaceArguments(self, bvars, args)
