"""
Rainfall file generator for AquaCrop (.PLU files)
"""

import os
from typing import List
def generate_rainfall_file(
    file_path: str,
    location: str,
    ...
    """
    Generate an AquaCrop rainfall file (.PLU)
    
    Args:
        file_path: Path to write the file
        location: Location description
        rainfall_values: List of rainfall values (mm)
    ...
    if len(rainfall_values) == 0:
        raise ValueError("rainfall_values must not be empty")
