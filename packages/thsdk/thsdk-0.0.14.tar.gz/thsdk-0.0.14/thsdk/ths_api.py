...
class THSHQ:
    def __init__(self, ops: dict = ()):
        ...
        self._lib.Init.argtypes = [ctypes.c_char_p]
        ...
        self._lib.sub.argtypes = [ctypes.c_void_p]
        self._lib.sub.restype = None
        self._lib.unsub.argtypes = []
        self._lib.unsub.restype = None
        self._lib.triggerCallback.argtypes = [ctypes.c_int, ctypes.c_int]
        self._lib.triggerCallback.restype = ctypes.c_int

        self._lib.Init(json.dumps(ops).encode('utf-8'))
