...
class oweqfeatureengineering(OWWidget, ConcurrentWidgetMixin):
    ...
    def __init__(self):
        ...
        self.nMorales_spin = gui.spin(params_box, self, "nMorales", step=1, label="Events for b-value Morales")
        ...
        self.nAdeli_spin = gui.spin(params_box, self, "nAdeli", step=1, label="Events for b-value Adeli")
        ...
        self.referenceMagnitude_spin = gui.doubleSpin(params_box, self, "referenceMagnitude", step=0.1, label="Reference Magnitude")
        ...
        self.dayspred_spin = gui.spin(params_box, self, "dayspred", step=1, label="Prediction Days")
        ...
        self.classFrom_spin = gui.doubleSpin(params_box, self, "classFrom", step=0.1, label="Classification: From")
        ...
        self.classTo_spin = gui.doubleSpin(params_box, self, "classTo", step=0.1, label="Classification: To")
        ...
        self.classStep_spin = gui.doubleSpin(params_box, self, "classStep", step=0.05, label="Classification: Step")
        ...
        self.chth_spin = gui.doubleSpin(params_box, self, "chth", step=0.01, label="Threshold for mu and c")
