...
class WatsonxCustomMetric:
    ...
    def _get_monitor_instance(self, 
                              subscription_id: str,
    ...
    def _update_monitor_instance(self, 
    ...
    def _get_patch_request_field(self,
                                 field_path: str, 
                                 field_value: Any, 
    ...
    def add_measurements(self,
        ...
        measurements_request = [MonitorMeasurementRequest(**obj.dict()) for obj in measurements_request]
        
        self._wos_client.monitor_instances.add_measurements(
            monitor_instance_id=monitor_instance_id,
            monitor_measurement_request=measurements_request).result        
