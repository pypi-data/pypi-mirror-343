...
from xgi.exception  import XGIError, frozen
from xgi.utils.utilities import powerset, update_uid_counter
from xgi.core.hypergraph import Hypergraph
from xgi.core.views import EdgeView, NodeView
...
class SimplicialComplex(Hypergraph):
    ...
    **attr : dict, optional
    ...
    >>> S = xgi_optimized.SimplicialComplex([[1, 2, 3], [4], [5, 6], [6, 7, 8]])
    >>> S.nodes
    ...
    def __str__(self):
        ...
        --------
        >>> import xgi_optimized
        >>> S = xgi_optimized.SimplicialComplex(name="foo")
        >>> str(S)
    ...
    def add_simplex(self, members, idx=None, **attr):
        ...
        **attr : dict, optional
        ...
        >>> import xgi_optimized
        >>> S = xgi_optimized.SimplicialComplex()
        >>> S.add_simplex([1, 2, 3])
    ...
    def add_simplices_from(self, ebunch_to_add, max_order=None, **attr):
        ...
        **attr : kwargs, optional
        ...
        >>> S2 = xgi_optimized.SimplicialComplex()
    ...
    def remove_simplex_ids_from(self, ebunch):
        ...
        Raises
        ------
        xgi_optimized.exception.IDNotFound
    ...
    def has_simplex(self, simplex):
        ...
        --------
        >>> import xgi_optimized
        >>> S = xgi_optimized.SimplicialComplex([[1, 2], [2, 3, 4]])
        >>> S.has_simplex([1, 2])
        True
        >>> S.has_simplex({1, 3})
        False
    ...
    def cleanup(self, isolates=False, connected=True, relabel=True, in_place=True):
        ...
        if connected:
            from xgi.algorithms import largest_connected_hypergraph

            largest_connected_hypergraph(_S, in_place=True)
        if relabel:
            from xgi.utils import convert_labels_to_integers
    ...
    def freeze(self):
        ...
        >>> import xgi_optimized
        >>> edges = [[1, 2], [2, 3, 4]]
        >>> S = xgi_optimized.SimplicialComplex(edges)
        >>> S.freeze()
        >>> S.add_node(5)
