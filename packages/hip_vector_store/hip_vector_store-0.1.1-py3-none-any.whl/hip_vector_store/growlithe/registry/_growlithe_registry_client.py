...
class _GrowlitheRegistry:
    ...
    def __init__(self, settings_config: config.Settings):
        ...
        self.databricks_client = DatabricksSQLClient(
            server_hostname=self.settings_config.DATABRICKS_CLUSTER_HOST,
            http_path=self.settings_config.DATABRICKS_SQL_CLUSTER_PATH,
            access_token=self.settings_config.DATABRICKS_PAT_TOKEN,
        )
