...
urlpatterns = [
    ...
    path('v1/pipelines/reconfigs/getReconfigsDropdownForPipeline',  GetReconfigsDropdownForPipeline.as_view(),    name='getReconfigsDropdownForPipeline'),
    path('v1/pipelines/reconfigs/getReconfigsList',                 GetReconfigsList.as_view(),                   name='getReconfigsList'),
    path('v1/pipelines/reconfigs/delete',                           DeleteReconfigs.as_view(),                    name='deleteReconfigs'),
    path('v1/pipelines/reconfigs/getParams',                        GetReconfigParams.as_view(),                  name='getReconfigParams'),
    path('v1/pipelines/reconfigs/saveNewReconfigsToFile',           SaveNewReconfigsToFile.as_view(),             name='saveNewReconfigsToFile'),
