...
class EnvAssistant:
    ...
    def envHandler(self):
        ...
        try:
            ...
            print('----- EnvAssistant 1 ---')
            pprint(self.runTaskObj.taskProperties)
            ...
            if self.runTaskObj.envFile:
                ...
                if self.runTaskObj.playbookObj.isKeystackAlive and self.runTaskObj.env and self.runTaskObj.env != 'not-required':
                    ...
                    print('----- EnvAssistant 3 parallelUsage ----', self.runTaskObj.taskProperties.get('parallelUsage', False))     
