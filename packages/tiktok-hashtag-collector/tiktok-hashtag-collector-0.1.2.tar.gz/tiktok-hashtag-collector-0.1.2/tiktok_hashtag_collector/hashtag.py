...
class TiktokHashtagCollector:
    ...
    # Constants
    RAPID_URL_COLLECT_HASHTAG = "https://tiktok-v2-rapidapi.p.rapidapi.com/hashtag/search"
    RAPID_URL_COLLECT_POST_BY_HASHTAG = "https://tiktok-v2-rapidapi.p.rapidapi.com/hashtag/posts/{hashtag_id}"
    ...
    def __init__(self, api_key, country_code="US", max_post_by_hashtag=100, max_hashtag_post_retry=3, max_profile_retry=3):
        """
        Initialize the collector with an API key, country code and max posts per hashtag.
