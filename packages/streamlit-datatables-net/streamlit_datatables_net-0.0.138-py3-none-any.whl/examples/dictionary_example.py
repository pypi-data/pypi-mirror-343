    ...
    with st.container(border=True):
        ...
        with st.expander("Code"):
            with st.echo():
                ...
                options["order"] = [[4, "asc"]]
                render_group_count = stringify_javascript_function(JAVASCRIPT_FILE_PATH, "render_group_count")
                ...
                with dt_container:
                    ...
                    dt_response = st_datatable(
                        big_data, column_order=column_order, options=options, key="example_1", dt_config="default", date_format="%m/%d/%Y", is_datetime=True, enable_top_navigation=False, export_file_name="Example 1", on_select=on_select, enable_diagnostics=True)
