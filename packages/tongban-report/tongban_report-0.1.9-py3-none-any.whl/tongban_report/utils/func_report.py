...
from .perf_util import get_perf_report
from .file_util import FileUtil


def gen_report(docx, xlsx, sheet, project_num):
    ...
    for single in data:
        ...
        for i in docx_input.paragraphs:
            for j in i.runs:
                ...
                if "img" in j.text:
                    j.text = j.text.replace('img', '')
                    j.add_picture("./chart/chart.png", width=Inches(6.2))
