...
class RunRequest():
    ...
    participants: Optional[dict[str, str]] # list of participant puples eg [{"agent": "agent_name", "role": "participant"}]
...
class ExperimentResult():
    ...
    def display_runs(self, show_logs: bool = False):
        ...
        for run in self.runs:
            ...
            print(f"  Total time: {'N/A' if not isinstance(run.total_time, (int, float)) else f'{run.total_time/1000:.2f} seconds'}")
