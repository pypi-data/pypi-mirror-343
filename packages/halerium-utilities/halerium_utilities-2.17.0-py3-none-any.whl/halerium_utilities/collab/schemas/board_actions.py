...
class BoardAction(BaseModel):
    type: Literal["add_node", "update_node", "remove_node",
        ...
        description=("The type of the specific action to perform. "
                     ...
                     "remove_edge, update_edge, add_element, update_element, "
                     "remove_element, update_process_queue, send_node_to_execute."),
        example="remove_node"
    )
    ...
    def validate_payload(cls, t, values):
        ...
        if type == "add_node":
            ...
            schema = EdgeId
        # elif type == "add_element":
        #     schema = AddPathElement
        # elif type == "update_element":
        #     schema = PathElementUpdate
        # elif type == "move_element":
        #     schema = MovePathElement
        # elif type == "remove_element":
        #     schema = ElementId
...
# class AddPathElement(BaseModel):
#     element: PathElement
#     index: int
