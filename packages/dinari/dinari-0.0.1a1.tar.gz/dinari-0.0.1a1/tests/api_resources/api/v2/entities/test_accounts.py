...
class TestAccounts:
    ...
    def test_method_create(self, client: Dinari) -> None:
        account = client.api.v2.entities.accounts.create(
    ...
    def test_raw_response_create(self, client: Dinari) -> None:
        response = client.api.v2.entities.accounts.with_raw_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: Dinari) -> None:
        with client.api.v2.entities.accounts.with_streaming_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create(self, client: Dinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.api.v2.entities.accounts.with_raw_response.create(
                "",
            )
    ...
    def test_method_list(self, client: Dinari) -> None:
        account = client.api.v2.entities.accounts.list(
    ...
    def test_raw_response_list(self, client: Dinari) -> None:
        response = client.api.v2.entities.accounts.with_raw_response.list(
            entity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Dinari) -> None:
        with client.api.v2.entities.accounts.with_streaming_response.list(
            entity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Dinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.api.v2.entities.accounts.with_raw_response.list(
                entity_id="",
            )
...
class TestAsyncAccounts:
    ...
    async def test_method_create(self, async_client: AsyncDinari) -> None:
        account = await async_client.api.v2.entities.accounts.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Account, account, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncDinari) -> None:
        response = await async_client.api.v2.entities.accounts.with_raw_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncDinari) -> None:
        async with async_client.api.v2.entities.accounts.with_streaming_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncDinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.api.v2.entities.accounts.with_raw_response.create(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncDinari) -> None:
        account = await async_client.api.v2.entities.accounts.list(
            entity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(AccountListResponse, account, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncDinari) -> None:
        response = await async_client.api.v2.entities.accounts.with_raw_response.list(
            entity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncDinari) -> None:
        async with async_client.api.v2.entities.accounts.with_streaming_response.list(
            entity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncDinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.api.v2.entities.accounts.with_raw_response.list(
                entity_id="",
            )
