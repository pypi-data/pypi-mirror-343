...
class TestWallet:
    ...
    def test_method_retrieve(self, client: Dinari) -> None:
        wallet = client.api.v2.accounts.wallet.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Dinari) -> None:
        response = client.api.v2.accounts.wallet.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Dinari) -> None:
        with client.api.v2.accounts.wallet.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Dinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.api.v2.accounts.wallet.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncWallet:
    ...
    async def test_method_retrieve(self, async_client: AsyncDinari) -> None:
        wallet = await async_client.api.v2.accounts.wallet.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Wallet, wallet, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncDinari) -> None:
        response = await async_client.api.v2.accounts.wallet.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncDinari) -> None:
        async with async_client.api.v2.accounts.wallet.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncDinari) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.api.v2.accounts.wallet.with_raw_response.retrieve(
                "",
            )
