...
class ImportFactory(DataFactory):
    ...
    def import_nuscenes_product(self, nuscenes_root, output_dir, oss_root, predata=False, json_file_name=None):
        print(self.type, "process has been created.")
        from ..io.import_data.nuscenes.import_nuscenes import ImportNuscenes
        return ImportNuscenes(nuscenes_root, output_dir, oss_root, predata, json_file_name)
