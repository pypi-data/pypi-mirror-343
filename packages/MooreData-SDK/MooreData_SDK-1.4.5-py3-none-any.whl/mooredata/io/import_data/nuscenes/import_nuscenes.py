...
class ImportNuscenes(NuscenesDet):
    def __init__(self, nuscenes_root, output_dir, oss_root, predata=False, json_file_name=None):

        super(ImportNuscenes, self).__init__(nuscenes_root, output_dir, oss_root, predata, json_file_name)
