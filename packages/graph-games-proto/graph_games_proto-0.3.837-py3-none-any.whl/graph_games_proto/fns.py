...
# end
    ...
    return_route_card_idxs = [player_hand.new_route_cards[i] for i in route_card_hand_idxs]
    chosen = set(list(player_hand.new_route_cards)) - set(return_route_card_idxs)
    
    print(f"new_route_cards: {list(player_hand.new_route_cards)}")
    print(f"return_route_card_idxs: {return_route_card_idxs}")
    ...
    # @reset s.route_discards = [s.route_discards..., return_route_card_nums...]
    s = s.set(route_discards=s.route_discards + return_route_card_idxs)
    # @reset s.player_hands[a.player_idx].new_route_cards = []
