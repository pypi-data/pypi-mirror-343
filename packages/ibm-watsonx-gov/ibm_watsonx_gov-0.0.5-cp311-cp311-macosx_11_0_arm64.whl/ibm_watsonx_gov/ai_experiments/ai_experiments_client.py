...
class AIExperimentsClient:
    ...
    def create(self, experiment_details: AIExperiment) -> AIExperiment:
        ...
        metadata = get(response_json, "metadata", default={})
        ai_experiment_data = get(
            response_json, "entity.ai_experiment", default={})
        ...
        ai_experiment_details = {
            ...
            "component_id": get(metadata, "component_id", default=""),
    ...
    def update(
        ...
        if evaluation_results:
            attachment_id = self.__store_experiment_run_result(
                ai_experiment_id, experiment_run_details, evaluation_results
            )
        ...
        update_payload = {
            ...
            "nodes": experiment_run_details.nodes or [],
    ...
    def __store_experiment_run_result(
        ...
        """
        # evaluation_result will be a instance of  DataFrame or ToolMetricResult, this method will convert it to required format.
        # evaluation_result = get_evaluation_result_payload(evaluation_result)
