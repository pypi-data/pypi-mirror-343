...
def CrearTablaReport(Datos: t.Union[list, list],
    ...
    for col in NombreColumnas:
        ColumnasTH += '<th scope="col" class=' +ClassColumnas[countCol]+'>'+col+'</th>'
        countCol += 1
    ...
    if Datos == [] or Datos is None:
        ...
        for row in Datos:
            ...
            for col in DatosColumnas:
                ...
                ColumnasTD += "<td id='"+col+"_"+NumeralTabla+"' class='" + \
                    ClassColumnas[countCol]+" text-wrap'>"+str(columna)+"</td>"
                countCol += 1
