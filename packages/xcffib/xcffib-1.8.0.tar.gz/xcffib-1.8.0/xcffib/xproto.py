...
class ARC(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.x, self.y, self.width, self.height, self.angle1, self.angle2 = (
...
class FORMAT(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=BBB5x", self.depth, self.bits_per_pixel, self.scanline_pad)
        )
        return buf.getvalue()
...
class SCREEN(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        ) = unpacker.unpack("IIIIIHHHHHHIBBBB")
...
class SetupRequest(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        ) = unpacker.unpack("BxHHHH2x")
        self.authorization_protocol_name = xcffib.List(
            unpacker, "c", self.authorization_protocol_name_len
        )
        unpacker.pad("c")
        self.authorization_protocol_data = xcffib.List(
            unpacker, "c", self.authorization_protocol_data_len
        )
        self.bufsize = unpacker.offset - base
...
class Setup(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.min_keycode,
            self.max_keycode,
        ) = unpacker.unpack("BxHHHIIIIHHBBBBBBBB4x")
...
class KeyPressEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.state,
            self.same_screen,
        ) = unpacker.unpack("xB2xIIIIhhhhHBx")
        self.bufsize = unpacker.offset - base
...
class ExposeEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.window, self.x, self.y, self.width, self.height, self.count = (
            unpacker.unpack("xx2xIHHHHH2x")
        )
        self.bufsize = unpacker.offset - base
...
class GraphicsExposureEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.count,
            self.major_opcode,
        ) = unpacker.unpack("xx2xIHHHHHHB3x")
        self.bufsize = unpacker.offset - base
    ...
    @classmethod
    def synthetic(
        cls, drawable, x, y, width, height, minor_opcode, count, major_opcode
    ):
        self = cls.__new__(cls)
...
class NoExposureEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack("=x2xIHBx", self.drawable, self.minor_opcode, self.major_opcode)
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class CreateNotifyEvent(xcffib.Event):
    ...
    @classmethod
    def synthetic(
        cls, parent, window, x, y, width, height, border_width, override_redirect
    ):
        self = cls.__new__(cls)
        self.parent = parent
        self.window = window
...
class UnmapNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack("=x2xIIB3x", self.event, self.window, self.from_configure)
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class MapNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack("=x2xIIB3x", self.event, self.window, self.override_redirect)
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class ReparentNotifyEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.event, self.window, self.parent, self.x, self.y, self.override_redirect = (
            unpacker.unpack("xx2xIIIhhB3x")
        )
        self.bufsize = unpacker.offset - base
...
class ConfigureNotifyEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.border_width,
            self.override_redirect,
        ) = unpacker.unpack("xx2xIIIhhHHHBx")
        self.bufsize = unpacker.offset - base
...
class PropertyNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack("=x2xIIIB3x", self.window, self.atom, self.time, self.state)
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class SelectionNotifyEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.time, self.requestor, self.selection, self.target, self.property = (
            unpacker.unpack("xx2xIIIII")
        )
        self.bufsize = unpacker.offset - base
...
class ColormapNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack("=x2xIIBB2x", self.window, self.colormap, self.new, self.state)
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class ClientMessageEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            ...
            else ClientMessageData.synthetic(*self.data).pack()
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class GetWindowAttributesReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.backing_pixel,
            self.save_under,
            self.map_is_installed,
            self.map_state,
            self.override_redirect,
            self.colormap,
            self.all_event_masks,
            self.your_event_mask,
            self.do_not_propagate_mask,
        ) = unpacker.unpack("xB2x4xIHBBIIBBBBIIIH2x")
        self.bufsize = unpacker.offset - base
...
class GetGeometryReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.height,
            self.border_width,
        ) = unpacker.unpack("xB2x4xIhhHHH2x")
        self.bufsize = unpacker.offset - base
...
class QueryPointerReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.win_y,
            self.mask,
        ) = unpacker.unpack("xB2x4xIIhhhhH2x")
        self.bufsize = unpacker.offset - base
...
class QueryFontReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.min_byte1,
            self.max_byte1,
            self.all_chars_exist,
            self.font_ascent,
            self.font_descent,
            self.char_infos_len,
        ) = unpacker.unpack("4xHHHHBBBBhhI")
...
class QueryTextExtentsReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.font_descent,
            self.overall_ascent,
            self.overall_descent,
            self.overall_width,
            self.overall_left,
            self.overall_right,
        ) = unpacker.unpack("xB2x4xhhhhiii")
        self.bufsize = unpacker.offset - base
...
class AllocColorPlanesReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.pixels_len, self.red_mask, self.green_mask, self.blue_mask = (
            unpacker.unpack("xx2x4xH2xIII8x")
        )
        self.pixels = xcffib.List(unpacker, "I", self.pixels_len)
        self.bufsize = unpacker.offset - base
...
class COLORITEM(xcffib.Struct):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=IHHHBx", self.pixel, self.red, self.green, self.blue, self.flags
            )
        )
        return buf.getvalue()
...
class QueryExtensionReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.present, self.major_opcode, self.first_event, self.first_error = (
            unpacker.unpack("xx2x4xBBBB")
        )
        self.bufsize = unpacker.offset - base
...
class GetPointerControlReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.acceleration_numerator, self.acceleration_denominator, self.threshold = (
            unpacker.unpack("xx2x4xHHH18x")
        )
        self.bufsize = unpacker.offset - base
...
class GetScreenSaverReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.timeout, self.interval, self.prefer_blanking, self.allow_exposures = (
            unpacker.unpack("xx2x4xHHBB18x")
        )
        self.bufsize = unpacker.offset - base
...
class xprotoExtension(xcffib.Extension):
    ...
    def GetWindowAttributes(self, window, is_checked=True):
        ...
        return self.send_request(
            3, buf, GetWindowAttributesCookie, is_checked=is_checked
        )
    ...
    def ChangeProperty(
        self, mode, window, property, type, format, data_len, data, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xB2xIIIB3xI", mode, window, property, type, format, data_len)
        )
    ...
    def GetProperty(
        self, delete, window, property, type, long_offset, long_length, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack(
    ...
    def GetSelectionOwner(self, selection, is_checked=True):
        ...
        return self.send_request(
            23, buf, GetSelectionOwnerCookie, is_checked=is_checked
        )

    def ConvertSelection(
        self, requestor, selection, target, property, time, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xx2xIIIII", requestor, selection, target, property, time)
        )
    ...
    def TranslateCoordinates(
        self, src_window, dst_window, src_x, src_y, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(struct.pack("=xx2xIIhh", src_window, dst_window, src_x, src_y))
        return self.send_request(
            40, buf, TranslateCoordinatesCookie, is_checked=is_checked
        )
    ...
    def ListFontsWithInfo(self, max_names, pattern_len, pattern, is_checked=True):
        ...
        buf.write(xcffib.pack_list(pattern, "c"))
        return self.send_request(
            50, buf, ListFontsWithInfoCookie, is_checked=is_checked
        )
    ...
    def PolyPoint(
        self, coordinate_mode, drawable, gc, points_len, points, is_checked=False
    ):
        buf = io.BytesIO()
    ...
    def FillPoly(
        self, drawable, gc, shape, coordinate_mode, points_len, points, is_checked=False
    ):
        buf = io.BytesIO()
    ...
    def PolyFillRectangle(
        self, drawable, gc, rectangles_len, rectangles, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(struct.pack("=xx2xII", drawable, gc))
        buf.write(xcffib.pack_list(rectangles, RECTANGLE))
    ...
    def GetImage(
        self, format, drawable, x, y, width, height, plane_mask, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack(
                "=xB2xIhhHHI", format, drawable, x, y, width, height, plane_mask
            )
        )
    ...
    def ListInstalledColormaps(self, window, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xI", window))
        return self.send_request(
            83, buf, ListInstalledColormapsCookie, is_checked=is_checked
        )
    ...
    def AllocColorPlanes(
        self, contiguous, cmap, colors, reds, greens, blues, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xB2xIHHHH", contiguous, cmap, colors, reds, greens, blues)
        )
    ...
    def ChangeKeyboardMapping(
        ...
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xB2xBB2x", keycode_count, first_keycode, keysyms_per_keycode)
        )
    ...
    def GetKeyboardMapping(self, first_keycode, count, is_checked=True):
        ...
        return self.send_request(
            101, buf, GetKeyboardMappingCookie, is_checked=is_checked
        )
    ...
    def GetKeyboardControl(self, is_checked=True):
        ...
        buf.write(struct.pack("=xx2x"))
        return self.send_request(
            103, buf, GetKeyboardControlCookie, is_checked=is_checked
        )
    ...
    def GetPointerControl(self, is_checked=True):
        ...
        buf.write(struct.pack("=xx2x"))
        return self.send_request(
            106, buf, GetPointerControlCookie, is_checked=is_checked
        )

    def SetScreenSaver(
        self, timeout, interval, prefer_blanking, allow_exposures, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack(
                "=xx2xhhBB", timeout, interval, prefer_blanking, allow_exposures
            )
        )
    ...
    def SetPointerMapping(self, map_len, map, is_checked=True):
        ...
        return self.send_request(
            116, buf, SetPointerMappingCookie, is_checked=is_checked
        )
    ...
    def GetPointerMapping(self, is_checked=True):
        ...
        buf.write(struct.pack("=xx2x"))
        return self.send_request(
            117, buf, GetPointerMappingCookie, is_checked=is_checked
        )
    ...
    def SetModifierMapping(self, keycodes_per_modifier, keycodes, is_checked=True):
        ...
        return self.send_request(
            118, buf, SetModifierMappingCookie, is_checked=is_checked
        )
    ...
    def GetModifierMapping(self, is_checked=True):
        ...
        buf.write(struct.pack("=xx2x"))
        return self.send_request(
            119, buf, GetModifierMappingCookie, is_checked=is_checked
        )
