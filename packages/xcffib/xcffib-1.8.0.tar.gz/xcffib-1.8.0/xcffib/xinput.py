...
class GetExtensionVersionReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        base = unpacker.offset
        self.xi_reply_type, self.server_major, self.server_minor, self.present = (
            unpacker.unpack("xB2x4xHHB19x")
        )
        self.bufsize = unpacker.offset - base
...
class DeviceInfo(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.device_type, self.device_id, self.num_class_info, self.device_use = (
            unpacker.unpack("IBBBx")
        )
        self.bufsize = unpacker.offset - base
...
class KeyInfo(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.class_id, self.len, self.min_keycode, self.max_keycode, self.num_keys = (
...
class ValuatorInfo(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.class_id, self.len, self.axes_len, self.mode, self.motion_size = (
            unpacker.unpack("BBBBI")
        )
...
class InputInfo(xcffib.Struct):
    ...
    def pack(self):
        ...
        if self.class_id & InputClass.Key:
            ...
            buf.write(
                struct.pack("=BBH2x", self.min_keycode, self.max_keycode, self.num_keys)
            )
        if self.class_id & InputClass.Button:
...
class GetSelectedExtensionEventsReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.xi_reply_type, self.num_this_classes, self.num_all_classes = (
            unpacker.unpack("xB2x4xHH20x")
        )
...
class GetDeviceMotionEventsReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.xi_reply_type, self.num_events, self.num_axes, self.device_mode = (
            unpacker.unpack("xB2x4xIBB18x")
        )
        self.events = xcffib.List(
            unpacker,
            xcffib.__DeviceTimeCoord_wrapper(DeviceTimeCoord, self.num_axes),
            self.num_events,
        )
        self.bufsize = unpacker.offset - base
...
class GetDeviceFocusReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Reply.__init__(self, unpacker)
        base = unpacker.offset
        self.xi_reply_type, self.focus, self.time, self.revert_to = unpacker.unpack(
            "xB2x4xIIB15x"
        )
        self.bufsize = unpacker.offset - base
...
class LedFeedbackState(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.class_id, self.feedback_id, self.len, self.led_mask, self.led_values = (
            unpacker.unpack("BBHII")
        )
        self.bufsize = unpacker.offset - base
...
class FeedbackState(xcffib.Struct):
    ...
    def pack(self):
        ...
        if self.class_id & FeedbackClass.Pointer:
            ...
            buf.write(
                struct.pack("=2xHHH", self.accel_num, self.accel_denom, self.threshold)
            )
        if self.class_id & FeedbackClass.String:
        ...
        if self.class_id & FeedbackClass.Integer:
            ...
            buf.write(
                struct.pack("=Iii", self.resolution, self.min_value, self.max_value)
            )
        if self.class_id & FeedbackClass.Led:
            self.led_mask = self.data.pop(0)
            self.led_values = self.data.pop(0)
...
class IntegerFeedbackCtl(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.class_id, self.feedback_id, self.len, self.int_to_display = (
            unpacker.unpack("BBHi")
        )
        self.bufsize = unpacker.offset - base
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=BBHi", self.class_id, self.feedback_id, self.len, self.int_to_display
            )
        )
        return buf.getvalue()
...
class StringFeedbackCtl(xcffib.Struct):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=BBH2xH", self.class_id, self.feedback_id, self.len, self.num_keysyms
            )
        )
        buf.write(xcffib.pack_list(self.keysyms, "I"))
        return buf.getvalue()
...
class ValuatorState(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=BBBB", self.class_id, self.len, self.num_valuators, self.mode)
        )
...
class DeviceAbsAreaState(xcffib.Struct):
    ...
    @classmethod
    def synthetic(
        cls, control_id, len, offset_x, offset_y, width, height, screen, following
    ):
        self = cls.__new__(cls)
        self.control_id = control_id
        self.len = len
...
class DeviceCoreState(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=HHBB2x", self.control_id, self.len, self.status, self.iscore)
        )
        return buf.getvalue()
...
class DeviceResolutionCtl(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.control_id, self.len, self.first_valuator, self.num_valuators = (
    ...
    @classmethod
    def synthetic(
        cls, control_id, len, first_valuator, num_valuators, resolution_values
    ):
        self = cls.__new__(cls)
        self.control_id = control_id
        self.len = len
...
class GetDevicePropertyReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.format,
            self.device_id,
        ) = unpacker.unpack("xB2x4xIIIBB10x")
...
class GroupInfo(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=BBBB", self.base, self.latched, self.locked, self.effective)
        )
        return buf.getvalue()
...
class ModifierInfo(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=IIII", self.base, self.latched, self.locked, self.effective)
        )
        return buf.getvalue()
...
class XIQueryPointerReply(xcffib.Reply):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.same_screen,
            self.buttons_len,
        ) = unpacker.unpack("xx2x4xIIiiiiBxH")
...
class AddMaster(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.type, self.len, self.name_len, self.send_core, self.enable = (
            unpacker.unpack("HHHBB")
        )
...
class RemoveMaster(xcffib.Struct):
    ...
    @classmethod
    def synthetic(
        cls, type, len, deviceid, return_mode, return_pointer, return_keyboard
    ):
        self = cls.__new__(cls)
        self.type = type
        self.len = len
...
class ButtonClass(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=HHHH", self.type, self.len, self.sourceid, self.num_buttons)
        )
...
class KeyClass(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=HHHH", self.type, self.len, self.sourceid, self.num_keys)
        )
...
class ScrollClass(xcffib.Struct):
    ...
    def pack(self):
        ...
        buf.write(
            self.increment.pack()
            if hasattr(self.increment, "pack")
            else FP3232.synthetic(*self.increment).pack()
        )
        return buf.getvalue()
...
class TouchClass(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.type, self.len, self.sourceid, self.mode, self.num_touches = (
            unpacker.unpack("HHHBB")
        )
        self.bufsize = unpacker.offset - base
...
class GestureClass(xcffib.Struct):
    ...
    def pack(self):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=HHHBx", self.type, self.len, self.sourceid, self.num_touches)
        )
        return buf.getvalue()
...
class ValuatorClass(xcffib.Struct):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=HHHHI", self.type, self.len, self.sourceid, self.number, self.label
            )
        )
        buf.write(
            self.min.pack()
            if hasattr(self.min, "pack")
            else FP3232.synthetic(*self.min).pack()
        )
        buf.write(
            self.max.pack()
            if hasattr(self.max, "pack")
            else FP3232.synthetic(*self.max).pack()
        )
        buf.write(
            self.value.pack()
            if hasattr(self.value, "pack")
            else FP3232.synthetic(*self.value).pack()
        )
    ...
    @classmethod
    def synthetic(
        cls, type, len, sourceid, number, label, min, max, value, resolution, mode
    ):
        self = cls.__new__(cls)
        self.type = type
        self.len = len
...
class XIDeviceInfo(xcffib.Struct):
    ...
    @classmethod
    def synthetic(
        cls, deviceid, type, attachment, num_classes, name_len, enabled, name, classes
    ):
        self = cls.__new__(cls)
        self.deviceid = deviceid
        self.type = type
...
class DeviceValuatorEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        base = unpacker.offset
        self.device_id, self.device_state, self.num_valuators, self.first_valuator = (
            unpacker.unpack("xB2xHBB")
        )
    ...
    @classmethod
    def synthetic(
        cls, device_id, device_state, num_valuators, first_valuator, valuators
    ):
        self = cls.__new__(cls)
        self.device_id = device_id
...
class DeviceKeyPressEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.same_screen,
            self.device_id,
        ) = unpacker.unpack("xB2xIIIIhhhhHBB")
        self.bufsize = unpacker.offset - base
...
class DeviceFocusInEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.detail, self.time, self.window, self.mode, self.device_id = (
            unpacker.unpack("xB2xIIBB18x")
        )
        self.bufsize = unpacker.offset - base
...
class DeviceMappingNotifyEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.device_id, self.request, self.first_keycode, self.count, self.time = (
            unpacker.unpack("xB2xBBBxI20x")
        )
        self.bufsize = unpacker.offset - base
...
class DevicePresenceNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=x2xIBBH20x", self.time, self.devchange, self.device_id, self.control
            )
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
...
class DevicePropertyNotifyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=B2xII19xB", self.state, self.time, self.property, self.device_id
            )
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
...
class DeviceChangedEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Event.__init__(self, unpacker)
        base = unpacker.offset
        self.deviceid, self.time, self.num_classes, self.sourceid, self.reason = (
            unpacker.unpack("xx2xHIHHB11x")
        )
        self.classes = xcffib.List(unpacker, DeviceClass, self.num_classes)
        self.bufsize = unpacker.offset - base
...
class KeyPressEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.sourceid,
            self.flags,
        ) = unpacker.unpack("xx2xHIIIIIiiiiHHH2xI")
        self.mods = ModifierInfo(unpacker)
        unpacker.pad(GroupInfo)
        self.group = GroupInfo(unpacker)
        unpacker.pad("I")
    ...
    def pack(self):
        ...
        buf.write(
            self.mods.pack()
            if hasattr(self.mods, "pack")
            else ModifierInfo.synthetic(*self.mods).pack()
        )
        buf.write(
            self.group.pack()
            if hasattr(self.group, "pack")
            else GroupInfo.synthetic(*self.group).pack()
        )
...
class EnterEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.focus,
            self.buttons_len,
        ) = unpacker.unpack("xx2xHIHBBIIIiiiiBBH")
        self.mods = ModifierInfo(unpacker)
        unpacker.pad(GroupInfo)
        self.group = GroupInfo(unpacker)
        unpacker.pad("I")
...
class HierarchyInfo(xcffib.Struct):
    ...
    def __init__(self, unpacker):
        ...
        xcffib.Struct.__init__(self, unpacker)
        base = unpacker.offset
        self.deviceid, self.attachment, self.type, self.enabled, self.flags = (
            unpacker.unpack("HHBB2xI")
        )
        self.bufsize = unpacker.offset - base
...
class HierarchyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=x2xHIIH10x", self.deviceid, self.time, self.flags, self.num_infos
            )
        )
...
class PropertyEvent(xcffib.Event):
    ...
    def pack(self):
        ...
        buf.write(
            struct.pack(
                "=x2xHIIB11x", self.deviceid, self.time, self.property, self.what
            )
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
...
class TouchOwnershipEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.sourceid,
            self.flags,
        ) = unpacker.unpack("xx2xHIIIIIH2xI8x")
        self.bufsize = unpacker.offset - base
...
class BarrierHitEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.root_x,
            self.root_y,
        ) = unpacker.unpack("xx2xHIIIIIIIH2xii")
    ...
    def pack(self):
        ...
        buf.write(
            self.dx.pack()
            if hasattr(self.dx, "pack")
            else FP3232.synthetic(*self.dx).pack()
        )
        buf.write(
            self.dy.pack()
            if hasattr(self.dy, "pack")
            else FP3232.synthetic(*self.dy).pack()
        )
        buf_len = len(buf.getvalue())
        if buf_len < 32:
            buf.write(struct.pack(("%dx" % (32 - buf_len))))
...
class GesturePinchBeginEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.delta_angle,
            self.sourceid,
        ) = unpacker.unpack("xx2xHIIIIIiiiiiiiiiiH2x")
        self.mods = ModifierInfo(unpacker)
        unpacker.pad(GroupInfo)
        self.group = GroupInfo(unpacker)
...
class GestureSwipeBeginEvent(xcffib.Event):
    ...
    def __init__(self, unpacker):
        ...
        (
            ...
            self.delta_unaccel_y,
            self.sourceid,
        ) = unpacker.unpack("xx2xHIIIIIiiiiiiiiH2x")
        self.mods = ModifierInfo(unpacker)
        unpacker.pad(GroupInfo)
        self.group = GroupInfo(unpacker)
        (self.flags,) = unpacker.unpack("I")
...
class xinputExtension(xcffib.Extension):
    def GetExtensionVersion(self, name_len, name, is_checked=True):
        ...
        return self.send_request(
            1, buf, GetExtensionVersionCookie, is_checked=is_checked
        )
    ...
    def GetSelectedExtensionEvents(self, window, is_checked=True):
        ...
        return self.send_request(
            7, buf, GetSelectedExtensionEventsCookie, is_checked=is_checked
        )

    def ChangeDeviceDontPropagateList(
        self, window, num_classes, mode, classes, is_checked=False
    ):
        buf = io.BytesIO()
    ...
    def GetDeviceDontPropagateList(self, window, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xI", window))
        return self.send_request(
            9, buf, GetDeviceDontPropagateListCookie, is_checked=is_checked
        )
    ...
    def GetDeviceMotionEvents(self, start, stop, device_id, is_checked=True):
        ...
        return self.send_request(
            10, buf, GetDeviceMotionEventsCookie, is_checked=is_checked
        )
    ...
    def ChangeKeyboardDevice(self, device_id, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xB3x", device_id))
        return self.send_request(
            11, buf, ChangeKeyboardDeviceCookie, is_checked=is_checked
        )
    ...
    def ChangePointerDevice(self, x_axis, y_axis, device_id, is_checked=True):
        ...
        return self.send_request(
            12, buf, ChangePointerDeviceCookie, is_checked=is_checked
        )
    ...
    def GetFeedbackControl(self, device_id, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xB3x", device_id))
        return self.send_request(
            22, buf, GetFeedbackControlCookie, is_checked=is_checked
        )

    def ChangeFeedbackControl(
        self, mask, device_id, feedback_id, feedback, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(struct.pack("=xx2xIBB2x", mask, device_id, feedback_id))
        buf.write(
            feedback.pack()
            if hasattr(feedback, "pack")
            else FeedbackCtl.synthetic(*feedback).pack()
        )
    ...
    def GetDeviceKeyMapping(self, device_id, first_keycode, count, is_checked=True):
        ...
        return self.send_request(
            24, buf, GetDeviceKeyMappingCookie, is_checked=is_checked
        )
    ...
    def GetDeviceModifierMapping(self, device_id, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xB3x", device_id))
        return self.send_request(
            26, buf, GetDeviceModifierMappingCookie, is_checked=is_checked
        )

    def SetDeviceModifierMapping(
        self, device_id, keycodes_per_modifier, keymaps, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(struct.pack("=xx2xBB2x", device_id, keycodes_per_modifier))
        buf.write(xcffib.pack_list(keymaps, "B"))
        return self.send_request(
            27, buf, SetDeviceModifierMappingCookie, is_checked=is_checked
        )
    ...
    def GetDeviceButtonMapping(self, device_id, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xB3x", device_id))
        return self.send_request(
            28, buf, GetDeviceButtonMappingCookie, is_checked=is_checked
        )
    ...
    def SetDeviceButtonMapping(self, device_id, map_size, map, is_checked=True):
        ...
        return self.send_request(
            29, buf, SetDeviceButtonMappingCookie, is_checked=is_checked
        )
    ...
    def DeviceBell(
        self, device_id, feedback_id, feedback_class, percent, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xx2xBBBb", device_id, feedback_id, feedback_class, percent)
        )
        return self.send_request(32, buf, is_checked=is_checked)

    def SetDeviceValuators(
        self, device_id, first_valuator, num_valuators, valuators, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(struct.pack("=xx2xBBBx", device_id, first_valuator, num_valuators))
        buf.write(xcffib.pack_list(valuators, "i"))
        return self.send_request(
            33, buf, SetDeviceValuatorsCookie, is_checked=is_checked
        )
    ...
    def ChangeDeviceControl(self, control_id, device_id, control, is_checked=True):
        ...
        return self.send_request(
            35, buf, ChangeDeviceControlCookie, is_checked=is_checked
        )
    ...
    def ListDeviceProperties(self, device_id, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xB3x", device_id))
        return self.send_request(
            36, buf, ListDevicePropertiesCookie, is_checked=is_checked
        )
    ...
    def ChangeDeviceProperty(
        ...
        buf.write(
            struct.pack(
                "=xx2xIIBBBxI", property, type, device_id, format, mode, num_items
            )
        )
    ...
    def GetDeviceProperty(
        self, property, type, offset, len, device_id, delete, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xx2xIIIIBB2x", property, type, offset, len, device_id, delete)
        )
        return self.send_request(
            39, buf, GetDevicePropertyCookie, is_checked=is_checked
        )
    ...
    def XIGetClientPointer(self, window, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xI", window))
        return self.send_request(
            45, buf, XIGetClientPointerCookie, is_checked=is_checked
        )
    ...
    def XIAllowEvents(
        self, time, deviceid, event_mode, touchid, grab_window, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xx2xIHBxII", time, deviceid, event_mode, touchid, grab_window)
        )
    ...
    def XIPassiveGrabDevice(
        ...
        return self.send_request(
            54, buf, XIPassiveGrabDeviceCookie, is_checked=is_checked
        )
    ...
    def XIPassiveUngrabDevice(
        ...
        buf.write(
            struct.pack(
                "=xx2xIIHHB3x", grab_window, detail, deviceid, num_modifiers, grab_type
            )
        )
        buf.write(xcffib.pack_list(modifiers, "I"))
    ...
    def XIChangeProperty(
        self, deviceid, mode, format, property, type, num_items, items, is_checked=False
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack(
                "=xx2xHBBIII", deviceid, mode, format, property, type, num_items
            )
        )
        if format & PropertyFormat._8Bits:
            data8 = items.pop(0)
    ...
    def XIGetProperty(
        self, deviceid, delete, property, type, offset, len, is_checked=True
    ):
        buf = io.BytesIO()
        buf.write(
            struct.pack("=xx2xHBxIIII", deviceid, delete, property, type, offset, len)
        )
    ...
    def XIGetSelectedEvents(self, window, is_checked=True):
        ...
        buf.write(struct.pack("=xx2xI", window))
        return self.send_request(
            60, buf, XIGetSelectedEventsCookie, is_checked=is_checked
        )
