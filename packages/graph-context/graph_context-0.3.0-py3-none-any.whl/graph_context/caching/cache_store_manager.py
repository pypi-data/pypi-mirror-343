...
class CacheStoreManager:
    ...
    def __init__(self, config: CacheConfig):
        ...
        self.entity_store = CacheStore(
            maxsize=config.entity_cache_size,
            ttl=config.entity_cache_ttl
        )
        self.relation_store = CacheStore(
            maxsize=config.relation_cache_size,
            ttl=config.relation_cache_ttl
        )
        ...
        self.traversal_store = CacheStore(
            maxsize=config.traversal_cache_size,
            ttl=config.traversal_cache_ttl
        )
