...
class FloatVector2Schema(Schema):
    ...
    value: Incomplete
    size0: Incomplete
    def __init__(self, display_name: str = '2D Embedding', description: str = '', writable: bool = False, display_importance: float = 0, number_role: str = ...) -> None: ...

class FloatVector3Schema(Schema):
    """A schema for a 3D vector"""
    value: Incomplete
    size0: Incomplete
    def __init__(self, display_name: str = '3D Embedding', description: str = '', writable: bool = False, display_importance: float = 0, number_role: str = ...) -> None: ...
