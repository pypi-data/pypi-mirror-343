...
class EmbeddingsMetricsCollector(MetricsCollector):
    ...
    '''
    def __init__(self, layers: Sequence[int], reshape_strategy: dict[int, Literal['mean', 'flatten', 'avg_pool_1_1', 'avg_pool_2_2', 'avg_pool_3_3']] | dict[int, Callable[[torch.Tensor], torch.Tensor]] | None = None) -> None:
