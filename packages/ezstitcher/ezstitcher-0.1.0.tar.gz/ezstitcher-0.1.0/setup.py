...
setup(
    ...
    classifiers=[
        ...
        "Programming Language :: Python :: 3.11", # Specify 3.11 only
        "License :: OSI Approved :: MIT License",
        "Operating System :: OS Independent",
        # Consider adding Development Status, Audience, Topic classifiers later
    ],
    python_requires="==3.11", # Restrict to exactly 3.11
    install_requires=[
        "numpy>=1.20.0",
        "scikit-image>=0.18.0",
        "scipy>=1.6.0",
