...
from seuvm._seuvmv2 import Seuvmv2
...
# seuvmv2 = Seuvmv2()
#
# # значение индекса F10.7 = 90 s.f.u.
# f107 = 90.0
#
# # расчёт спектров с помощью моделей
# seuvmv0_spectra = seuvmv0.predict(f107)['euv_flux_spectra']
# seuvmv1_spectra = seuvmv1.predict(f107)['euv_flux_spectra']
# seuvmv2_spectra = seuvmv2.predict(f107)['euv_flux_spectra']
#
# # построение графиков спектров
# plt.semilogy(seuvmv0_spectra, color='r', label='SEUVMv0')
# plt.semilogy(seuvmv1_spectra, color='g', label='SEUVMv1')
# plt.semilogy(seuvmv2_spectra, color='b', label='SEUVMv2')
# plt.xlabel('F10.7, s.f.u.')
# plt.ylabel('I, Вт / м^2 / nm')
# plt.legend()
# plt.show()

seuv = Seuvmv0()
print(seuv.predict(100))
