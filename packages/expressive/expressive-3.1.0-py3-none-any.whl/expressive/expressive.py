...
class Expressive:
    ...
    def __init__(
        ...
        *,
        ...
        # fill additional arg members
        self._config.update(parallel_model)
        self._config["builder.allow_autobuild"] = allow_autobuild  # TODO enable global override
    ...
    def __repr__(self):
        ...
        allow_autobuild = self._config["builder.allow_autobuild"]
        content = [
    ...
    def __call__(self, data, dtype_result=None):
        ...
        try:
            ...
            if not self._config["builder.allow_autobuild"]:
