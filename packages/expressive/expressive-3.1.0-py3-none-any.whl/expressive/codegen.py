...
def loop_function_template_builder(expr, symbols, indexers, results, result_passed, dtype_result, data, config):
    ...
    allow_prange = test_allow_prange(data, config)
