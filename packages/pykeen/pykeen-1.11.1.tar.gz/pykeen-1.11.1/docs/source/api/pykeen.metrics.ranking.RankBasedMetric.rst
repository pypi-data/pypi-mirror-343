...
.. autoclass:: RankBasedMetric
   ...
   .. autosummary::
      ...
      ~RankBasedMetric.closed_expectation
      ~RankBasedMetric.closed_variance
      ~RankBasedMetric.key
      ~RankBasedMetric.needs_candidates
      ~RankBasedMetric.supported_rank_types
      ~RankBasedMetric.supports_weights
      ~RankBasedMetric.synonyms
   ...
   .. autosummary::
      ...
      ~RankBasedMetric.extra_repr
      ~RankBasedMetric.get_description
      ~RankBasedMetric.get_link
      ~RankBasedMetric.get_range
      ~RankBasedMetric.get_sampled_values
      ~RankBasedMetric.iter_extra_repr
   ...
   .. autoattribute:: closed_expectation
   .. autoattribute:: closed_variance
   .. autoattribute:: key
   .. autoattribute:: needs_candidates
   .. autoattribute:: supported_rank_types
   .. autoattribute:: supports_weights
