...
class PanoptoDownloader:
    ...
    def __init__(self, browser_session: BrowserSession, max_workers: int = None):
    ...
    def download_direct(self, url: str, output_path: str, chunk_size: int = 8192, max_retries: int = 3) -> bool:
    ...
    def download_videos(self, video_list: List[Tuple[str, str]], download_dir: str) -> Tuple[int, int]:
