...
class TelescopeServer(object):
    ...
    def in_position(self, verbose=False):
        """
        ...
        try:
            ...
            if verbose:
                if ready:
                    print("MACS follow error OK")
                else:
                    print("MACS follow error too high")
            # has mirror settled?
            ...
            if verbose:
                if ready:
                    ...
                    print("M1 noise too high")
        except Exception as err:
            # failed to read status, don't assume OK.
            ready = False
            if verbose:
                print("Failed to read telescope status: ", err)
