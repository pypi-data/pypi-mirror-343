...
def build_upload_file_request(
    ...
    **kwargs: Any,
    ...
    if data_format is not None:
        _params["dataFormat"] = _SERIALIZER.query("data_format", data_format, "str")
    if compression_format is not None:
        _params["compressionFormat"] = _SERIALIZER.query(
            "compression_format", compression_format, "str"
        )
    ...
    return HttpRequest(
        method="POST",
        url=f"/v1/projects/{project_id}/files",
        headers=_headers,
        files=files,
        params=_params,
    )
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                self.client.project_files.upload_file(data)
        """
