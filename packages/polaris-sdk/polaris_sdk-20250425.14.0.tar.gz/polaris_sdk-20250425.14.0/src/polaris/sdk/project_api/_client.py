...
class ImplyPolarisProjectClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    * Codes in the ``5xx`` range indicate an error with the Imply servers.
    ...
    :vartype alerts: polaris.sdk.project_api.operations.AlertsOperations
    :ivar network_policy: NetworkPolicyOperations operations
    :vartype network_policy: polaris.sdk.project_api.operations.NetworkPolicyOperations
    :ivar collections: CollectionsOperations operations
    :vartype collections: polaris.sdk.project_api.operations.CollectionsOperations
    :ivar connections: ConnectionsOperations operations
    :vartype connections: polaris.sdk.project_api.operations.ConnectionsOperations
    :ivar dashboards: DashboardsOperations operations
    :vartype dashboards: polaris.sdk.project_api.operations.DashboardsOperations
    :ivar data_cubes: DataCubesOperations operations
    :vartype data_cubes: polaris.sdk.project_api.operations.DataCubesOperations
    :ivar embedding_links: EmbeddingLinksOperations operations
    :vartype embedding_links: polaris.sdk.project_api.operations.EmbeddingLinksOperations
    :ivar events: EventsOperations operations
    :vartype events: polaris.sdk.project_api.operations.EventsOperations
    :ivar files: FilesOperations operations
    :vartype files: polaris.sdk.project_api.operations.FilesOperations
    :ivar lookups: LookupsOperations operations
    :vartype lookups: polaris.sdk.project_api.operations.LookupsOperations
    :ivar jobs: JobsOperations operations
    :vartype jobs: polaris.sdk.project_api.operations.JobsOperations
    :ivar query: QueryOperations operations
    :vartype query: polaris.sdk.project_api.operations.QueryOperations
    :ivar reports: ReportsOperations operations
    :vartype reports: polaris.sdk.project_api.operations.ReportsOperations
    :ivar tables: TablesOperations operations
    :vartype tables: polaris.sdk.project_api.operations.TablesOperations
