...
from ._configuration import ImplyPolarisRegionalClientConfiguration
from .operations import ProjectsOperations


class ImplyPolarisRegionalClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    * Codes in the ``5xx`` range indicate an error with the Imply servers.
    ...
    :vartype projects: polaris.sdk.regional_api.aio.operations.ProjectsOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self._config = ImplyPolarisRegionalClientConfiguration(**kwargs)
