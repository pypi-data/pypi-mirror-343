...
class ImplyPolarisRegionalClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for ImplyPolarisRegionalClient.
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "polaris-sdk/{}".format(VERSION))
