...
from ._configuration import ImplyPolarisGlobalClientConfiguration
...
class ImplyPolarisGlobalClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    * Codes in the ``5xx`` range indicate an error with the Imply servers.
    ...
    :vartype api_keys: polaris.sdk.global_api.aio.operations.ApiKeysOperations
    :ivar audit: AuditOperations operations
    :vartype audit: polaris.sdk.global_api.aio.operations.AuditOperations
    :ivar customizations: CustomizationsOperations operations
    :vartype customizations: polaris.sdk.global_api.aio.operations.CustomizationsOperations
    :ivar identity: IdentityOperations operations
    :vartype identity: polaris.sdk.global_api.aio.operations.IdentityOperations
    :ivar metrics: MetricsOperations operations
    :vartype metrics: polaris.sdk.global_api.aio.operations.MetricsOperations
    :ivar projects: ProjectsOperations operations
    :vartype projects: polaris.sdk.global_api.aio.operations.ProjectsOperations
    :keyword endpoint: Service URL. Default value is "https://api.imply.io".
    :paramtype endpoint: str
    """

    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        self, *, endpoint: str = "https://api.imply.io", **kwargs: Any
    ) -> None:
        self._config = ImplyPolarisGlobalClientConfiguration(**kwargs)
        ...
        self.audit = AuditOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.customizations = CustomizationsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
