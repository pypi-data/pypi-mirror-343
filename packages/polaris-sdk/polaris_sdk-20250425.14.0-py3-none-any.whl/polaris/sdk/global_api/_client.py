...
class ImplyPolarisGlobalClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    * Codes in the ``5xx`` range indicate an error with the Imply servers.
    ...
    :vartype api_keys: polaris.sdk.global_api.operations.ApiKeysOperations
    :ivar audit: AuditOperations operations
    :vartype audit: polaris.sdk.global_api.operations.AuditOperations
    :ivar customizations: CustomizationsOperations operations
    :vartype customizations: polaris.sdk.global_api.operations.CustomizationsOperations
    :ivar identity: IdentityOperations operations
    :vartype identity: polaris.sdk.global_api.operations.IdentityOperations
    :ivar metrics: MetricsOperations operations
    :vartype metrics: polaris.sdk.global_api.operations.MetricsOperations
    :ivar projects: ProjectsOperations operations
    :vartype projects: polaris.sdk.global_api.operations.ProjectsOperations
