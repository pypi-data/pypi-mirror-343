...
from achatbot.common.utils.helper import print_model_params
...
class Qwen2_5OmniForConditionalGenerationStreaming(Qwen2_5OmniForConditionalGeneration):
    ...
    def thinker_generate_chunk(
        ...
        **kwargs,
        ...
        logging.debug(
            f"thinker_max_tokens_per_step: {thinker_max_tokens_per_step} | first chunk generated cost: {times[0]} s | total cost: {sum(times)} s"
        )
