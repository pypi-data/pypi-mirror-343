...
def write(fp, data, *args):
    ...
    - For CSV files (.csv), the tuple contains:
      ...
      - `headers` (list | tuple): The headers for the CSV columns.
...
def read_id(fp, usecols, filter=None) -> OrderedSet:
    ...
    Args:
        ...
        usecols (str | tuple | list): The column name(s) to extract from the CSV file.
                                      Can be a single column name (str) or a list/tuple of names for multiple fields.
