...
class GreekAPI:
    def __init__(self, user,s_pwd, pwd,procli,ac_no,is_secure,is_base_64):
        self.username = user
        ...
        self.rest_ip = " " # to be filled by the client or support team
        self.rest_port = "3333"
    ...
    def place_order(self,tokenno,symbol,lot,qty,price,buysell,ordtype,trigprice,exchange,strategyname):
        ...
        if df_order_response['svcName'][0]=='NewOrderRequestResponse':
            return df_order_response['data.gorderid'][0]
        elif df_order_response['svcName'][0]=='IrisRejection':
            return df_order_response['data.gorderid'][0]+ " reason "+df_order_response['data.reason'][0]
    ...
    def Order_Trade_status(self,ord_id):
        ...
        return response['data'][0]['order_status']
