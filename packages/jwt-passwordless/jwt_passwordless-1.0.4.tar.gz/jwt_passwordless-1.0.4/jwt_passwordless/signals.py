                ...
                try:
                    ...
                    if instance_email != old_email and instance_email != "" and instance_email is not None:
                        ...
                        if api_settings.PASSWORDLESS_AUTO_SEND_VERIFICATION_TOKEN is True:
                            ...
                            if success:
                                logger.info('jwt_passwordless: Successfully sent email on updated address: %s'
                                            % instance_email)
                            else:
                                logger.info('jwt_passwordless: Failed to send email to updated address: %s'
                                            % instance_email)
                ...
                try:
                    ...
                    if instance_mobile != old_mobile and instance_mobile != "" and instance_mobile is not None:
                        ...
                        if api_settings.PASSWORDLESS_AUTO_SEND_VERIFICATION_TOKEN is True:
                            ...
                            if success:
                                logger.info('jwt_passwordless: Successfully sent SMS on updated mobile: %s'
                                            % instance_mobile)
                            else:
                                logger.info('jwt_passwordless: Failed to send SMS to updated mobile: %s'
                                            % instance_mobile)
