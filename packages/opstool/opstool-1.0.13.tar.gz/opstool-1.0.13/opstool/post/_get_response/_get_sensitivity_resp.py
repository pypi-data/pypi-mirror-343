...
class SensitivityRespStepData(ResponseBase):
    def __init__(self, node_tags=None, ele_tags=None, sens_para_tags=None):
        self.resp_names = [
            "disp",
            "vel",
            "accel",
...
def _get_nodal_sens_resp(node_tags, sens_para_tags):
...
def _get_sens_lambda(sens_para_tags):
    ...
    return np.array(all_sens_lambdas)
