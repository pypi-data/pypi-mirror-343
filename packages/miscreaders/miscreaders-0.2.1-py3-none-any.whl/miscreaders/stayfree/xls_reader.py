...
class StayfreeXlsReader:
    ...
    This parser reads file that can be manually exported from the Android app
    (as of 18.8.4) by the slightly confusing way of: *Settings* > *Storage* > *Export to CSV*.
    Despite the menu mentioning CSV, the exported file is actually XLS (old-style Excel file).

    See Also:
        :py:class:`StayfreeBackupReader` for a more readily automated way of getting the data.
