...
class CreateInvoiceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collection_method", "coupon_id", "custom_fields", "customer_id", "description", "email_invoice_on_finalization", "finalize_invoice_immediately", "invoice_type", "is_preview", "net_d", "payment_method_id", "selected_product_price_quantity", "subscription_id"]
