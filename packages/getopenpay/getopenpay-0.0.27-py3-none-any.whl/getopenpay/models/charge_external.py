...
class ChargeExternal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount_atom", "created_at", "currency", "custom_fields", "customer_id", "disputed", "failure_code", "failure_message", "id", "invoice_id", "is_deleted", "object", "payment_intent_id", "payment_intent_mapping_id", "payment_method", "payment_method_id", "payment_processor_id", "payment_processor_name", "provider_type_fee_amount_atom", "refunded", "refunded_amount_atom", "status", "subscription_ids", "subscriptions", "total_charge_amount_atom", "updated_at"]
