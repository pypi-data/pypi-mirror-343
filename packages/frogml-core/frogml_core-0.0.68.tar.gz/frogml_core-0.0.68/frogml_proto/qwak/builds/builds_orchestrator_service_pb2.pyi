...
import frogml_proto.qwak.builds.build_url_pb2
import sys
...
class BuildModelRequest(google.protobuf.message.Message):
    ...
    @property
    def build_spec(self) -> frogml_proto.qwak.builds.build_pb2.RemoteBuildSpec:
        """Requested build model spec"""
    def __init__(
        self,
        *,
        build_spec: frogml_proto.qwak.builds.build_pb2.RemoteBuildSpec | None = ...,
    ) -> None: ...
...
class GetBuildVersioningUploadURLRequest(google.protobuf.message.Message):
    ...
    @property
    def params(self) -> frogml_proto.qwak.builds.build_url_pb2.BuildVersioningUrlParams:
        """The params to define the url."""
    def __init__(
        self,
        *,
        params: frogml_proto.qwak.builds.build_url_pb2.BuildVersioningUrlParams | None = ...,
    ) -> None: ...
...
class ListBuildVersioningTagsRequest(google.protobuf.message.Message):
    ...
    @property
    def build_versioning_tags(self) -> frogml_proto.qwak.builds.build_url_pb2.BuildVersioningTags:
        """The params to define the urls."""
    def __init__(
        self,
        *,
        build_versioning_tags: frogml_proto.qwak.builds.build_url_pb2.BuildVersioningTags | None = ...,
    ) -> None: ...
...
class CreateDataTableRequest(google.protobuf.message.Message):
    ...
    @property
    def table(self) -> frogml_proto.qwak.builds.build_pb2.DataTableDefinition:
        """Table Definition"""
    path: builtins.str
    ...
    def __init__(
        ...
        *,
        ...
        build_id: builtins.str = ...,
        tag: builtins.str = ...,
        table: frogml_proto.qwak.builds.build_pb2.DataTableDefinition | None = ...,
        path: builtins.str = ...,
    ) -> None: ...
...
class GetBaseDockerImageNameRequest(google.protobuf.message.Message):
    ...
    base_docker_image_type: frogml_proto.qwak.builds.build_pb2.BaseDockerImageType.ValueType
    def __init__(
        self,
        *,
        base_docker_image_type: frogml_proto.qwak.builds.build_pb2.BaseDockerImageType.ValueType = ...,
...
class SaveArtifactPathRequest(google.protobuf.message.Message):
    ...
    @property
    def artifact_path_spec(self) -> frogml_proto.qwak.builds.build_url_pb2.BuildArtifactPathSpec:
        """The artifact path specification"""
    def __init__(
        self,
        *,
        artifact_path_spec: frogml_proto.qwak.builds.build_url_pb2.BuildArtifactPathSpec | None = ...,
    ) -> None: ...
