...
from utils.utilities import PDFTestProcessor
...
class TestScriptGenerator:
    ...
    def __init__(self, input_dir: str = "input_pdfs", output_dir: str = "tests"):
        self.input_dir = "input_pdfs"  # Always use input_pdfs as the main directory
        self.output_dir = output_dir
        self.processor = PDFTestProcessor(self.input_dir)
        self.template_env = Environment(loader=FileSystemLoader('utils/templates'))
...
class PDFHandler(FileSystemEventHandler):
    ...
    def __init__(self, generator: TestScriptGenerator):
...
def start_pdf_watcher(input_path: str = "input_pdfs"):
    ...
    if os.path.isfile(input_path):
        ...
        generator = TestScriptGenerator(watch_dir, output_dir)
