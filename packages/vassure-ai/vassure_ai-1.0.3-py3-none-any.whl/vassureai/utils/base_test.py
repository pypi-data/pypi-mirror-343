...
from utils.pdfgenerator import TestReport
from utils.utilities import initialize_llm, save_screenshot, determine_status, get_timestamp
from utils.config import Config
from utils.controller_setup import register_controller
...
class BaseTest:
    ...
    def setup_base(self):
        ...
        self.report = TestReport(filename_prefix=self.test_name or self.__class__.__name__)
