    ...
    def create_jitter(self, overlap_dis=0.05):
        ...
        if self.multi:
            ...
            with Manager() as manager:
                ...
                # num = int(cpu_count() / 2)
                # num = 10
                ilog.debug(f"stitch using {self.num} process")
        ...
        ilog.debug("Scan image done!")

    def jitter_eval(self, height, width, overlap=[0.1, 0.1]):
        """
