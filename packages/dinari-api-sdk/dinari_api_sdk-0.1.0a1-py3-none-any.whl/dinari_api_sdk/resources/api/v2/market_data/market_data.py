...
from .....types.api.v2.market_data_get_market_hours_response import MarketDataGetMarketHoursResponse
    ...
    def get_market_hours(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=MarketDataGetMarketHoursResponse,
        )
...
class MarketDataResourceWithRawResponse:
    def __init__(self, market_data: MarketDataResource) -> None:
        ...
        self.get_market_hours = to_raw_response_wrapper(
            market_data.get_market_hours,
        )
...
class AsyncMarketDataResourceWithRawResponse:
    def __init__(self, market_data: AsyncMarketDataResource) -> None:
        ...
        self.get_market_hours = async_to_raw_response_wrapper(
            market_data.get_market_hours,
        )
...
class MarketDataResourceWithStreamingResponse:
    def __init__(self, market_data: MarketDataResource) -> None:
        ...
        self.get_market_hours = to_streamed_response_wrapper(
            market_data.get_market_hours,
        )
...
class AsyncMarketDataResourceWithStreamingResponse:
    def __init__(self, market_data: AsyncMarketDataResource) -> None:
        ...
        self.get_market_hours = async_to_streamed_response_wrapper(
            market_data.get_market_hours,
        )
