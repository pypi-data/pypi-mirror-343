...
from ......types.api.v2.market_data import (
    stock_list_params,
    stock_retrieve_news_params,
    stock_retrieve_historical_prices_params,
)
from ......types.api.v2.market_data.stock_list_response import StockListResponse
from ......types.api.v2.market_data.stock_retrieve_news_response import StockRetrieveNewsResponse
from ......types.api.v2.market_data.stock_retrieve_quote_response import StockRetrieveQuoteResponse
from ......types.api.v2.market_data.stock_retrieve_dividends_response import StockRetrieveDividendsResponse
from ......types.api.v2.market_data.stock_retrieve_historical_prices_response import (
...
class StocksResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        symbols: List[str] | NotGiven = NOT_GIVEN,
