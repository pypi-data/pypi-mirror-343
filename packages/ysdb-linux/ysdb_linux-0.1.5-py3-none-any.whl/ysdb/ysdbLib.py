...
if platform.system() == 'Windows':
	lib_name = 'win/ysdbLib.dll'
elif platform.system() == 'Linux':
	lib_name = 'linux/libysdbLib.so'
elif platform.system() == 'Darwin':
	raise Exception(f"YSDB not supported on platform {platform.system()} (macos)")
else:
	raise Exception(f"YSDB not supported on platform {platform.system()}")
