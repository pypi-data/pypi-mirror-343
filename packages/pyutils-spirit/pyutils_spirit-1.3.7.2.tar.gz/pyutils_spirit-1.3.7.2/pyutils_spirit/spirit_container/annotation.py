...
class ContainerAnnotation:
    __spirit_application_container: ThreadHolder = None
    ...
    def component(cls, signature: str) -> callable:
        ...
        def get_component_cls(other_cls):
            ...
            def get_component_instance(*args, **kwargs) -> object:
                if cls.__spirit_application_container is None:
                    cls.__spirit_application_container = ThreadHolder.constructor()
