...
if __name__ == '__main__':
    ...
    if use_pp:
        ...
        dask.config.set(scheduler='processes', num_workers = 12) # each cpu can provide 2 workers
...
#%% Forecasting        
    if "forecast" in mode:
        ...
        export_GSIM_to_openquake() #need to do only one time
...
#%% Upscale grid (experimental)
            ...
            image_overlay = ImageOverlay(
                ...
                image="overlay_with_transparency.png", #use png file instead of numpy array 
                bounds=bounds,
                opacity=0.6,
                interactive=True,
                name="Estimated PGA"
