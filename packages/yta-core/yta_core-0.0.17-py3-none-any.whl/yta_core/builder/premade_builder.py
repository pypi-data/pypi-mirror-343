...
from yta_core.builder.enums import Premade
...
class PremadeBuilder(Builder):
    ...
    def build(
        ...
        parameters = PremadeBuilder.get_parameters_from_method(method, element)
