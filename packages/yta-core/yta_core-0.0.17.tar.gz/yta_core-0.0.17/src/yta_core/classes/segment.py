...
from yta_audio.voice.generation.narrator import MicrosoftVoiceNarrator
...
class Segment:
    ...
    def _create_voice_narration(
        ...
        if self.has_voice_narration:
            ...
            segment_part_filename = self._create_segment_file(f'narration.{get_file_extension(self.voice_narration_filename_processed)}')
