from nnunet_extend.network_architecture.DSCNet.DSCNet_3D.S3_DSCNet import DCN_Conv, EncoderConv, DecoderConv
import torch
from torch import nn, cat
from torch.nn.functional import dropout


class DSCNet_3DTiny(nn.Module):
    def __init__(self, n_channels, n_classes, kernel_size, extend_scope, if_offset, device, number):
        super(DSCNet_3DTiny, self).__init__()
        self.device = device
