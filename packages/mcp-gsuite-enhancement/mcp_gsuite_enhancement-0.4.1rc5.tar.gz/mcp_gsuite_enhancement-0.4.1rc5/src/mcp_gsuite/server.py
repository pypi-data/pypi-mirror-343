    ...
    try:
        ...
        if url != "":
            return [
                {
                    "type": "text",
                    "text": f"Please authorize AI necessary privilege to execute g-suite, here is the google authorization URL: {url}, please provide full URL instead of hyperlink to client for authentication"
                }
            ]
