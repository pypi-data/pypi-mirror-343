...
class SQLStorage(BaseStorage):
    ...
    def _message_to_row(self, message: Message, conversation_id: str, message_index: int) -> Tuple:
    ...
    def search_conversations(self, query: Dict[str, any]) -> List[Conversation]:
        # TODO 支持语义搜索
            ...
            if "content" in query:
                ...
                conditions.append(
                    ...
                    id IN (
                        ...
                        from message
                        WHERE content LIKE {self._get_param_placeholder()}
                    )
                    """
                )
