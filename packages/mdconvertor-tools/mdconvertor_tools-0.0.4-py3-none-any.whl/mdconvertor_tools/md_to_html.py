...
def transform(md_path, output_dir="", output_format=""):
    ...
    <html lang="en" class="scroll-smooth bg-gray-50 text-gray-900 antialiased">
        <head>
            ...
            <!-- Tailwind CSS -->
            <link href="file:///{centralized_tailwind_path}" rel="stylesheet">

            <!-- MathJax -->
            <script type="text/javascript" id="MathJax-script" async
                src="file:///{centralized_mathjax_path}"></script>

            <!-- Custom CSS -->
            <link rel="stylesheet" href="file:///{centralized_css_path}" />
        </head>
    ...
    html_template = html_template.replace("{centralized_mathjax_path}", setup_mathjax())
    html_template = html_template.replace("{centralized_css_path}", setup_custom_css())
    html_template = html_template.replace("{centralized_tailwind_path}", setup_tailwind())
