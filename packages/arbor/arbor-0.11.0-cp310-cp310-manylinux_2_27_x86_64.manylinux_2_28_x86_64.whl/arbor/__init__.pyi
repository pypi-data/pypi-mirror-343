...
def modcc():
    ...
__config__: dict = {'mpi': False, 'mpi4py': False, 'gpu': None, 'vectorize': False, 'profiling': False, 'neuroml': True, 'bundled': False, 'version': '0.11.0', 'source': 'unknown commit', 'build_config': 'RELEASE', 'arch': 'native', 'prefix': '/tmp/tmpolqsjd1r/wheel/platlib/arbor', 'python_lib_path': '', 'binary_path': 'bin', 'lib_path': 'lib64', 'data_path': 'share', 'CXX': '/opt/rh/gcc-toolset-14/root/usr/bin/g++', 'pybind-version': '2.13.6', 'timestamp': 'Apr 24 2025 17:58:20'}
