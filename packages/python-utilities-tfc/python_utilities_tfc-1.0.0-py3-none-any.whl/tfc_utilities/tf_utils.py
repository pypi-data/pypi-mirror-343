...
def download_workspace_state(org_name, workspace_name, token=TERRAFORM_CLOUD_TOKEN, output_path="downloaded.tfstate"):
    """
...
def get_workspace_id(org_name, workspace_name, token=TERRAFORM_CLOUD_TOKEN):
    """
...
def get_variable_id(organization, workspace_id, target_variable_name, api_token=TERRAFORM_CLOUD_TOKEN, url="https://app.terraform.io"):
    """
...
def update_variable(organization, workspace_id, variable_id, new_value, api_token=TERRAFORM_CLOUD_TOKEN, url="https://app.terraform.io"):
    """
...
def trigger_run(organization, workspace_id, auto_apply, api_token=TERRAFORM_CLOUD_TOKEN, url="https://app.terraform.io"):
...
def get_run_status(organization, run_id, api_token=TERRAFORM_CLOUD_TOKEN, url="https://app.terraform.io"):
    headers = {
        'Authorization': f'Bearer {api_token}',
        'Content-Type': 'application/vnd.api+json'
    }
...
def monitor_run(organization, run_id):
    """
    Monitor the status of a Terraform run until it completes.
    """
    while True:
        status = get_run_status(organization, run_id)
