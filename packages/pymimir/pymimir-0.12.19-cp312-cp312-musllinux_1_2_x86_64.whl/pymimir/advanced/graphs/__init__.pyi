...
class CertificateColorRefinement:
    ...
    def get_canonical_configuration_compression_function(self) -> dict[tuple[int, list[int]], int]: ...
...
class Certficate2FWL:
    ...
    def get_canonical_configuration_compression_function(self) -> dict[tuple[int, list[list[int]]], int]: ...
