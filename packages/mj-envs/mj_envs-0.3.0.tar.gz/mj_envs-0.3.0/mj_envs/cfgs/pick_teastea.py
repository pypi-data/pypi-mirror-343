...
def random_xyz(i):
    return [random.uniform(-0.2, 0.2), random.uniform(0.2, 0.4), 0.02 + 0.03 * i ]
...
task_cfg = { 
    ...
    "default_poses": {
        "teastea": [0, 0.3, 0.02] + R.from_euler('xyz', [90, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
