...
def construct_scene(task, robot, thirdperson=False):
    ...
    model, root = _construct_scene(task_cfg, robot_cfg, thirdperson)
    return model

def _construct_scene(task_cfg, robot_cfg, thirdperson = False): 
