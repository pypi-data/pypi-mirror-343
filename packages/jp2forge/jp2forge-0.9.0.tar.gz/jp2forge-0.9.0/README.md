...
JP2Forge was created by [xy-liao](https://github.com/xy-liao) and was inspired by the BnF (Bibliothèque nationale de France) image format specifications. The implementation is original but follows the technical requirements described in their reference documents.

This project was developed with the assistance of AI tools which helped with code structure, documentation, and testing strategies. All implementation decisions and code architecture remain the responsibility of the author.
