...
class MatrixXd(object):
    ...
    @staticmethod
    def decode(data: T.Union[bytes, T.BinaryIO]) -> "MatrixXd":
    ...
    @staticmethod
    def _decode_one(buf: T.BinaryIO) -> "MatrixXd":
    ...
    def deepcopy(self, **kwargs: T.Any) -> "MatrixXd":
        """
