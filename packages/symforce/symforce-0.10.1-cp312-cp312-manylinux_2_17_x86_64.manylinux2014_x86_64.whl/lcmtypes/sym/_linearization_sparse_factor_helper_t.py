...
class linearization_sparse_factor_helper_t(object):
    __slots__: T.List[str] = ["residual_dim", "combined_residual_offset", "key_helpers", "jacobian_index_map", "hessian_index_map"]

    def __init__(
        self,
        residual_dim: int=0,
        combined_residual_offset: int=0,
        key_helpers: T.Optional[T.List[linearization_offsets_t]]=None,
        jacobian_index_map: T.Optional[T.Sequence[int]]=None,
        hessian_index_map: T.Optional[T.Sequence[int]]=None,
        ...
        self.key_helpers: T.List[linearization_offsets_t] = [] if key_helpers is None else key_helpers
        self.jacobian_index_map: T.Sequence[int] = [] if jacobian_index_map is None else jacobian_index_map
        self.hessian_index_map: T.Sequence[int] = [] if hessian_index_map is None else hessian_index_map

    @staticmethod
    def from_all_fields(
        residual_dim: int,
        combined_residual_offset: int,
        key_helpers: T.List[linearization_offsets_t],
        jacobian_index_map: T.Sequence[int],
        hessian_index_map: T.Sequence[int],
    ...
    @classmethod
    def _default(cls) -> "linearization_sparse_factor_helper_t":
        return cls()
    ...
    @staticmethod
    def decode(data: T.Union[bytes, T.BinaryIO]) -> "linearization_sparse_factor_helper_t":
    ...
    @staticmethod
    def _decode_one(buf: T.BinaryIO) -> "linearization_sparse_factor_helper_t":
    ...
    def deepcopy(self, **kwargs: T.Any) -> "linearization_sparse_factor_helper_t":
        """
