...
class Quaterniond(object):
    ...
    @staticmethod
    def decode(data: T.Union[bytes, T.BinaryIO]) -> "Quaterniond":
    ...
    @staticmethod
    def _decode_one(buf: T.BinaryIO) -> "Quaterniond":
    ...
    def deepcopy(self, **kwargs: T.Any) -> "Quaterniond":
        """
