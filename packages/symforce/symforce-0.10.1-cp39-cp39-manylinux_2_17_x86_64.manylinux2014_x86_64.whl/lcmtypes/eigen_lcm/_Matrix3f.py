...
class Matrix3f(object):
    ...
    def __init__(
        ...
        if _skip_initialize:
            return
        self.data: T.List[float] = [ 0.0 for dim0 in range(9) ] if data is None else data
    ...
    @staticmethod
    def decode(data: T.Union[bytes, T.BinaryIO]) -> "Matrix3f":
    ...
    @staticmethod
    def _decode_one(buf: T.BinaryIO) -> "Matrix3f":
    ...
    def deepcopy(self, **kwargs: T.Any) -> "Matrix3f":
        """
