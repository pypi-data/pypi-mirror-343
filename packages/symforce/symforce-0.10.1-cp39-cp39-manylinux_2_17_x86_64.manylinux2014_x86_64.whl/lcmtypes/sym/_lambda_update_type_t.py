...
class lambda_update_type_t(enum.Enum):
    ...
    def _skytype_meta():
        ...
        return dict(
            type="enum",
            package="sym",
            name="lambda_update_type_t",
        )

    @classmethod
    def _default(cls):
        # type: () -> lambda_update_type_t
    ...
    @classmethod
    def decode(cls, data):
        # type: (T.Union[bytes, T.BinaryIO]) -> lambda_update_type_t
    ...
    def _decode_one(cls, buf):
        # type: (T.BinaryIO) -> lambda_update_type_t
    ...
    def from_int(cls, value, default):
        # type: (int, lambda_update_type_t) -> lambda_update_type_t
        pass

    @T.overload
    @classmethod
    def from_int(cls, value, default=None):  # pylint: disable=function-redefined
        # type: (int, None) -> T.Optional[lambda_update_type_t]
        pass

    @classmethod
    def from_int(cls, value, default=None):  # pylint: disable=function-redefined
        # type: (int, T.Optional[lambda_update_type_t]) -> T.Optional[lambda_update_type_t]
        """
        An alternative to "lambda_update_type_t(value)" which will return
