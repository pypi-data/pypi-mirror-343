...
class Matrix4i(object):
    ...
    def __init__(
        ...
        if _skip_initialize:
            return
        self.data: T.List[int] = [ 0 for dim0 in range(16) ] if data is None else data
    ...
    @staticmethod
    def decode(data: T.Union[bytes, T.BinaryIO]) -> "Matrix4i":
    ...
    @staticmethod
    def _decode_one(buf: T.BinaryIO) -> "Matrix4i":
    ...
    def deepcopy(self, **kwargs: T.Any) -> "Matrix4i":
        """
