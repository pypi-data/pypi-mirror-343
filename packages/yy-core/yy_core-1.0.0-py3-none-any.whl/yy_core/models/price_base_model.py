...
from yy_core.models.act_base_model import *
from yy_core.models.launch_base_model import *
...
class PriceBaseModel():
    ...
    def save_price_gear(self, app_id, act_id, price_gear_id, relation_type, price_gear_name, price_gear_pic, price, goods_id, sku_id, remark="", sort_index=0, business_type=0):
        ...
        price_gear.modify_date = CoreHelper.get_now_datetime()
        ...
        if is_add:
            if sku_id != "":
                ...
                if price_gear_goodsid_skuid:
                    ...
                    return invoke_result_data
            price_gear.create_date = CoreHelper.get_now_datetime()
            price_gear.effective_date = CoreHelper.get_now_datetime()
