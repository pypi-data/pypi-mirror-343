...
@LastEditTime: 2025-04-23 18:34:40
@LastEditors: HuangJianYi
@Description: 
"""
from yy_core.libs.customize.safe_helper import SafeHelper
from yy_core.libs.customize.wechat_helper import WeChatPayRequest
...
from yy_core.models.db_models.third.third_main_order_model import *
...
class OrderBaseModel(FrameBaseModel):
    ...
    def create_wechat_refund(self, source_type, app_id, act_id, pay_order_no, refund_amount = 0, refund_reason = ""):
        ...
        #请求太频繁限制
        if CoreHelper.is_continue_request(f"create_wechat_refund:{app_id}_{pay_order_no}", 1000) == False:
            invoke_result_data.success = False
            invoke_result_data.error_code = "error"
        ...
        refund_no = CoreHelper.create_order_id()
        #创建退款预订单
        ...
        refund_order.create_date = CoreHelper.get_now_datetime()
