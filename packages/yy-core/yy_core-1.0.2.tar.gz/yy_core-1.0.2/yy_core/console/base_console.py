...
"""
:Author: yy
:Date: 2025-05-09 20:44:50
@LastEditTime: 2025-04-27 14:18:35
...
if nacos_config:
    ...
    try:
        ...
        nacos_client.add_naming_instance(nacos_data_id, HostHelper.get_host_ip(), int(config.get_value("run_port",0)),heartbeat_interval=5,group_name=nacos_group)
