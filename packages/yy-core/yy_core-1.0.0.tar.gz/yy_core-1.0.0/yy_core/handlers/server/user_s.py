...
@LastEditTime: 2025-04-23 15:03:15
@LastEditors: yy
@Description: 用户模块
"""
...
from yy_core.libs.customize.oss2_helper import *
from yy_core.models.enum import *
from yy_core.models.core_model import *
from yy_core.models.db_models.tao.tao_login_log_model import *
...
class BatchUpdateUserAssetHandler(ClientBaseHandler):
    ...
    def post_async(self):
        ...
        asset_base_model = AssetBaseModel(context=self)
        asset_object_json = CoreHelper.json_loads(asset_object_json)
        asset_object_ids = ""
