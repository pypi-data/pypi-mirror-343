...
from dl2050utils.fs import pickle_load, pickle_save, json_save, json_load, json_loads, json_dumps, rm, cp
...
__all__ = [
    ...
    'AppLog',
    'DB',
    'pickle_load', 'pickle_save', 'json_save', 'json_load', 'json_loads', 'json_dumps', 'rm', 'cp'
]