...
class ConsoleLogger:
    ...
    def success(self, message: str) -> None:
        ...
        self.log(message, LogLevel.SUCCESS, "green")
    ...
    def hint(self, message: str) -> None:
        """Log a hint message."""
        self.log(message, LogLevel.HINT, "cyan")
    ...
    def config(self, message: str) -> None:
        ...
        self.log(message, LogLevel.CONFIG, "blue")
    ...
    def prompt(self, message: str, **kwargs: Any) -> Any:
        ...
        return click.prompt(f"{LogLevel.QUESTION.value} {message}", **kwargs)
