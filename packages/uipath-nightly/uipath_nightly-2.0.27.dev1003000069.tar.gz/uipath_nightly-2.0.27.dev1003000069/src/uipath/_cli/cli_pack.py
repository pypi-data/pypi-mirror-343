...
def display_project_info(config):
    ...
    console.success(f"{'Name'.ljust(max_label_length)}: {config['project_name']}")
    console.success(f"{'Version'.ljust(max_label_length)}: {config['version']}")
    console.success(f"{'Description'.ljust(max_label_length)}: {description}")
    console.success(f"{'Authors'.ljust(max_label_length)}: {config['authors']}")
