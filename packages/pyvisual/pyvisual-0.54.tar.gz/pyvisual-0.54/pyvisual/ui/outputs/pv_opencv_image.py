...
class PvOpencvImage(QWidget):
    def __init__(self, container=None, x=0, y=0, width=640, height=480, corner_radius=0, fill=None,
                 idle_color=(211, 211, 211, 1), flip_v=False, flip_h=False, rotate=0, scale=1.0, 
        ...
        self._tag = tag
        self._fill = fill
        self._idle_color = QColor(idle_color[0], idle_color[1], idle_color[2], int(idle_color[3] * 255))
    ...
    def configure_style(self):
        ...
        if self._fill:
            ...
            # Create a new pixmap with the container size, filled with idle_color
            centered = QPixmap(final_width, final_height)
            centered.fill(self._idle_color)
    ...
    def paintEvent(self, event):
        ...
        # Draw the idle_color background if no image is available.
        if self._pixmap is None:
            painter.fillRect(self.rect(), self._idle_color)
        else:
    ...
    @property
    def idle_color(self):
        return (self._idle_color.red(), self._idle_color.green(), 
                self._idle_color.blue(), self._idle_color.alphaF())

    @idle_color.setter
    def idle_color(self, value):
        self._idle_color = QColor(value[0], value[1], value[2], int(value[3] * 255))
...
if __name__ == "__main__":
    ...
    img_widget = PvOpencvImage(
        ...
        height=100,
        corner_radius=20,
        idle_color=(230, 230, 230, 1),  # Light gray background
        flip_h=False,
        rotate=0,
