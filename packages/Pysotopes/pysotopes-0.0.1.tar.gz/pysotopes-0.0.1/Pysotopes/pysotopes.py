...
class island_frame():
    def __init__(self, mainApp: app):
        self.frame = tkinter.Frame(mainApp.get_raw_app())
...
class app_widgets():
    ...
    def text(self, properties: dict, packing_properties: dict):
        ...
        # make it also return a packing option
    ...
    def get_named_widgets(self, key: str) -> dict | None:
        print("Getting get named widgets")
        print(self, key)
        print("getting named widget lib")
        print(self.named_widget_lib)
        print()
        try:
