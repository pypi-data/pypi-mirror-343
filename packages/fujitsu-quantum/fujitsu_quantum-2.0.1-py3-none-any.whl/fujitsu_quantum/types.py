...
from numpy import integer, floating, inexact
...
Integer: TypeAlias = Union[int, integer]
RealNumber: TypeAlias = Union[int, float, integer, floating]
Number: TypeAlias = Union[int, float, complex, integer, inexact]
ParameterValues: TypeAlias = list[list[float]]
QubitAllocation: TypeAlias = Union[dict[str, int], list[int]]

# the operator type used in the SDK
Operator: TypeAlias = list[tuple[str, Number]]
...
APIOperator: TypeAlias = list[list[Union[str, list[Union[float, floating]]]]]
