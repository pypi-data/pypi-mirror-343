...
log_levels = {
    'FIXME': CosmoEngine.LoggerInterface.eFIXME,
    'DEBUG': CosmoEngine.LoggerInterface.eDebug,
    'DEPRECATED': CosmoEngine.LoggerInterface.eDeprecated,
    'INFO': CosmoEngine.LoggerInterface.eInfo,
    'WARNING': CosmoEngine.LoggerInterface.eWarning,
    'ERROR': CosmoEngine.LoggerInterface.eError,
    'CRITICAL': CosmoEngine.LoggerInterface.eAssertion,
}


def set_log_level(engine, level):
    if level in log_levels:
        CosmoEngine.LoggerManager.GetInstance().GetLogger().SetLogLevel(log_levels[level])
