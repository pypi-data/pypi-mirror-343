...
class AsymptoticCLs(AnalysisObject):
    ...
    def evaluate_limits(self):
        ...
        if self.minimizer.has_discrete_nuisance() and self.minimizer.config['do_discrete_iteration']:
            self.stdout.info("Re-minimizing Asimov nll as there is discrete nuisance")
