...
import parse
from ut_types.other import Location
from ut_types.venue import WebVenueDetails
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from ut_types.menu import WebVenueMenu
...
class Venue:
    ...
    _activity_details: set[WebActivityBeer] = field(
