...
from ut_types.user import WebUserDetails
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from ut_types.beer import WebActivityBeer
...
class User:
    ...
    _user_details: WebUserDetails = field(init=False, repr=False)
    ...
    def __post_init__(self) -> None:
        ...
        self._user_details = user_details(resp=self._page)
        self.user_name = self._user_details.name
