...
class ALCManager:
    def __init__(self, df_original: pd.DataFrame,
        ...
        si = ScoreInterval(si_type=self.si_type, si_confidence=self.si_confidence, logger=self.logger)
    ...
    def _add_result(self,
        ...
        self.rep.si.add_prediction(prediction, confidence, predict_type)
    ...
    def _ok_to_halt(self, si_halt: ScoreInterval) -> Dict[str, Any]:
        ...
        alc_scores = si_halt.get_alc_scores(si_halt.df_base, si_halt.df_attack)
    ...
    def alc_per_secret_df(self,
                       known_columns: Optional[List[str]] = None,
                       secret_column: Optional[str] = None) -> pd.DataFrame:
        return self.rep.alc_per_secret_df(known_columns, secret_column)
