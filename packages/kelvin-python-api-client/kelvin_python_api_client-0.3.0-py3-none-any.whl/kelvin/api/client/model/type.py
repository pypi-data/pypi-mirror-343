...
class InfoItem(DataModelBase):
    ...
    title: Optional[StrictStr] = Field(
        None, description="Title of the action to be performed if the Recommendation is accepted.", example="Open valve"
    )
    description: Optional[StrictStr] = Field(
        None,
        description="Description of the action to be performed if the Recommendation is accepted.",
        example="Open the valve to allow more flow into the tank.",
    )
...
class RecommendationActions(DataModelBase):
    ...
    Parameters
    ----------
    info: Optional[List[InfoItem]]
    control_changes: Optional[List[RecommendationControlChange]]

    """

    info: Optional[List[InfoItem]] = Field(
        None, description="A list of all actions to be performed if the Recommendation is accepted."
    )
