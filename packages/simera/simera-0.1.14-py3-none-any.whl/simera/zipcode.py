...
class ZipcodeManager:
    _ZIPCODE_PATTERNS = {
        ...
        'pattern_5_digits': {
            'country': ['BA', 'EE', 'HR', 'IC', 'LT', 'ME', 'RS', 'UA', 'XK', 'DE', 'FR', 'MC', 'ES', 'IT', 'SM', 'VA', 'FI'],
...
if __name__ == '__main__':
    ...
    # path_zips = r'C:\Users\plr03474\NoOneDrive\NetworkDesign FROG\2024 Europe\data\input\transport\templates\Postal_codes_EU_in_SAP.xlsx'
