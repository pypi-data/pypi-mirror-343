...
class Config:
    ...
    class _Config:
        ...
        def __init__(self, path):
            ...
            yaml_transport_ratesheet = self._path.resources / 'transport' / 'transport_ratesheet.yaml'
            yaml_sites = self._path.resources / 'warehouse' / 'sites.yaml'
            ...
            # Transport setup
            self.transport_ratesheet = self.setup_transport(yaml_transport_ratesheet)

            # Warehouse setup
            self.warehouse_ratesheet = self.read_yaml(yaml_sites)
        ...
        def setup_transport(self, file_path):
            ...
            # Custom defaults
            custom_defaults = data.get('custom_defaults', {'drop': 0})
