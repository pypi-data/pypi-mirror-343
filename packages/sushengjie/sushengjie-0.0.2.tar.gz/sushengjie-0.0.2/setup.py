...
setuptools.setup(
    name="sushengjie",  # Replace with your desired PyPI package name (must be unique)
    version="0.0.2",  # Initial version number
    ...
    packages=setuptools.find_packages(), # Automatically find package directories (will find sushengjie/)
