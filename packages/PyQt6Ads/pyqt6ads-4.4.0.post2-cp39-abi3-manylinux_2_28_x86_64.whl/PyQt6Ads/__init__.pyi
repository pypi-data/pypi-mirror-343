...
class CFloatingDockContainer(QtWidgets.QDockWidget, "IFloatingWidget"):
    @typing.overload
    def __init__(self, DockManager: typing.Optional["CDockManager"]) -> None: ...
    @typing.overload
    ...
    def showNormal(self, fixGeometry: bool) -> None: ...
...
class CFloatingWidgetTitleBar(QtWidgets.QWidget):
    def __init__(self, parent: typing.Optional["CFloatingDockContainer"] = ...) -> None: ...

    maximizeRequested: typing.ClassVar[QtCore.pyqtSignal]
    closeRequested: typing.ClassVar[QtCore.pyqtSignal]
    def setMaximizedIcon(self, maximized: bool) -> None: ...
    def updateStyle(self) -> None: ...
    def setTitle(self, Text: typing.Optional[str]) -> None: ...
    def enableCloseButton(self, Enable: bool) -> None: ...
    def normalIcon(self) -> QtGui.QIcon: ...
    def setNormalIcon(self, Icon: QtGui.QIcon) -> None: ...
    def maximizeIcon(self) -> QtGui.QIcon: ...
    def setMaximizeIcon(self, Icon: QtGui.QIcon) -> None: ...
    def mouseDoubleClickEvent(self, event: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mouseMoveEvent(self, ev: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mouseReleaseEvent(self, ev: typing.Optional[QtGui.QMouseEvent]) -> None: ...
    def mousePressEvent(self, ev: typing.Optional[QtGui.QMouseEvent]) -> None: ...
