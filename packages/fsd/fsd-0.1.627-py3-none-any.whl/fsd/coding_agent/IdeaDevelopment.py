...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "  * For removal: '[FIX REQUIRED] package-name: Remove conflicting/unused dependency. Action: npm uninstall package-name'\n"
            "  * For reinstallation: '[FIX REQUIRED] package-name: Reinstall to fix version conflicts. Action: npm uninstall package-name && npm install package-name'\n"
            "  * For buggy dependencies: '[FIX REQUIRED] package-name: Replace with alternative due to known bugs. Action: npm uninstall package-name && npm install alternative-package'\n"
