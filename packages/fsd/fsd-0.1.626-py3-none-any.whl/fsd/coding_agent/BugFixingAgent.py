...
class BugFixingAgent:
    ...
    async def get_coding_request(self, file):
        ...
        user_prompt = f"As a world-class, highly experienced {'SVG designer' if is_svg else 'developer'} specializing in debugging and bug fixing, implement the following task with utmost efficiency and precision:\n"
