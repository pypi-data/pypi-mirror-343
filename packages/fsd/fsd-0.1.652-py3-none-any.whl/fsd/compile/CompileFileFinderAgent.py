...
class CompileFileFinderAgent:
    ...
    async def get_compile_file_planning(self, userRequest, tree):
        ...
        for line in lines:
            ...
            # Extract the file path correctly from the tree output
            # This handles nested directories properly
            file_path = line.strip()
            # Remove any leading indicators or spaces that might be part of the tree output
            file_path = file_path.split(' ')[-1].strip()
            
            # Ensure it's a full path by converting relative path to absolute
            ...
            for pattern in dependency_patterns:
                ...
                if '*' in pattern:
                    ...
                    if file_path.endswith(extension):
                        ...
                        break
                elif pattern in os.path.basename(file_path):
                    crucial_files.append(file_path)
                    break
