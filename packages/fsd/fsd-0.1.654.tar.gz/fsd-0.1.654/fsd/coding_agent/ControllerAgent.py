...
class ControllerAgent:
    ...
    async def get_started(self, user_prompt, tier, file_attachments, focused_files):
        ...
        if search_results != "":
            user_prompt = "Original user prompt:\n" + user_prompt + "\n\n" + "Here are the search data in the context, including content, citations and images. For images, prefer using the original source URLs. Citations are provided to reference where the content was obtained from. Please leverage this data comprehensively and efficiently:\n\n" + search_results
