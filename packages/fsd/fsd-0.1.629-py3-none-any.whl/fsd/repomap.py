...
class RepoMap:
    ...
    def __init__(
        ...
        if self.verbose and hasattr(self.io, 'tool_output'):
            self.io.tool_output(
    ...
    def get_rel_fname(self, fname):
        try:
            ...
            # Issue with paths on different drives
            return fname

    def tags_cache_error(self, original_error=None):
        """Handle SQLite errors by trying to recreate cache, falling back to dict if needed"""

        if self.verbose and original_error and hasattr(self.io, 'tool_warning'):
        ...
        try:
            ...
            if hasattr(self.io, 'tool_warning'):
    ...
    def get_ranked_tags(
        ...
        if len(fnames) - cache_size > 100:
            if hasattr(self.io, 'tool_output'):
                self.io.tool_output(
        ...
        for fname in fnames:
            ...
            if not file_ok:
                if fname not in self.warned_files:
                    if hasattr(self.io, 'tool_warning') and hasattr(self.io, 'tool_output'):
    ...
    def get_ranked_tags_map_uncached(
        ...
        # Note: filter_important_files function not available - skipping this enhancement
