        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "4. search_queries: If search_needed is true, provide an array of 1-3 specific search queries that would help gather relevant real-time information about technologies, frameworks, or concepts mentioned in the user prompt. Each query must be highly specific to the task at hand, targeting exact technical information needed for implementation. Queries should focus on recent documentation, best practices, or specific implementation details of the technologies mentioned. Avoid generic queries about concepts. All queries must be in English and directly relevant to completing the requested task.\n\n"
