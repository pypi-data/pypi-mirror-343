...
class Database():
    ...
    def GetNamespace(self, cursor):
        cursor.execute("""
            SELECT
                n.oid,
                trim(n.nspname) AS name,
                trim(r.rolname) AS owner,
    ...
    def GetTableColumn(self, cursor):
        ...
        cursor.execute("""
            select
                ...
                trim(a.attname) as name,
                trim(format_type(a.atttypid, a.atttypmod)) as type,
    ...
    def GetTableConstraint(self, cursor):
        ...
        cursor.execute("""
            select
                ...
                trim(co.conname) as name,
                trim(co.contype) as type,
    ...
    def GetTablePolicy(self, cursor):
        ...
        cursor.execute("""
            select
                ...
                (
                    select array_agg(distinct trim(coalesce(plcrr.rolname, 'public')))
