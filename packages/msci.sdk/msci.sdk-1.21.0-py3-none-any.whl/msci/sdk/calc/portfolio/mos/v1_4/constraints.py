...
class ConstraintFactory:
    ...
    class BetaConstraint(BaseDataClassValidator):
        ...
        Args:
            ...
            lower_bound (float): (optional) Default value is -10000000000.
            upper_bound (float): (optional) Default value is 10000000000.
            is_soft (bool): (optional) Default value is False
        ...
        relax_order: Optional[str] = None
        lower_bound: Optional[float] = -10000000000
        upper_bound: Optional[float] = 10000000000
        is_soft: Optional[bool] = False
