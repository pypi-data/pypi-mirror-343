...
if version == "1.4":
    ...
    from .v1_4.mos_config import SimulationSettings, Strategy, ReferenceUniverse, SolutionSettings, \
        ...
        SpecificCovariance, FactorCovariance, FactorExposure, IdMappings
    ...
    from .v1_4.full_optimizer_node import GenericObjectiveFunction, OptimizationSettings, \
        ...
        DoNotTradeExpression, DoNotTradeListsAndExpressions, SimpleIdentification, CustomAttribute, PostRoundLotSettings, RiskTargetOptimization
