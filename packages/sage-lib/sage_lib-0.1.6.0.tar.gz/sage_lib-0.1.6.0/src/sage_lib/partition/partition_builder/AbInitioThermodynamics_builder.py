    ...
    def handleABITAnalysis(self, values: Dict[str, Dict], file_location: str = None) -> None:
        ...
        for abit, params in values.items():
            ...
            if abit.upper() == 'COMPOSITION_ANALYSIS':
                ...
                compressed_data = compressor.verify_and_load_or_compress(descriptors_by_species, method=compress_model, n_components= {k:n_components for k, d in descriptors_by_species.items()}, load=cache )
