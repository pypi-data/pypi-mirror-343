...
def cancelAnalogTriggerTriggerUpperBoundCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMClosedLoopEnabledCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMCompressorCurrentCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMCompressorOnCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMInitializedCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMPressureSwitchCallback(index: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
def cancelCTREPCMSolenoidOutputCallback(index: typing.SupportsInt, channel: typing.SupportsInt, uid: typing.SupportsInt) -> None:
    ...
