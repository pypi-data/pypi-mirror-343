...
class PermissionContext:
    ...
    async def get_groups(self) -> list[str]:
        """
        Gets the groups for context's user sub. The default implementation does not consult any external sources for
        group membership and must be overridden by subclasses to provide group membership information.
