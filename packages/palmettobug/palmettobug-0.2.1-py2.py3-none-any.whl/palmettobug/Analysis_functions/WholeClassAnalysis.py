...
#
# This class is largely based of off the Analysis class of PalmettoBUG (see that .py file), which in turn was heavily inspired / derived from CATALYST
# However, this class shares very little similarity with CATALYST
