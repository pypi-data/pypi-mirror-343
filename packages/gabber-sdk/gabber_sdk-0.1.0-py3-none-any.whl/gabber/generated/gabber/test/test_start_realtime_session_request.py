...
class TestStartRealtimeSessionRequest(unittest.TestCase):
    """StartRealtimeSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartRealtimeSessionRequest:
        """Test StartRealtimeSessionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartRealtimeSessionRequest`
        """
        model = StartRealtimeSessionRequest()
        if include_optional:
            return StartRealtimeSessionRequest(
                simulated = True,
    ...
    def testStartRealtimeSessionRequest(self):
        """Test StartRealtimeSessionRequest"""
