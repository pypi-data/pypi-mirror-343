...
class TestRealtimeSessionConfigUpdate(unittest.TestCase):
    """RealtimeSessionConfigUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RealtimeSessionConfigUpdate:
        """Test RealtimeSessionConfigUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RealtimeSessionConfigUpdate`
        """
        model = RealtimeSessionConfigUpdate()
        if include_optional:
            return RealtimeSessionConfigUpdate(
                ...
                generative = gabber.generated.gabber.models.realtime_session_generative_config_update.RealtimeSessionGenerativeConfigUpdate(
                    llm = '', 
                    voice_override = '', 
                    persona = '', 
                    scenario = '', 
    ...
    def testRealtimeSessionConfigUpdate(self):
        """Test RealtimeSessionConfigUpdate"""
