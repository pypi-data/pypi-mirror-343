...
class TestRealtimeSessionConfigCreate(unittest.TestCase):
    """RealtimeSessionConfigCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RealtimeSessionConfigCreate:
        """Test RealtimeSessionConfigCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RealtimeSessionConfigCreate`
        """
        model = RealtimeSessionConfigCreate()
        if include_optional:
            return RealtimeSessionConfigCreate(
    ...
    def testRealtimeSessionConfigCreate(self):
        """Test RealtimeSessionConfigCreate"""
