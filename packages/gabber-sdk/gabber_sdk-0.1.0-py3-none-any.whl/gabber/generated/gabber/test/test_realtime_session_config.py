...
class TestRealtimeSessionConfig(unittest.TestCase):
    """RealtimeSessionConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RealtimeSessionConfig:
        """Test RealtimeSessionConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RealtimeSessionConfig`
        """
        model = RealtimeSessionConfig()
        if include_optional:
    ...
    def testRealtimeSessionConfig(self):
        """Test RealtimeSessionConfig"""
