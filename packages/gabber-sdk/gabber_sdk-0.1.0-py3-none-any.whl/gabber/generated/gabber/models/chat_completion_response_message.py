...
class ChatCompletionResponseMessage(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="The contents of the message.")
    ...
    gabber: Optional[ChatCompletionResponseMessageGabber] = None
    __properties: ClassVar[List[str]] = ["content", "refusal", "role", "tool_calls", "gabber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gabber": ChatCompletionResponseMessageGabber.from_dict(obj["gabber"]) if obj.get("gabber") is not None else None
        })
        return _obj
