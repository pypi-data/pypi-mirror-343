...
class WebhookMessageRealtimeSessionTimeLimitExceeded(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['realtime_session.time_limit_exceeded']):
            raise ValueError("must be one of enum values ('realtime_session.time_limit_exceeded')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": WebhookMessageRealtimeSessionTimeLimitExceededPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
