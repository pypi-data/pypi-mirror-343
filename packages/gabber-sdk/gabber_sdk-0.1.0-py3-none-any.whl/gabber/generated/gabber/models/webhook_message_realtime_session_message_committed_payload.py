...
class WebhookMessageRealtimeSessionMessageCommittedPayload(BaseModel):
    """
    WebhookMessageRealtimeSessionMessageCommittedPayload
    """ # noqa: E501
    message: ContextMessage
    realtime_session_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["message", "realtime_session_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": ContextMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "realtime_session_id": obj.get("realtime_session_id")
        })
        return _obj
