...
class RealtimeSessionConnectionDetails(BaseModel):
    """
    RealtimeSessionConnectionDetails
    """ # noqa: E501
    url: StrictStr = Field(description="The URL to connect to the RealtimeSession")
    token: StrictStr = Field(description="The token to use to connect to the RealtimeSession")
