...
class ChatCompletionResponse(BaseModel):
    ...
    """ # noqa: E501
    choices: List[ChatCompletionResponseChoicesInner] = Field(description="A list of chat completion choices.")
    model: StrictStr = Field(description="The model used for completion.")
    gabber: Optional[ChatCompletionResponseGabber] = None
    __properties: ClassVar[List[str]] = ["choices", "model", "gabber"]
