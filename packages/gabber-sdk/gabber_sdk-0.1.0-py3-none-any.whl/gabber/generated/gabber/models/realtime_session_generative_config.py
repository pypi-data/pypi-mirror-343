...
class RealtimeSessionGenerativeConfig(BaseModel):
    """
    Configuration for the generative AI in the RealtimeSession.
    """ # noqa: E501
    llm: LLM
    voice_override: Optional[Voice] = None
    persona: Optional[Persona] = None
    scenario: Optional[Scenario] = None
    context: Context
    tool_definitions: List[ToolDefinition] = Field(description="The tool definitions to use for the generative AI.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voice_override": Voice.from_dict(obj["voice_override"]) if obj.get("voice_override") is not None else None,
