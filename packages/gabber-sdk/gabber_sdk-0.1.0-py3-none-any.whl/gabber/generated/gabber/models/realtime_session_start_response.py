...
class RealtimeSessionStartResponse(BaseModel):
    """
    RealtimeSessionStartResponse
    """ # noqa: E501
    session: RealtimeSession
    connection_details: RealtimeSessionConnectionDetails
    __properties: ClassVar[List[str]] = ["session", "connection_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "session": RealtimeSession.from_dict(obj["session"]) if obj.get("session") is not None else None,
            "connection_details": RealtimeSessionConnectionDetails.from_dict(obj["connection_details"]) if obj.get("connection_details") is not None else None
        })
        return _obj
