...
class ContextAdvancedMemoryEdge(BaseModel):
    """
    ...
    source_node: StrictStr
    target_node: StrictStr
    fact: StrictStr
    relation: StrictStr
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "invalidated_at", "source_node", "target_node", "fact", "relation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target_node": obj.get("target_node"),
            "fact": obj.get("fact"),
