...
class WebhookMessageToolCallsStarted(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['tool.calls_started']):
            raise ValueError("must be one of enum values ('tool.calls_started')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": WebhookMessageToolCallsStartedPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
