...
class RealtimeSessionTimelineItem(BaseModel):
    """
    RealtimeSessionTimelineItem
    """ # noqa: E501
    seconds: Optional[Union[StrictFloat, StrictInt]] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["seconds", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['silence', 'agent', 'user']):
            raise ValueError("must be one of enum values ('silence', 'agent', 'user')")
        return value
