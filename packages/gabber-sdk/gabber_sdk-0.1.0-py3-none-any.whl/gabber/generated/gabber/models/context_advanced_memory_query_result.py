...
class ContextAdvancedMemoryQueryResult(BaseModel):
    """
    ContextAdvancedMemoryQueryResult
    """ # noqa: E501
    nodes: List[ContextAdvancedMemoryNode]
    edges: List[ContextAdvancedMemoryEdge]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [ContextAdvancedMemoryNode.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "edges": [ContextAdvancedMemoryEdge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None
        })
        return _obj
