...
class AttachLivekitRoom200ResponseConfigGenerativeToolDefinitionsInnerCallSettingsDestinationOneOf(BaseModel):
    """
    AttachLivekitRoom200ResponseConfigGenerativeToolDefinitionsInnerCallSettingsDestinationOneOf
    """ # noqa: E501
    type: StrictStr
    url: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['web_request']):
            raise ValueError("must be one of enum values ('web_request')")
        return value
