...
class AttachLivekitRoom200Response(BaseModel):
    """
    ...
    config: AttachLivekitRoom200ResponseConfig
    data: List[AttachLivekitRoom200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": AttachLivekitRoom200ResponseConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
