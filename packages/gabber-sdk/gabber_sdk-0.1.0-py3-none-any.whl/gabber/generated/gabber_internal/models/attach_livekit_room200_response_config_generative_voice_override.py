...
class AttachLivekitRoom200ResponseConfigGenerativeVoiceOverride(BaseModel):
    """
    ...
    pricing: AttachLivekitRoom200ResponseConfigGenerativeVoiceOverridePricing
    tags: List[AttachLivekitRoom200ResponseConfigGenerativeVoiceOverrideTagsInner] = Field(description="Tags associated with this voice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricing": AttachLivekitRoom200ResponseConfigGenerativeVoiceOverridePricing.from_dict(obj["pricing"]) if obj.get("pricing") is not None else None,
            "tags": [AttachLivekitRoom200ResponseConfigGenerativeVoiceOverrideTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
