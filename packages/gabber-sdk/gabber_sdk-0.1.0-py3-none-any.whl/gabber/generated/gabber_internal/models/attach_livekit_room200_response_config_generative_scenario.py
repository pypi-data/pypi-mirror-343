...
class AttachLivekitRoom200ResponseConfigGenerativeScenario(BaseModel):
    """
    AttachLivekitRoom200ResponseConfigGenerativeScenario
    """ # noqa: E501
    created_at: datetime
    id: StrictStr
    name: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["created_at", "id", "name", "project", "prompt", "human"]
