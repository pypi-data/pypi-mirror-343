...
class AttachLivekitRoom200ResponseConfig(BaseModel):
    """
    ...
    generative: AttachLivekitRoom200ResponseConfigGenerative
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "generative": AttachLivekitRoom200ResponseConfigGenerative.from_dict(obj["generative"]) if obj.get("generative") is not None else None,
