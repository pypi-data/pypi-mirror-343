...
class TestChatCompletionStreamResponseChoice(unittest.TestCase):
    """ChatCompletionStreamResponseChoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatCompletionStreamResponseChoice:
        """Test ChatCompletionStreamResponseChoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChatCompletionStreamResponseChoice`
        """
        model = ChatCompletionStreamResponseChoice()
        if include_optional:
            return ChatCompletionStreamResponseChoice(
    ...
    def testChatCompletionStreamResponseChoice(self):
        """Test ChatCompletionStreamResponseChoice"""
