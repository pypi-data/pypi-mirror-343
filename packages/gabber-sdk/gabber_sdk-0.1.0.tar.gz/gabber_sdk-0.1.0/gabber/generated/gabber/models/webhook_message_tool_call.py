...
class WebhookMessageToolCall(BaseModel):
    """
    WebhookMessageToolCall
    """ # noqa: E501
    id: StrictStr
    tool_definition_id: StrictStr
    function: WebhookMessageToolCallFunction
    __properties: ClassVar[List[str]] = ["id", "tool_definition_id", "function"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "tool_definition_id": obj.get("tool_definition_id"),
            "function": WebhookMessageToolCallFunction.from_dict(obj["function"]) if obj.get("function") is not None else None
        })
        return _obj
