...
class ChatCompletionRequestMessageContentPartAudio(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Audio content type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "input_audio": ChatCompletionRequestMessageContentPartAudioInputAudio.from_dict(obj["input_audio"]) if obj.get("input_audio") is not None else None
        })
        return _obj
