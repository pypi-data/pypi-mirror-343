...
class ChatCompletionRequestAssistantMessage(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[ChatCompletionRequestSystemMessageContent] = None
    ...
    __properties: ClassVar[List[str]] = ["content", "refusal", "role", "tool_calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": ChatCompletionRequestSystemMessageContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
