...
class StartRealtimeSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    simulated: Optional[StrictBool] = Field(default=None, description="Whether the session is simulated.")
    config: RealtimeSessionConfigCreate
    extra: Optional[Dict[str, Any]] = Field(default=None, description="Extra data for certain Gabber partner integrations.", alias="_extra")
    __properties: ClassVar[List[str]] = ["simulated", "config", "_extra"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": RealtimeSessionConfigCreate.from_dict(obj["config"]) if obj.get("config") is not None else None,
