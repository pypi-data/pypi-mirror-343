...
class ContextCreateRequest(BaseModel):
    ...
    messages: Optional[List[ContextMessageCreateParams]] = None
    __properties: ClassVar[List[str]] = ["persona", "scenario", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [ContextMessageCreateParams.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
