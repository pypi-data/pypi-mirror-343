...
class ChatCompletionStreamResponseDeltaGabber(BaseModel):
    """
    If the audio output modality is requested, this object contains data
    """ # noqa: E501
    voice: Optional[ChatCompletionStreamResponseDeltaGabberVoice] = None
    __properties: ClassVar[List[str]] = ["voice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "voice": ChatCompletionStreamResponseDeltaGabberVoice.from_dict(obj["voice"]) if obj.get("voice") is not None else None
        })
        return _obj
