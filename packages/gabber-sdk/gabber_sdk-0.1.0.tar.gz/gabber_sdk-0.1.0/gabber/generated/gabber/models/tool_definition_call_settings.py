...
class ToolDefinitionCallSettings(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "destination": ToolDefinitionCallSettingsDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None
        })
        return _obj
