...
class ChatCompletionStreamResponseDelta(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="The contents of the chunk message.")
    ...
    gabber: Optional[ChatCompletionStreamResponseDeltaGabber] = None
    __properties: ClassVar[List[str]] = ["content", "role", "tool_calls", "refusal", "gabber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gabber": ChatCompletionStreamResponseDeltaGabber.from_dict(obj["gabber"]) if obj.get("gabber") is not None else None
        })
        return _obj
