...
class RealtimeSessionConfigUpdate(BaseModel):
    """
    RealtimeSessionConfigUpdate
    """ # noqa: E501
    general: Optional[RealtimeSessionGeneralConfig] = None
    input: Optional[RealtimeSessionInputConfig] = None
    generative: Optional[RealtimeSessionGenerativeConfigUpdate] = None
    output: Optional[RealtimeSessionOutputConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "generative": RealtimeSessionGenerativeConfigUpdate.from_dict(obj["generative"]) if obj.get("generative") is not None else None,
