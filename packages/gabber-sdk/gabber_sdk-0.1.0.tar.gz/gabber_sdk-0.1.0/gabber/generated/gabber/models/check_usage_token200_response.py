...
class CheckUsageToken200Response(BaseModel):
    """
    CheckUsageToken200Response
    """ # noqa: E501
    ttl_seconds: StrictInt = Field(description="The TTL of the token in seconds")
    __properties: ClassVar[List[str]] = ["ttl_seconds"]
