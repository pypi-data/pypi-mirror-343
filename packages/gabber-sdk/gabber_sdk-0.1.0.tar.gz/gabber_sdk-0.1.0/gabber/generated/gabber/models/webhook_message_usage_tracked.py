...
class WebhookMessageUsageTracked(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['usage.tracked']):
            raise ValueError("must be one of enum values ('usage.tracked')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": WebhookMessageUsageTrackedPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
