...
class WebhookMessageToolCallFunction(BaseModel):
    """
    WebhookMessageToolCallFunction
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the function to call.")
    arguments: Dict[str, Any] = Field(description="The named arguments to call the function with the function was called with")
