...
class ChatCompletionResponseGabberMessageData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message_index", "content_index", "type", "data"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['audio_transcript']):
            raise ValueError("must be one of enum values ('audio_transcript')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "data": ChatCompletionResponseGabberMessageDataData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
