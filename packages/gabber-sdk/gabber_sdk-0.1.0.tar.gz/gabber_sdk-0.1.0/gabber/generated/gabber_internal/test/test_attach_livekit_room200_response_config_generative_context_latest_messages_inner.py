...
class TestAttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner(unittest.TestCase):
    """AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner:
        """Test AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner`
        """
        model = AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner()
        if include_optional:
            return AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner(
                id = '',
    ...
    def testAttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner(self):
        """Test AttachLivekitRoom200ResponseConfigGenerativeContextLatestMessagesInner"""
