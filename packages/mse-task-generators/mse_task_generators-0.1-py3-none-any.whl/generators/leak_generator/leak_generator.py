...
int main(){
    ...
    def create_task(self):
        ...
        # leak_scenarios = int(input("Какой тип задачи вы хотите: "))
        # if leak_scenarios!=3:
        #     print("На данный момент работает лишь опция №3")
        #     exit(0)
        # пока тип задачи передается в объект класса через хардкод в конструкторе (см. __main__)
        ...
        files_to_move = ["leaks_generated.c", "leaks_generated", "text1"]
