...
class ManimDimensions:
    ...
    def width_to_manim_width(width: float):
        ...
        """
        return (width * MANIM_SCENE_DEFAULT_SIZE[0]) / DEFAULT_SCENE_SIZE[0]
    ...
    def manim_width_to_width(manim_width: float):
        ...
        return (manim_width * DEFAULT_SCENE_SIZE[0]) / MANIM_SCENE_DEFAULT_SIZE[0]
    ...
    def height_to_manim_height(height: float):
        ...
        """
        return (height * MANIM_SCENE_DEFAULT_SIZE[1]) / DEFAULT_SCENE_SIZE[1]
    ...
    def manim_height_to_height(manim_height: float):
        ...
        # an exception or, at least, print a message
        return (manim_height * DEFAULT_SCENE_SIZE[1]) / MANIM_SCENE_DEFAULT_SIZE[1]
...
def fullscreen_image(filename, image_mode: str = 'RGBA', **kwargs):
    ...
    """
    image_width_fitted = ImageMobject(filename, image_mode, **kwargs).scale_to_fit_width(ManimDimensions.width_to_manim_width(MOVIEPY_SCENE_DEFAULT_SIZE[0]))
    ...
    image_height_fitted = ImageMobject(filename, image_mode, **kwargs).scale_to_fit_height(ManimDimensions.height_to_manim_height(MOVIEPY_SCENE_DEFAULT_SIZE[1]))
