...
from xorq.vendor.ibis.backends.snowflake.converter import SnowflakePandasData
from xorq.vendor.ibis.backends.sql import SQLBackend
from xorq.vendor.ibis.backends.sql.compilers.base import STAR
...
$$ {defn["source"]} $$"""
    ...
    def to_pyarrow(
        ...
        **kwargs: Any,
        ...
        from xorq.vendor.ibis.backends.snowflake.converter import SnowflakePyArrowData
