...
@alias('safe_dump_to_file', 'safe_dump_to_json', 'safe_write_to_json', 'safe_write_to_file','safe_dump_to_file')
def safe_json_save(data, file_path=None, ensure_ascii=False, indent=4, *args, **kwargs):
...
@alias('read_from_json', 'safe_read_from_json', 'safe_load_from_json', 'safe_load_from_file','safe_json_reads')
...
def read_from_json(file_path):
    return safe_json_read(file_path)
...
def safe_dump_to_file(*args, **kwargs):
    return safe_json_save(*args, **kwargs)
