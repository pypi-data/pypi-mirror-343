...
class CTypeDescriptor:
    ...
    def __str__(self) -> str:
        return (
            ...
            f", range: [{self.min}, {self.max}], ctype: {self.ctype}"
        )
...
class CTypeRegistry:
    ...
    def _init_alias_map(self):
        self._ctype_name_map: dict = {k: v.ctype.__name__ for k, v in self.types.items()}
    ...
    def to_ctypes_name(self, type_str: str, _default: str = None) -> str:
        return self._ctype_name_map.get(type_str, _default)
