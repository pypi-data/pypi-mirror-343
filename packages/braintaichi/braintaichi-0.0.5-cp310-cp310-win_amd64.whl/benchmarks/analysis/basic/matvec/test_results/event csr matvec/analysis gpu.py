...
combined_csv_path = "event csr matvec/event_csrmv_gpu.csv"
...
plt.suptitle('[GPU] event csr matvec taichi speedup over brainpylib\n'
             'speedup = (brainpylib time / taichi aot time) - 1', fontsize=16)

# Adjust layout to make room for the title
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('event csr matvec/event csrmv gpu.png')
# plt.show()
