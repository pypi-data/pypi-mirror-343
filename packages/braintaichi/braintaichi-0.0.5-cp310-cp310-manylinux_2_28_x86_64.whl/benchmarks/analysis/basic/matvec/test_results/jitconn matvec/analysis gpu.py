...
combined_csv_path = "jitconn matvec/jitconn_matvec_gpu.csv"
...
plt.suptitle('[GPU] jitconn matvec taichi speedup over brainpylib\n'
             'speedup = (brainpylib time / taichi aot time) - 1', fontsize=16)

# Adjust layout to make room for the title
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('jitconn matvec\jitconn_matvec_gpu.png')
# plt.show()
