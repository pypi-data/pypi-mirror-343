...
combined_csv_path = "jitconn event matvec/jitconn_event_matvec_cpu.csv"
...
plt.suptitle('[CPU] jitconn event matvec taichi speedup over brainpylib\n'
             'speedup = (brainpylib time / taichi aot time) - 1', fontsize=16)

# Adjust layout to make room for the title
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('jitconn event matvec/jitconn_event_matvec_cpu.png')
# plt.show()
