...
combined_df = pd.read_csv(os.path.join(PATH, 'jitconn_matvec_gpu.csv'))
...
# plt.title('[GPU] jitconn matvec taichi speedup over origin brainpy')
plt.savefig(os.path.join(PATH, 'jitconn_matvec_gpu_dist.png'))
