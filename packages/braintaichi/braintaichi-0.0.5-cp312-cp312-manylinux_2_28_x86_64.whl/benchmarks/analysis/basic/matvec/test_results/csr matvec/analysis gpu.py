...
combined_csv_path = "csr matvec/csrmv_gpu.csv"
...
plt.suptitle('[GPU] csr matvec taichi speedup over brainpylib method: cusparse\n'
             'speedup = (brainpylib time / taichi aot time) - 1', fontsize=16)

# Adjust layout to make room for the title
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('csr matvec/csrmv gpu.png')
# plt.show()
