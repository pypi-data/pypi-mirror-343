...
combined_df = pd.read_csv("jitconn event matvec/jitconn_event_matvec_gpu.csv")
...
plt.title('[GPU] jitconn event matvec taichi speedup over brainpylib' + '\n' +
          'speedup = (brainpylib time / taichi aot time) - 1')
plt.savefig('jitconn event matvec/jitconn_event_matvec_gpu_dist.png')
