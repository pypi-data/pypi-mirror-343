...
from app.types.browser_types import (
    ...
    BrowserConsoleViewAction, SearchGoogleAction, ClickElementAction, InputTextAction,
    OpenTabAction, ScrollAction, SwitchTabAction, SendKeysAction, BrowserActionResult
)
