...
class Options(optmanager.OptManager):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.add_option(
            ...
            "Location of the default dumpserver configuration files."
        )
        self.add_option(
            "certs", Sequence[str], [],
            """
        ...
        self.add_option(
            ...
            "Set supported ciphers for client <-> dumpserver connections using OpenSSL syntax."
        )
        self.add_option(
            "ciphers_server", Optional[str], None,
            "Set supported ciphers for dumpserver <-> server connections using OpenSSL syntax."
        )
        self.add_option(
