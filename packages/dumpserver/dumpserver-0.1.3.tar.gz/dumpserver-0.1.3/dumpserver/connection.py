...
class Connection(serializable.Serializable, metaclass=ABCMeta):
    ...
    This is intentional, all I/O should be handled by `dumpserver.proxy.server` exclusively.
    """
...
class Client(Connection):
    """A connection between a client and dumpserver."""
    peername: Address
    ...
    """
    The certificate used by dumpserver to establish TLS with the client.
    """
...
class Server(Connection):
    """A connection between dumpserver and an upstream server."""
