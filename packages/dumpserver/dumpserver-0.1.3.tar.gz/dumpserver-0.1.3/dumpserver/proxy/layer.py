...
from dumpserver.connection import Connection
from dumpserver.proxy import commands, events
from dumpserver.proxy.commands import Command, StartHook
...
class NextLayerHook(StartHook):
    ...
    (by default, this is done by dumpserver.addons.NextLayer)
    """
    data: NextLayer
