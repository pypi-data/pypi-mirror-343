...
class Command:
    ...
    blocking: Union[bool, "dumpserver.proxy.layer.Layer"] = False
    """
...
class StartHook(Command, dumpserver.hooks.Hook):
    """
    Start an event hook in the dumpserver core.
