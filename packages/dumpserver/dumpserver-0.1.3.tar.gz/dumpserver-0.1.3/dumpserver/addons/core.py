...
from dumpserver.utils import emoji
from dumpserver import ctx, hooks
...
from dumpserver import platform
...
class Core:
    ...
    def mark(self, flows: typing.Sequence[flow.Flow], marker: dumpserver.types.Marker) -> None:
        """
            Mark flows.
        """
        updated = []
    ...
    @command.argument("attr", type=dumpserver.types.Choice("flow.set.options"))
    def flow_set(
        self,
    ...
    @command.argument("encoding", type=dumpserver.types.Choice("flow.encode.options"))
    def encode(
        self,
        flows: typing.Sequence[flow.Flow],
        part: str,
    ...
    def options_load(self, path: dumpserver.types.Path) -> None:
        """
    ...
    def options_save(self, path: dumpserver.types.Path) -> None:
        """
