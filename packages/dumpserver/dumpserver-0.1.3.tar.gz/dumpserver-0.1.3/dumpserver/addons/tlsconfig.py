...
from dumpserver import certs, ctx, exceptions, connection, tls
from dumpserver.net import tls as net_tls
from dumpserver.options import CONF_BASENAME
from dumpserver.proxy import context
from dumpserver.proxy.layers import modes
from dumpserver.proxy.layers import tls as proxy_tls
...
class TlsConfig:
    ...
    # TODO: This addon should manage the following options itself, which are current defined in dumpserver/options.py:
    #  - upstream_cert
    ...
    def configure(self, updated):
        ...
        if self.certstore.default_ca.has_expired():
            ctx.log.warn(
                "The dumpserver certificate authority has expired!\n"
                "Please delete all CA-related files in your ~/.dumpserver folder.\n"
                "The CA will be regenerated automatically after restarting dumpserver.\n"
                "See dumpserver for additional help.",
            )
