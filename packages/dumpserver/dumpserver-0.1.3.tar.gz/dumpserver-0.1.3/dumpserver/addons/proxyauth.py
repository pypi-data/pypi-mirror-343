...
from dumpserver import connection, ctx
...
class ProxyAuth:
    ...
    def is_http_proxy(self) -> bool:
        """
        Returns:
            - True, if authentication is done as if dumpserver is a proxy
            - False, if authentication is done as if dumpserver is an HTTP server
        """
