...
from dumpserver import addonmanager, hooks
from dumpserver import command
from dumpserver import eventsequence
...
class Master:
    """
        The master handles dumpserver's main event loop.
    """
    ...
    def _asyncio_exception_handler(self, loop, context):
        ...
        self.log.error(
            ...
            "\n\thttps://github.com/dumpserver/dumpserver/issues"
        )
