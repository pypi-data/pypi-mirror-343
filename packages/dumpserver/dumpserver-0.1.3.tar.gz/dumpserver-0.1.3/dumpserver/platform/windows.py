...
class TransparentProxy:
    """
    Transparent Windows Proxy for dumpserver based on WinDivert/PyDivert. This module can be used to
    ...
    which dumpserver sees, but this would remove the correct client info from dumpserver.
    """
...
if __name__ == "__main__":
    ...
    @click.option("-p", "--proxy-port", type=int, metavar="8080", default=8080,
                  help="The port dumpserver is listening on.")
    def redirect(**options):
        """Redirect flows to dumpserver."""
