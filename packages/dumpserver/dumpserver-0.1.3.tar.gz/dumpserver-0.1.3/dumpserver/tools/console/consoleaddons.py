...
from dumpserver import command, command_lexer
from dumpserver import contentviews
...
from dumpserver.tools.console import keymap
...
class ConsoleAddon:
    ...
    def console_choose(
        ...
        cmd: dumpserver.types.Cmd,
        *args: dumpserver.types.CmdArgs
    ) -> None:
        """
    ...
    def console_choose_cmd(
        self,
        prompt: str,
        choicecmd: dumpserver.types.Cmd,
        subcmd: dumpserver.types.Cmd,
        *args: dumpserver.types.CmdArgs
    ) -> None:
        """
    ...
    def view_pop(self) -> None:
        """
            ...
            user to exit dumpserver.
        """
        signals.pop_view_state.send(self)

    @command.command("console.bodyview")
    @command.argument("part", type=dumpserver.types.Choice("console.bodyview.options"))
    ...
    @command.argument("flow_part", type=dumpserver.types.Choice("console.edit.focus.options"))
    ...
    def grideditor_load(self, path: dumpserver.types.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path: dumpserver.types.Path) -> None:
        """
    ...
    def grideditor_save(self, path: dumpserver.types.Path) -> None:
        """
    ...
    @command.argument("mode", type=dumpserver.types.Choice("console.flowview.mode.options"))
