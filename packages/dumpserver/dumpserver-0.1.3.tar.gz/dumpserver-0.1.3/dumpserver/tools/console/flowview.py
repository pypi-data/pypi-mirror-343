...
import dumpserver.tools.console.master  # noqa
import urwid
from dumpserver import contentviews
from dumpserver import ctx
from dumpserver import http
from dumpserver import tcp
from dumpserver.tools.console import common
from dumpserver.tools.console import flowdetailview
from dumpserver.tools.console import layoutwidget
from dumpserver.tools.console import searchable
from dumpserver.tools.console import tabs
...
class FlowViewHeader(urwid.WidgetWrap):
    ...
    def __init__(
        self,
        master: "dumpserver.tools.console.master.ConsoleMaster",
    ) -> None:
        self.master = master
        self.focus_changed()
    ...
    def conn_text(self, conn):
        if conn:
            ...
            for k, v in conn.headers.fields:
                ...
                #
                # header, dumpserver will display the following:
                #
                ...
                # Also, from a security perspective, a dumpserver user couldn't be fooled by homoglyphs.
                #
