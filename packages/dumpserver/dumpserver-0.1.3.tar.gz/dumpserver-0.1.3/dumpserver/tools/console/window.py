...
import urwid
from dumpserver.tools.console import commands
from dumpserver.tools.console import common
from dumpserver.tools.console import eventlog
from dumpserver.tools.console import flowlist
from dumpserver.tools.console import flowview
from dumpserver.tools.console import grideditor
from dumpserver.tools.console import help
from dumpserver.tools.console import keybindings
from dumpserver.tools.console import options
from dumpserver.tools.console import overlay
from dumpserver.tools.console import signals
from dumpserver.tools.console import statusbar

if os.name == "nt":
    from dumpserver.contrib.urwid import raw_display
else:
