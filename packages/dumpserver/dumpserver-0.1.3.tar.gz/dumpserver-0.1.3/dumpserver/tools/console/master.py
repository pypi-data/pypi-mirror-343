...
from dumpserver.addons import errorcheck, intercept
from dumpserver.addons import eventstore
...
from dumpserver.tools.console import consoleaddons
from dumpserver.tools.console import defaultkeys
from dumpserver.tools.console import keymap
from dumpserver.tools.console import palettes
from dumpserver.tools.console import signals
from dumpserver.tools.console import window
...
class ConsoleMaster(master.Master):
    ...
    def spawn_editor(self, data):
        ...
        fd, name = tempfile.mkstemp('', "dumpserver", text=text)
    ...
    async def running(self) -> None:
        if not sys.stdout.isatty():
            print("Error: dumpserver's console interface requires a tty. "
                  "Please run dumpserver in an interactive shell environment.", file=sys.stderr)
            sys.exit(1)
