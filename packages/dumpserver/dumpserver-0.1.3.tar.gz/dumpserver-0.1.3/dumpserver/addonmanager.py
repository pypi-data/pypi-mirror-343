...
class Loader:
    ...
    def add_command(self, path: str, func: typing.Callable) -> None:
        """Add a command to dumpserver.

        Unless you are generating commands programatically,
        this API should be avoided. Decorate your function with `@dumpserver.command.command` instead.
        """
        ...
        for a in traverse([addon]):
            ...
            if func:
                if callable(func):
                    ...
                    # For example, a user may have "from dumpserver import log" in an addon,
