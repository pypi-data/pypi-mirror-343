...
from dumpserver.websocket import WebSocketData
from dumpserver.coretypes import multidict
from dumpserver.coretypes import serializable
from dumpserver.net import encoding
from dumpserver.net.http import cookies
from dumpserver.net.http import multipart
from dumpserver.net.http import status_codes
from dumpserver.net.http import url
from dumpserver.net.http.headers import assemble_content_type
from dumpserver.net.http.headers import parse_content_type
from dumpserver.utils import human
from dumpserver.utils import strutils
from dumpserver.utils import typecheck
from dumpserver.utils.strutils import always_bytes
...
class Message(serializable.Serializable):
    ...
    If `False`, dumpserver will buffer the entire body before forwarding it to the destination.
    ...
    Setting it in `request` or  `response` is already too late, dumpserver has buffered the message body already.
    """
