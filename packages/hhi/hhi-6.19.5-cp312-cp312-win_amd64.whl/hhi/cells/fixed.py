...
def HHI_DFB(WL_L: float = 1550.0) -> gf.Component:
    ...
    c.add_label(text=f"WL_L={WL_L}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="e1",
        width=16.0,
        cross_section="DC",
...
def HHI_DirCoupE1700(L_C: float = 100.0) -> gf.Component:
    ...
    c.add_label(text=f"L_C={L_C}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="o1",
        width=2.0,
        cross_section="E1700",
...
def HHI_EAM(L_E: float = 100.0) -> gf.Component:
    ...
    c.add_label(text=f"L_E={L_E}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="g1",
        width=100.0,
        cross_section="GSG",
...
def HHI_EOBiasSectionSingle(L_B: float = 500.0) -> gf.Component:
    ...
    c.add_label(text=f"L_B={L_B}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="n1",
        width=16.0,
        cross_section="DC",
...
def HHI_EOPMTWSingleDD(N: int = 4.0) -> gf.Component:
    ...
    c.add_label(text=f"N={N}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="g1",
        width=150.0,
        cross_section="GS",
...
def HHI_ISOsectionSingle(L_I: float = 100.0) -> gf.Component:
    ...
    c.add_label(text=f"L_I={L_I}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="o1",
        width=2.0,
        cross_section="ACT",
...
def HHI_PMTOE1700(L_P: float = 200.0) -> gf.Component:
    ...
    c.add_label(text=f"L_P={L_P}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="e1",
        width=16.0,
        cross_section="DC",
...
def HHI_SOA(L_S: float = 100.0) -> gf.Component:
    ...
    c.add_label(text=f"L_S={L_S}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="n1",
        width=16.0,
        cross_section="DC",
...
def HHI_TOBiasSection(L: float = 100.0) -> gf.Component:
    ...
    c.add_label(text=f"L={L}", position=(0, 0), layer=layer_label)
    c.add_port(
        name="e1",
        width=16.0,
        cross_section="DC",
