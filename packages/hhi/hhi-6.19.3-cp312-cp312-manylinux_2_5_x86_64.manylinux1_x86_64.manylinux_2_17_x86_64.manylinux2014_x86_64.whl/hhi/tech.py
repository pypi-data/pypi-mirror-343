...
from hhi.route_bundle_sbend import route_bundle_sbend
...
def DC(
    ...
    return gf.cross_section.cross_section(
        width=width, layer=layer, radius=radius, **kwargs
    )
...
@xsection
def RF(section_width=100.0, radius=min_radius_metal, **kwargs) -> gf.CrossSection:
    return xs_metal(section_width=section_width, radius=radius, **kwargs)
...
route_bundle_sbend_e200 = partial(
    route_bundle_sbend, cross_section="E200", bend_s="sbend_bezier"
)
route_bundle_sbend_e600 = partial(
    route_bundle_sbend, cross_section="E600", bend_s="sbend_bezier"
)
route_bundle_sbend_e1700 = partial(
    route_bundle_sbend, cross_section="E1700", bend_s="sbend_bezier"
)
...
routing_strategies = dict(
    ...
    route_bundle_dc_corner=route_bundle_dc_corner,
)
