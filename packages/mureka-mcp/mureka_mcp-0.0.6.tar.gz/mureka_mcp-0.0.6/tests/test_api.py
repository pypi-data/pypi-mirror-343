...
async def test_generate_lyrics():
    try:
        title_and_lyrics = await generate_lyrics("A cheerful, upbeat birthday song for a girl named Jessica. Should be celebratory, joyful, and mention her name multiple times. Should include wishes for happiness and a wonderful year ahead.")
