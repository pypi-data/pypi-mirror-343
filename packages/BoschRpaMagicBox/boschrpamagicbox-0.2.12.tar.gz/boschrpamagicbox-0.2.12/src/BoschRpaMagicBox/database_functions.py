...
def fetch_data_from_mysql_server(mysql_host, mysql_port, mysql_user, mysql_password, mysql_database_name, sql_query):
    """
...
def save_mysql_data_to_excel(mysql_host, mysql_port, mysql_user, mysql_password, mysql_database_name, sql_query, username, password, server_name, share_name, remote_file_path,
    ...
    """
    try:
        fetch_data = fetch_data_from_mysql_server(mysql_host, mysql_port, mysql_user, mysql_password, mysql_database_name, sql_query)
