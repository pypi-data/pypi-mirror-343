...
class BrowserConfig(BaseModel):
    ...
    viewport: Optional[Dict[str, int]] = {
        "width": 1280 + random.randint(-200, 200),
        "height": 710 + random.randint(-100, 100),
    }
...
class CrawlerConfig(BaseModel):
    ...
    Attributes:
        screenshot: Whether to take screenshot of the page
        screenshot_path: Path to save screenshots, defaults to 'screenshots'
    """
