...
class TableSelector(BaseModule):
    ...
    def load_metadata(self):
        ...
        try:
            if isinstance(self.metadata_file_path, str) and self.metadata_file_path.startswith("{"):
                ...
                logger.warning("Invalid metadata source provided. Expected a file path or a JSON string.")
                return {}
