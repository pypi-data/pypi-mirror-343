...
class Namespace:
    ...
    def __init__(self, node_name: str, value: Any = None, cache_path: Optional[str] = None):
        """初始化命名空间
        ...
        system_logger.debug(f"[Namespace][{self.namespace_id}]：创建命名空间，node_name={self.node_name}")
    ...
    def set_value(self, value: Any) -> None:
        ...
        """
        self.value = value
        system_logger.debug(f"[Namespace][{self.namespace_id}]：设置值，node_name={self.node_name}")
    ...
    def set_cache_path(self, cache_path: str) -> None:
        ...
        """
        self.cache_path = cache_path
        system_logger.debug(f"[Namespace][{self.namespace_id}]：设置缓存路径，node_name={self.node_name}, cache_path={cache_path}")
...
class NamespaceRegistry:
    ...
    def get_namespace(self, node_name: str) -> Namespace:
        ...
        if node_name not in self.namespaces:
            ...
            system_logger.debug(f"[Registry][{self.registry_id}]：创建命名空间，node_name={node_name}")
    ...
    def set_value(self, node_name: str, value: Any) -> None:
        ...
        system_logger.debug(f"[Registry][{self.registry_id}]：设置命名空间值，node_name={node_name}")
    ...
    def get_value(self, node_name: str, default: Any = None) -> Any:
        ...
        """
        if node_name not in self.namespaces:
            system_logger.debug(f"[Registry][{self.registry_id}]：获取不存在的命名空间，node_name={node_name}")
            return default
        system_logger.debug(f"[Registry][{self.registry_id}]：获取命名空间值，node_name={node_name}")
    ...
    def set_cache_path(self, node_name: str, cache_path: str) -> None:
        ...
        system_logger.debug(f"[Registry][{self.registry_id}]：设置命名空间缓存路径，node_name={node_name}, cache_path={cache_path}")
    
    def get_cache_path(self, node_name: str, default: Optional[str] = None) -> Optional[str]:
        """获取节点命名空间的缓存路径
        ...
        """
        if node_name not in self.namespaces:
            system_logger.debug(f"[Registry][{self.registry_id}]：获取不存在的命名空间的缓存路径，node_name={node_name}")
            return default
        system_logger.debug(f"[Registry][{self.registry_id}]：获取命名空间缓存路径，node_name={node_name}")
    ...
    def clear_namespace_value(self, node_name: str) -> None:
        ...
        if node_name in self.namespaces:
            ...
            system_logger.debug(f"[Registry][{self.registry_id}]：清空命名空间值，node_name={node_name}")
        else:
            system_logger.debug(f"[Registry][{self.registry_id}]：尝试清空不存在的命名空间值，node_name={node_name}")
