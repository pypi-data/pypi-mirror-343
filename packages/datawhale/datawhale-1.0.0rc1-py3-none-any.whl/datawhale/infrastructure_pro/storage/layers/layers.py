...
class Layers:
    ...
    def _generate_value_combinations(self, field_values: Dict[str, Union[str, List[str], Any]] = None) -> List[List[str]]:
        """生成所有可能的字段值组合
    ...
    def get_match_pattern(self, field_values: Dict[str, Union[str, List[str], Any]] = None) -> List[str]:
    ...
    def build_file_path(self, base_path: str, root_value: str, field_values: Dict[str, str]) -> str:
        """构建文件的完整路径
    ...
    def extract_field_values(self, file_path: str, base_path: str, root_value: str) -> Dict[str, str]:
        """从文件路径中提取字段值
