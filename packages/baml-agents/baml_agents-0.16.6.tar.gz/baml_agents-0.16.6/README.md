...
<a href="https://badge.fury.io/py/baml-agents"><img src="https://badge.fury.io/py/baml-agents.svg?style=flat&refresh=0.16.6" alt="PyPI version" /></a>
...
```bash
pip install "baml-agents>=0.16.6,<0.17.0"
```
