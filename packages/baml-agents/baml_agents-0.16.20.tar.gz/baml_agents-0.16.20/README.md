...
<a href="https://pypi.org/project/baml-agents"><img src="https://img.shields.io/badge/v0.16.20-version?color=43cd0f&style=flat&label=pypi" alt="PyPI version" /></a>
...
```bash
pip install "baml-agents>=0.16.20,<0.17.0"
```
