...
[![Available on PyPI](https://img.shields.io/badge/v0.16.21-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.16.21,<0.17.0"
```
