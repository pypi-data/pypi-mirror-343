...
class OrganizationRole(BaseModel):
    ...
    def permissions_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(['write:registries', 'delete:registries', 'write:images', 'delete:images', 'write:sandboxes', 'delete:sandboxes']):
                raise ValueError("each list item must be one of ('write:registries', 'delete:registries', 'write:images', 'delete:images', 'write:sandboxes', 'delete:sandboxes')")
        return value
