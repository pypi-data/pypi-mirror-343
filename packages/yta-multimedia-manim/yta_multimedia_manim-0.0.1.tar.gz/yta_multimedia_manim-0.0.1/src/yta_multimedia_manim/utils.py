...
from yta_multimedia_manim.constants import DEFAULT_SCENE_SIZE, DEFAULT_MANIM_SCENE_SIZE
...
# TODO: I'm not using this method, is it
# actually needed? Remove if not
def manim_alpha_animation_to_videoclip(video):
    ...
    MP3_EXPORTED_FILENAME = Temp.create_filename('manim_exported_audio.mp3')
    ...
    try:
        ...
        video = video.with_audio(AudioFileClip(MP3_EXPORTED_FILENAME))
