# -*- coding: utf-8 -*-
"""
This module is part of the pymodaq_plugins_acs_motion package.
It is based on the module control developed by the petebachant.
https://github.com/petebachant/ACSpy/blob/master/acspy/control.py
Here we add the ability to get the serial number and to load the buffer file.
"""
