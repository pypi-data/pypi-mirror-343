...
class OpenAIPlugin(PyttmanPlugin):
    ...
    detect_memory_prompt = ("You are a filtering layer in a multi-modal AI system. Your "
                            ...
                            "Only output `[MEMORY]: ...` or `0`. You are not ChatGPT. "
    ...
    def prepare_payload(self,
        ...
        if memories:
            memories = self.long_term_memory.get_memories(message.author.id, conversation)
    ...
    def before_router(self, message: MessageMixin):
        ...
        payload = self.prepare_payload(message, conversation)
