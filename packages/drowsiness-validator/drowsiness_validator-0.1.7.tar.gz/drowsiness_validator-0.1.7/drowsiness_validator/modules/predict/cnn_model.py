...
# Import matplotlib conditionally to make it optional
try:
    import matplotlib.pyplot as plt
    MATPLOTLIB_AVAILABLE = True
except ImportError:
    MATPLOTLIB_AVAILABLE = False
    print("Warning: matplotlib not available. Training history plots will not be generated.")
...
def train_model(train_dir, test_dir):
    ...
    if MATPLOTLIB_AVAILABLE:
        ...
        print("Matplotlib not available - skipping training history plot generation")
...
def plot_training_history(history):
    ...
    if not MATPLOTLIB_AVAILABLE:
        print("Cannot plot training history: matplotlib is not available")
        return
