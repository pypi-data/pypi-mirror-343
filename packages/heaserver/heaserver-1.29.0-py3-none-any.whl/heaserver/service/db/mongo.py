...
class Mongo(Database):
    ...
    async def get(self, request: web.Request, collection: str, var_parts: str | Sequence[str] | None = None, mongoattributes=None,
                  sub: str | None = None, groups: Sequence[str] | None = None) -> Optional[root.DesktopObjectDict]:
        """
    ...
    async def get_content(self, request: web.Request, collection: str, var_parts: str | Sequence[str] | None = None, mongoattributes=None,
                          sub: str | None = None, groups: Sequence[str] | None = None) -> Optional[SupportsAsyncRead]:
        """
        ...
        :param groups: the groups to filter by. Defaults to None.
        ...
        """
        obj = await self.get(request, collection, var_parts, mongoattributes, sub, groups)
        if obj is None:
            return None
    ...
    async def get_all(self, request: web.Request, collection: str, var_parts=None, mongoattributes=None,
                      sub: str | None = None, sort: dict[str, Literal[-1, 1]] | None = None,
                      groups: Sequence[str] | None = None) -> AsyncGenerator[root.DesktopObjectDict, None]:
        """
    ...
    async def empty(self, request: web.Request, collection: str, var_parts: str | Sequence[str] | None = None, mongoattributes=None,
                    sub: str | None = None, groups: Sequence[str] | None = None) -> bool:
        """
    ...
    async def put(self, request: web.Request, obj: root.DesktopObject, collection: str,
                  sub: str | None = None, groups: Sequence[str] | None = None) -> Optional[UpdateResult]:
        """
    ...
    async def delete(self, request: web.Request, collection: str, var_parts: str | Sequence[str] | None = None, mongoattributes: dict[str, Any] | None = None,
                     sub: str | None = None, groups: Sequence[str] | None = None) -> Optional[DeleteResult]:
        """
        ...
        coll = self._get_collection(collection)
        try:
            mongo_expr_ = self.__mongo_expr(request, var_parts, mongoattributes, sub, RESTPermissionGroup.DELETER_PERMS._perms_internal, groups)
    ...
    def __mongo_expr(request: web.Request,
                     ...
                     sub: str | None = None,
                     perms: Collection[root.Permission] | None = None,
                     groups: Sequence[str] | None = None) -> dict[str, Any]:
        if perms is not None:
            perms_ = [perm.name for perm in perms]
        else:
            perms_ = None
        extra_ = sub_filter_expr(sub or user.NONE_USER, permissions=perms_, groups=groups)
