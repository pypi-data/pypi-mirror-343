...
class EventSearchParams(BaseModel):
    ...
    object_id: StrictStr = Field(default=..., description="Unique ID of the object.")
    ...
    types: Optional[conlist(EventType)] = Field(default=None, description="An array of up to 20 strings containing specific event names. The list will be filtered to include only events with a matching event property.")
    updated_at: Optional[DateTimeFilter] = None
    __properties = ["created_at", "expand", "limit", "object_id", "page_number", "page_size", "sort_descending", "sort_key", "types", "updated_at"]
