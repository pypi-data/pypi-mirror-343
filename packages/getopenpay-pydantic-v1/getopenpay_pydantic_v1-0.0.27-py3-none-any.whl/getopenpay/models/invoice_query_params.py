...
class InvoiceQueryParams(BaseModel):
    ...
    __properties = ["billing_reason", "collection_method", "coupon_id", "created_at", "currency", "customer_id", "expand", "page_number", "page_size", "period_end", "period_start", "search", "sort_descending", "sort_key", "status", "subscription_id", "total_amount_atom", "updated_at"]
