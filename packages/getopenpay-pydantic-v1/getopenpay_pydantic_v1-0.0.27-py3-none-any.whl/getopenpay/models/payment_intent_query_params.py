...
class PaymentIntentQueryParams(BaseModel):
    ...
    __properties = ["amount_atom", "created_at", "customer_id", "expand", "invoice_id", "page_number", "page_size", "payment_method_id", "search", "sort_descending", "sort_key", "status", "updated_at"]
