...
class CreateCustomerRequest(BaseModel):
    ...
    email: StrictStr = Field(default=..., description="The customer’s email address.")
    ...
    shipping_addresses: Optional[conlist(CompleteAddress)] = Field(default=None, description="List of the customer’s shipping addresses.")
    state: Optional[StrictStr] = None
    zip_code: Optional[StrictStr] = None
    __properties = ["billing_email", "business_name", "city", "country", "coupon_id", "custom_fields", "customer_billing_address", "email", "first_name", "invoice_settings", "language", "last_name", "line1", "line2", "line3", "notes", "phone_number", "promotion_code_id", "shipping_addresses", "state", "zip_code"]
