...
class RefundQueryParams(BaseModel):
    ...
    __properties = ["amount_atom", "charge_id", "created_at", "customer_id", "expand", "page_number", "page_size", "payment_intent_id", "reason", "sort_descending", "sort_key", "status", "updated_at"]
