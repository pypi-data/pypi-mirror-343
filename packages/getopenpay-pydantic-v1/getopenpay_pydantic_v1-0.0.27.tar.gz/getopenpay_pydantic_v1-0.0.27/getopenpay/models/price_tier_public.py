...
class PriceTierPublic(BaseModel):
    ...
    PriceTierPublic
    """
    flat_amount_atom: StrictInt = Field(default=..., description="Flat price in the currency atom.")
    unit_amount_atom: StrictInt = Field(default=..., description="Price per unit in the currency atom.")
