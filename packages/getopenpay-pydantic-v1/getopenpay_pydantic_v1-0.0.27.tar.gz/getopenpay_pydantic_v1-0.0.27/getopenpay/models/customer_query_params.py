...
class CustomerQueryParams(BaseModel):
    ...
    emails: Optional[conlist(StrictStr)] = Field(default=None, description="List of customer email address.")
    ...
    __properties = ["coupon_id", "created_at", "email", "emails", "expand", "page_number", "page_size", "search", "sort_descending", "sort_key", "updated_at"]
