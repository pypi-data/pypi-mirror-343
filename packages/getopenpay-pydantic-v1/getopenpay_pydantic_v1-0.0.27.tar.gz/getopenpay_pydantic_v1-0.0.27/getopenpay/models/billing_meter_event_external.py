...
class BillingMeterEventExternal(BaseModel):
    ...
    status: BillingMeterEventStatus = Field(default=..., description="Status of the billing meter event.")
    updated_at: datetime = Field(default=..., description="DateTime at which the object was updated, in 'ISO 8601' format.")
    __properties = ["account_id", "created_at", "event_datetime", "event_name", "id", "identifier", "is_deleted", "object", "payload", "status", "updated_at"]
