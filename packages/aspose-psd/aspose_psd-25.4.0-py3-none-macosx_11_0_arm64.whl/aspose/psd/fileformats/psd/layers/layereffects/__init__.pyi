...
class GradientOverlayEffect(ILayerEffect):
    ...
    @property
    def settings(self) -> aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings:
        '''Gets the settings.'''
        ...
    
    @settings.setter
    def settings(self, value : aspose.psd.fileformats.psd.layers.fillsettings.BaseGradientFillSettings):
        '''Sets the settings.'''
        ...
