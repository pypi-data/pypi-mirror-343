...
def main(input_file, source_format, target_format, output_file, input_schema, output_schema):
    """Universal Config Converter CLI"""
    try:
        convert(input_file, source_format, target_format, output_file, input_schema, output_schema)
        click.echo(
