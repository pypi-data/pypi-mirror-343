...
progessiveBlueOrange = LinearSegmentedColormap.from_list('progessiveBlueOrange', ['#023047', '#219ebc', '#8ecae6', '#ffb703', '#fb8500']) # Blue orange
progessiveGreenOrange = LinearSegmentedColormap.from_list('progessiveGreenOrange', ['#264653', '#2a9d8f', '#e9c46a', '#f4a261', '#e76f51']) # Green orange
