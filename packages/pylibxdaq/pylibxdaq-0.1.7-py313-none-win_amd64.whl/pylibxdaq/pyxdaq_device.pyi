...
class Device:
    ...
    def set_register_sync(self, arg0: int, arg1: int, arg2: int) -> ReturnCode:
        ...
    def start_aligned_read_stream(self, addr: int, alignment: int, callback: typing.Callable[[DataView | None, str | None], None], *, chunk_size: int = 0) -> DataStream | None:
        ...
    def start_read_stream(self, addr: int, callback: typing.Callable[[ManagedBuffer | None, str | None], None], *, chunk_size: int = 0) -> DataStream | None:
        ...
