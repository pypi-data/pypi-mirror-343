...
from resource.parameters_info.basic_parameter_info import vnc_port_win_tille_dict, area_dungeons_dict
from otauto.template_match_mt import template_match # 模版模块
...
class VNC_recognition:
    ...
    def find_image_region(self,x1,y1,x2,y2):
        """
        :param x1: int:截图区域
        :param y1: int:截图区域
        :param x2: int:截图区域
        ...
        try:
            ...
            return template_match(numpy_data, area_dungeons_dict)
        except Exception as e:
