...
class Currency:
    ...
    def __init__(self, params):
        ...
        self.decimal_digit_cnt = (
            int(params.get("decimal_digit_cnt"))
            if params.get("decimal_digit_cnt")
            else None
        )
        # The symbol used to identify each defined currency.
        self.curr_symbol = (
            params.get("curr_symbol") if params.get("curr_symbol") else None
        )
        # The decimal symbol displayed.
        self.decimal_symbol = (
            params.get("decimal_symbol").strip()
            if params.get("decimal_symbol")
            else None
        )
        # The symbol used to group the numbers.
        self.digit_group_symbol = (
            params.get("digit_group_symbol").strip()
            if params.get("digit_group_symbol")
            else None
        )
        # The symbol used to display a positive currency.
        self.pos_curr_fmt_type = (
            params.get("pos_curr_fmt_type").strip()
            if params.get("pos_curr_fmt_type")
            else None
        )
        # The symbol used to display a negative currency.
        self.neg_curr_fmt_type = (
            params.get("neg_curr_fmt_type").strip()
            if params.get("neg_curr_fmt_type")
            else None
        )
        ...
        self.curr_short_name = (
            params.get("curr_short_name").strip()
            if params.get("curr_short_name")
            else None
        )
        ...
        self.base_exch_rate = (
            params.get("base_exch_rate").strip()
            if params.get("base_exch_rate")
            else None
        )
