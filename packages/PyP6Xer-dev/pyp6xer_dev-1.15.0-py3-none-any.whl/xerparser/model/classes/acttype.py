...
class ActType:
    ...
    def __init__(self, params):
        ...
        self.actv_short_len = (
            locale.atof(params.get("actv_short_len").strip())
            if params.get("actv_short_len")
            else None
        )
        ...
        self.actv_code_type = (
            params.get("actv_code_type").strip()
            if params.get("actv_code_type")
            else None
        )
        ...
        self.actv_code_type_scope = (
            params.get("actv_code_type_scope").strip()
            if params.get("actv_code_type_scope")
            else None
        )
