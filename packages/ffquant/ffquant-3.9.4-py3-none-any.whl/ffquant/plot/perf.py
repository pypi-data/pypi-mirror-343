...
def optrun_and_show_table(
    ...
    for key in sorted(opt_param_keys):
        headers.append(key)
    
    headers = headers + ["return_rate", "sharpe", "reward_risk_ratio", "win_rate", "max_drawdown"]
    ...
    for opt_result in global_backtest_data.opt_results:
        ...
        for key in sorted(opt_params.keys()):
            v = opt_params[key]
