...
from jjsystem.common.subsystem import manager
from jjsystem.common.subsystem import operation
from jjsystem.subsystem.functionality.resource import Functionality, FunctionalityRoute
from jjsystem.subsystem.module.resource import Module, ModuleFunctionality
from jjsystem.subsystem.user.email import TypeEmail, send_email
...
from jjsystem.subsystem.grant.resource import Grant
from jjsystem.subsystem.policy.resource import Policy
from jjsystem.subsystem.policy_functionality.resource \
    import PolicyFunctionality
from jjsystem.subsystem.policy_module.resource import PolicyModule
...
class Restore(operation.Operation):
    ...
    def pre(self, **kwargs):
        ...
        jjsystem_reset_url = os.environ.get(
            'JJSYSTEM_RESET_URL', 'http://jjsystem.com/#/reset/')
        self.reset_url = kwargs.get('reset_url', jjsystem_reset_url)
