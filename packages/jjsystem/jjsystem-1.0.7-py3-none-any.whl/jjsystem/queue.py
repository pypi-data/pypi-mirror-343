...
class RabbitMQ:
    ...
    def __init__(self):
        self.url = flask.current_app.config['JJSYSTEM_QUEUE_URL']
        self.port = flask.current_app.config['JJSYSTEM_QUEUE_PORT']
        self.virtual_host = \
            flask.current_app.config['JJSYSTEM_QUEUE_VIRTUAL_HOST']
        self.username = flask.current_app.config['JJSYSTEM_QUEUE_USERNAME']
        self.password = flask.current_app.config['JJSYSTEM_QUEUE_PASSWORD']
