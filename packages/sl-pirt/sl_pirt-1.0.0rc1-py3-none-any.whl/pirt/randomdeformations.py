...
def create_random_deformation_gaussian(im, amplitude=1, min_sigma=10, nblobs=50, seed=None):
    ...
    for dimension in range(len(im.shape)):
        ...
        for iter in range(nblobs):
            ...
            # Create patch
            patch = src.pirt.gaussfun.gaussiankernel2(sigma, 0, 0)
    ...
    deform = pirt.DeformationFieldBackward.from_field_multiscale(fields, gridsampling, injective=True, frozenedge=True)
