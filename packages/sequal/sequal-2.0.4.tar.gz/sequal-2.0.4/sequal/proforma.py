...
class ProFormaParser:
    ...
    @staticmethod
    def parse(proforma_str: str) -> Tuple[str, Dict[int, List[Modification]], List[GlobalModification], List['SequenceAmbiguity'], Optional[Tuple[int, str]]]:
        """
        ...
        return base_sequence, modifications, global_mods, sequence_ambiguities, (charge, species)
