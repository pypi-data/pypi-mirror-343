...
from paxpar.cli.tools import PaxparCLI_ObjCtx, call, root_command_callback, call_yaml
...
def api(
    ...
    helm_values_file_n = "\n".join([rf"-f {c} \ ".strip() for c in helm_values_file])
    ...
    helm_values_n = "\n".join([rf"--set {c} \ ".strip() for c in helm_values])
    ...
    #    namespace,
    #    gitlab_token_registry_read,
    #    ctx_obj,
    #)
    #registry_credentials_create(
    #    "gitea-registry-credentials",
    #    "https://gitea.arundo.tech",
    #    namespace,
    #    gitea_token_registry_read,
    #    ctx_obj,
    #)
