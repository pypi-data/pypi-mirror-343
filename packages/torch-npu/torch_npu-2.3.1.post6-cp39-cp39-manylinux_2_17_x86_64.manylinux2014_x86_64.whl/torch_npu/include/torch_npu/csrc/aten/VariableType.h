...
// @generated from /opt/agent_1744688376058/workspace/j_crXYnChH/pytorch/codegen/autograd/templates/VariableType.h
...
namespace VariableType {
  ...
  ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> npu_cross_entropy_loss(c10::DispatchKeySet ks, const at::Tensor & input, const at::Tensor & target, const c10::optional<at::Tensor> & weight, c10::string_view reduction, int64_t ignore_index, double label_smoothing, double lse_square_scale_for_zloss, bool return_zloss);
  ::std::tuple<at::Tensor,at::Tensor,at::Tensor> npu_group_norm_swish(c10::DispatchKeySet ks, const at::Tensor & input, int64_t num_groups, const at::Tensor & weight, const at::Tensor & bias, c10::optional<double> eps, c10::optional<double> swish_scale);
};
