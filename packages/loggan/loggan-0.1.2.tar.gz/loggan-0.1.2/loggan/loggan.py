    ...
    def emit(self, record):
        ...
        req = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "DiscordWebhookLogger/1.0 (Python/3.13)",
            },
        )
        ...
        try:
            ...
            logging.getLogger().error(
                f"HTTP Failed to send Discord webhook: {e} - URL: {self.webhook_url}"
            )
        except urllib.error.URLError as e:
            logging.getLogger().error(
                f"URL Failed to send Discord webhook: {e} - URL: {self.webhook_url}"
            )
