...
from perigon.models.internal_error_exception_cause import InternalErrorExceptionCause
from perigon.models.internal_error_exception_cause_stack_trace_inner import (
...
class InternalErrorException(BaseModel):
    ...
    cause: Optional[InternalErrorExceptionCause] = None
    stack_trace: Optional[List[InternalErrorExceptionCauseStackTraceInner]] = Field(
        default=None, alias="stackTrace"
    )
    message: Optional[StrictStr] = None
    suppressed: Optional[List[InternalErrorExceptionCause]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "cause": InternalErrorExceptionCause.from_dict(obj["cause"])
                if obj.get("cause") is not None
                else None,
                "stackTrace": [
                    InternalErrorExceptionCauseStackTraceInner.from_dict(_item)
                ...
                "suppressed": [
                    InternalErrorExceptionCause.from_dict(_item)
