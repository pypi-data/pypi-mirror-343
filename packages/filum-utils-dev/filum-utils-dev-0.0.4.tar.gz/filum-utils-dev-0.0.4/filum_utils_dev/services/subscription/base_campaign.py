...
class BaseCampaignSubscriptionService(SubscriptionService):
    ...
    def _handling_upload_metadata_groups_file(
        ...
        metadata_group_list = [metadata_group for metadata_group in metadata_groups.values()]
    ...
    def _get_metadata_groups(self, channel_name: str, users: List[Dict[str, Any]]) -> Optional[Dict[str, MetadataGroup]]:
