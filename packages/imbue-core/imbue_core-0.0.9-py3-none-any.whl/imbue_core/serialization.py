...
SerializableOrTuple = Serializable | Tuple["SerializableOrTuple", ...]


@attr.s(auto_attribs=True, frozen=True)
class SerializedException(Serializable):
    """A serializable dataclass that represents an exception"""

    exception: str
    args: SerializableOrTuple
    traceback: Optional[FixedTraceback]
    ...
    def build(cls, exception: BaseException, traceback: Optional[TracebackType] = None) -> "SerializedException":
        ...
        return SerializedException(
            ...
            traceback=FixedTraceback.from_tb(traceback),
        )
    ...
    def construct_instance(self) -> BaseException:
        return self.exception_class(*cast(Tuple[Serializable, ...], self.args))
