    ...
    try:
        if main_args.publish:
            ...
            gar_client.subscribe("S1", mode=subscription_mode,
                                 ...
                                 include_unknown_keys=main_args.include_unknown_keys
                                 )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--class", type=str, default=None,
                        help="Class name")
    parser.add_argument("--include-unknown-keys", action="store_true",
                        help="Include unknown keys when filtering for class")
