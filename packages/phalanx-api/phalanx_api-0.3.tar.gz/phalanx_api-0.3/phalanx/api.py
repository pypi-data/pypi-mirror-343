...
class ChannelAdvisorApi(ApiClient):
    ...
    def products_page(self, limit=100, raw=False, params=None, **kwargs):
        params = params or {}
        params.setdefault('$top', limit)
        params.setdefault('$orderby', 'UpdateDateUtc desc')
        route = 'v1/Products'
        return self.get(route, params=params, raw=raw, **kwargs)

    def orders_page(self, limit=100, raw=False, params=None, **kwargs):
        params = params or {}
        params.setdefault('$top', limit)
        params.setdefault('$orderby', 'UpdatedDateUtc desc')
        params.setdefault(
            '$expand',
