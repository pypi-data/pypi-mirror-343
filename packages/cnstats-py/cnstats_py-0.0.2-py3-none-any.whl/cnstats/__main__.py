...
def add_get_tree_parser(subparsers):
    """Adds the parser for the get_tree command."""
    parser_get_tree = subparsers.add_parser(
        "get_tree",
...
def add_query_data_parser(subparsers):
    """Adds the parser for the query_data command."""
    parser_query_data = subparsers.add_parser(
        "query_data",
    ...
    parser_query_data.add_argument(
        "--zbcode", type=str, required=True, help="Required. The indicator code(s)."
    )
    parser_query_data.add_argument(
        "--sj",
        type=str,
    ...
    parser_query_data.add_argument(
        "--regcode", type=str, help="Optional. The region code(s)."
    )
    parser_query_data.add_argument(
        "-o",
        "--output",
