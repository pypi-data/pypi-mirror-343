...
from ssolib.dataprep import filter_sso_data
from ssolib.modelfit import get_fit_params, make_residuals_df
from ssolib.periodest import get_period_estimate, perform_residual_resampling


def process_single_sso(name: str, path_args: list) -> tuple | None:
    """
