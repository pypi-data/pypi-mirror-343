...
from .v1_jupyter_notebook_instance_status_pod_resourcestate import V1JupyterNotebookInstanceStatusPodResourceState
...
class V1JupyterNotebookInstanceStatus(BaseModel):
    ...
    pods : Optional[dict[str,V1JupyterNotebookInstanceStatusPodResourceState]] = Field(default = None, alias = "pods")
