...
class BaseModel(SQLModel):
    ...
    created_at: datetime = Field(default_factory=datetime.now, title='创建时间', nullable=False)
    updated_at: datetime = Field(default_factory=datetime.now, title='更新时间', nullable=False)
    deleted: bool = Field(default=False, title='是否删除', nullable=False)
