...
__all__ = [
    ...
    "rm", "wait", "wait_seconds", "wait_minutes", "wait_hours", "ct", "micmute", "micunmute", "record"
]

if sys.platform == "win32":
    __all__.append("mute")
    __all__.append("unmute")
    __all__.append("micmute")
    __all__.append("micunmute")
    __all__.append("record")