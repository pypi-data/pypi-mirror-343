...
async def get_all_minecraft_versions() -> list[FabricMinecraftVersion]:
    ...
    .. code:: python
        ...
        for version in await minecraft_launcher_lib.fabric.get_all_minecraft_versions():
...
async def get_stable_minecraft_versions() -> list[str]:
    ...
    .. code:: python
        ...
        for version in await minecraft_launcher_lib.fabric.get_stable_minecraft_versions():
            print(version)
    """
...
async def get_latest_minecraft_version() -> str:
    ...
    .. code:: python
        ...
        print("Latest Minecraft version: " + await minecraft_launcher_lib.fabric.get_latest_minecraft_version())
    """
    minecraft_versions = await get_all_minecraft_versions()
...
async def get_latest_stable_minecraft_version() -> str:
    ...
    .. code:: python
        ...
        print("Latest stable Minecraft version: " + await minecraft_launcher_lib.fabric.get_latest_stable_minecraft_version())
    """
...
async def is_minecraft_version_supported(version: str) -> bool:
    ...
    .. code:: python
        ...
        version = "1.20"
        if await minecraft_launcher_lib.fabric.is_minecraft_version_supported(version):
...
async def get_all_loader_versions() -> list[FabricLoader]:
    ...
    .. code:: python
        ...
        for version in await minecraft_launcher_lib.fabric.get_all_loader_versions():
            print(version["version"])
    """
...
async def get_latest_loader_version() -> str:
    ...
    .. code:: python
        ...
        print("Latest loader version: " + await minecraft_launcher_lib.fabric.get_latest_loader_version())
    """
...
async def get_latest_installer_version() -> str:
    ...
    .. code:: python
        ...
        print("Latest installer version: " + await minecraft_launcher_lib.fabric.get_latest_installer_version())
    """
...
async def install_fabric(
    ...
    .. code:: python
        ...
        await minecraft_launcher_lib.fabric.install_fabric(minecraft_version, minecraft_directory)
