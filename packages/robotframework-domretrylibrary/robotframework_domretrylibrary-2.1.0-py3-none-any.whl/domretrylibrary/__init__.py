...
# Directly expose the DomRetryLibrary class
from .core import DomRetryLibrary as DomRetryLibrary

# This allows importing directly with "Library    DomRetryLibrary"
__version__ = "2.1.0"
