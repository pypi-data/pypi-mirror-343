...
class DomRetryLibrary:
    ...
    def ai_fallback_locator(self, keyword_name, locator_var, *args, ai_description=None):
        ...
        When using direct CSS/XPath selectors (from version 2.6.1), the library will
        automatically attempt to find a matching variable and its AI description.
