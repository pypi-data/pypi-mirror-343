...
class AIProcessor:
    ...
    def _normalize_xpath_text_conditions(self, xpath):
        ...
        # Pattern to find text() conditions: text()='something' or text()="something"
        ...
        # Pattern for contains(text(), 'something')
    ...
    def generate_locator(self, html, element_description, original_locator=None, page_url=None, selenium_lib=None):
        ...
        # Log the description to help with debugging
        ...
        # Create a unique cache key that includes the description
        if original_locator and element_description:
            # Use a hash of the description to ensure uniqueness
