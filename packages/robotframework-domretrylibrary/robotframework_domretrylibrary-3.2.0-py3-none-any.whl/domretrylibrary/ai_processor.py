...
13. Be VERY CAREFUL when using path separators:
...
PAY SPECIAL ATTENTION to path separators:
- Use / when you need to select an immediate child (direct parent-child relationship)
- Use // when the element can be at any depth inside another element (indirect relationship)
