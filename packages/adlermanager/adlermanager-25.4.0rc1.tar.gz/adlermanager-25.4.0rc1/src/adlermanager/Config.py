...
class ConfigClass(object):
    ...
    # Web
    web_endpoint: str = attr.ib(default=os.getenv("WEB_ENDPOINT", r"tcp6:interface=\:\::port=8080"))
    """
    ...
    ssh_endpoint: str = attr.ib(default=os.getenv("SSH_ENDPOINT", r"tcp6:interface=\:\::port=2222"))
    """
    ...
    # Alerts processing
    alert_resolve_minutes: timedelta = attr.ib(default=timedelta(minutes=int(os.getenv("ALERT_RESOLVE_MINUTES", "5"))))
    """
