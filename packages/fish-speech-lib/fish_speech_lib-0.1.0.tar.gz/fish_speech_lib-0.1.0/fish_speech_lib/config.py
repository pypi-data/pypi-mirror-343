...
FIREFLY_GAN_VQ_CONFIG = {
    ...
    "spec_transform": {
        "_target_": "fish_speech_lib.fish_speech.utils.spectrogram.LogMelSpectrogram",
        "sample_rate": 44100,
        "n_mels": 160,
        "n_fft": 2048,
        "hop_length": 512,
    ...
    "backbone": {
        "_target_": "fish_speech_lib.fish_speech.models.vqgan.modules.firefly.ConvNeXtEncoder",
        "input_channels": 160,
        "depths": [3, 3, 9, 3],
    ...
    "quantizer": {
        "_target_": "fish_speech_lib.fish_speech.models.vqgan.modules.fsq.DownsampleFiniteScalarQuantize",
        "input_dim": 512,
        "n_groups": 8,
        "n_codebooks": 1,
        "levels": [8, 5, 5, 5],
