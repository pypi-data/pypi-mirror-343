...
def compute_metrics_for_ensemble(ensemble_path,duplicated_chain=False,path=None):
    ...
    np.save(path+'/metadata/Rgs.npy',np.array(Rgs))
    np.save(path+'/metadata/mpds.npy',np.array(mpds))
    np.save(path+'/metadata/eeds.npy',np.array(eeds))
    np.save(path+'/metadata/asphs.npy',np.array(asphs))
    np.save(path+'/metadata/fractal_dims.npy',np.array(fractals))
    np.save(path+'/metadata/convex_hull_volume.npy',np.array(convs))
    np.save(path+'/metadata/gdfs.npy',np.array(gdfs))
    np.save(path+'/metadata/CNs.npy',np.array(CNs))
