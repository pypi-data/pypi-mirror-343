# Salt Extension for Salt Winrepo

Salt Extension for testing Salt Winrepo
...
The saltext-test-salt-winrepo project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:dafyddj/saltext-test-salt-winrepo.git

# Change to the repo dir
cd saltext-test-salt-winrepo
```
...
* Writing blog posts
* Sharing your experiences using Salt + Salt Winrepo
  on social media
...
[issues]: https://github.com/dafyddj/saltext-test-salt-winrepo/issues
[PRs]: https://github.com/dafyddj/saltext-test-salt-winrepo/pulls
[discussions]: https://github.com/dafyddj/saltext-test-salt-winrepo/discussions
