...
##    print(opts)
    ...
    if api=='kugou':
        from get_music.api_list.kg_playerlist import kg_playerlist
        kg_playerlist(url,lrc=lrc,pic=pic)
    elif api=='netease':
        from get_music.api_list.wy_playerlist import wy_playerlist
        wy_playerlist(url,lrc=lrc,pic=pic)
    elif api=='qq':
        from get_music.api_list.qq_playerlist import qq_playerlist
        qq_playerlist(url,lrc=lrc,pic=pic)
    elif api=='kuwo':
        from get_music.api_list.kw_playerlist import kw_playerlist
