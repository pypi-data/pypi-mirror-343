...
def setup_lookup_data(params, bucket):
    ...
    """
    data = dict()
    input_path_item_code = f'{params["g_model_fuzzy_lookup_folder"]}/{params["item_code_lookup"]}'
    input_path_invoice_classification = f'{params["g_model_fuzzy_lookup_folder"]}/{params["invoice_classification_lookup"]}'
    ...
    data["invoice_classification"] = download_json_from_bucket(input_path_invoice_classification)
    return data
