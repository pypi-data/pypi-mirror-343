...
REQUIRED_DEP = ['pyqt5', 'lxml','imutils==0.5.4','tqdm==4.67.1','XlsxWriter==3.2.3','six==1.17.0','numpy==2.2.4','progressbar2==3.47.0','scikit_learn==1.6.1','pandas','xlwt==1.3.0','sip==1.17.0']
about = {}
