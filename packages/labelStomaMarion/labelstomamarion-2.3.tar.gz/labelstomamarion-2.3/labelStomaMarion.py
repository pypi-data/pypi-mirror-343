...
from libs.excelMarion import Ui_Dialog
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        self.actions = struct(save=save, save_format=save_format, saveAs=saveAs, open=open, close=close,
                              resetAll=resetAll,
                              lineColor=color1, create=create, delete=delete,  edit=edit, #createScale=createScale,createRegion=createRegion
        ...
        addActions(self.menus.stoma, (create, detect,  excel,close))#, trainModel createScale, createRegion,
    ...
    def generarExcelStoma(self):
        ...
        ui1 = Ui_Dialog()
        ui1.setupUi(DialogStoma)
        x = DialogStoma.exec_()
        if ui1.genera:
            generaExcelStoma(os.path.dirname(ustr(self.filePath)), ui1.esca, ui1.pixe, ui1.uni)
