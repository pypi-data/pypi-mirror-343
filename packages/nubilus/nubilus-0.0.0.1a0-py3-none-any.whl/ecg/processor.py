...
class BPF:
    ...
    def __call__(self, input_signal:np.ndarray):
        if self.method != 'HYBRID':
            return filtfilt(self.b, self.a, input_signal) if self.method=='IIR' else filtfilt(self.taps, [1.0], input_signal)
        else:
            return filtfilt(self.taps, [1.0], filtfilt(self.b, self.a, input_signal))
