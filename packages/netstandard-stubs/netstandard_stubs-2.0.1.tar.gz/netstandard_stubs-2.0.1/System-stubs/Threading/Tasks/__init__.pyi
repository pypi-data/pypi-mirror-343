import typing, abc
from System import Func_1, Func_4, Action_1, Action_2, Action_3, Func_5, Func_3, Array_1, Action, IDisposable, IAsyncResult, AggregateException, Func_2, TimeSpan, Exception, IAsyncDisposable, OperationCanceledException, AsyncCallback, Func_6, EventArgs, IEquatable_1
from System.Collections.Concurrent import OrderablePartitioner_1, Partitioner_1
...
class Parallel(abc.ABC):
    # Skipped For due to it being static, abstract and generic.

    For : For_MethodGroup
    class For_MethodGroup:
        def __getitem__(self, t:typing.Type[For_1_T1]) -> For_1[For_1_T1]: ...

        For_1_T1 = typing.TypeVar('For_1_T1')
        class For_1(typing.Generic[For_1_T1]):
            For_1_TLocal = Parallel.For_MethodGroup.For_1_T1
            @typing.overload
            def __call__(self, fromInclusive: int, toExclusive: int, localInit: Func_1[For_1_TLocal], body: Func_4[int, ParallelLoopState, For_1_TLocal, For_1_TLocal], localFinally: Action_1[For_1_TLocal]) -> ParallelLoopResult:...
            # Method For(fromInclusive : Int64, toExclusive : Int64, localInit : Func`1, body : Func`4, localFinally : Action`1) was skipped since it collides with above method
            @typing.overload
            def __call__(self, fromInclusive: int, toExclusive: int, parallelOptions: ParallelOptions, localInit: Func_1[For_1_TLocal], body: Func_4[int, ParallelLoopState, For_1_TLocal, For_1_TLocal], localFinally: Action_1[For_1_TLocal]) -> ParallelLoopResult:...
            # Method For(fromInclusive : Int64, toExclusive : Int64, parallelOptions : ParallelOptions, localInit : Func`1, body : Func`4, localFinally : Action`1) was skipped since it collides with above method

        @typing.overload
        def __call__(self, fromInclusive: int, toExclusive: int, body: Action_1[int]) -> ParallelLoopResult:...
        # Method For(fromInclusive : Int64, toExclusive : Int64, body : Action`1) was skipped since it collides with above method
        @typing.overload
        def __call__(self, fromInclusive: int, toExclusive: int, body: Action_2[int, ParallelLoopState]) -> ParallelLoopResult:...
        # Method For(fromInclusive : Int64, toExclusive : Int64, body : Action`2) was skipped since it collides with above method
        @typing.overload
        def __call__(self, fromInclusive: int, toExclusive: int, parallelOptions: ParallelOptions, body: Action_1[int]) -> ParallelLoopResult:...
        # Method For(fromInclusive : Int64, toExclusive : Int64, parallelOptions : ParallelOptions, body : Action`1) was skipped since it collides with above method
        @typing.overload
        def __call__(self, fromInclusive: int, toExclusive: int, parallelOptions: ParallelOptions, body: Action_2[int, ParallelLoopState]) -> ParallelLoopResult:...
        # Method For(fromInclusive : Int64, toExclusive : Int64, parallelOptions : ParallelOptions, body : Action`2) was skipped since it collides with above method
    ...
    class ForEach_MethodGroup:
        ...
        class ForEach_1(typing.Generic[ForEach_1_T1]):
            ForEach_1_TSource = Parallel.ForEach_MethodGroup.ForEach_1_T1
            @typing.overload
            def __call__(self, source: OrderablePartitioner_1[ForEach_1_TSource], body: Action_3[ForEach_1_TSource, ParallelLoopState, int]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], body: Action_3[ForEach_1_TSource, ParallelLoopState, int]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], body: Action_1[ForEach_1_TSource]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], body: Action_2[ForEach_1_TSource, ParallelLoopState]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_1_TSource], body: Action_1[ForEach_1_TSource]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_1_TSource], body: Action_2[ForEach_1_TSource, ParallelLoopState]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: OrderablePartitioner_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_3[ForEach_1_TSource, ParallelLoopState, int]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_3[ForEach_1_TSource, ParallelLoopState, int]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_1[ForEach_1_TSource]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_2[ForEach_1_TSource, ParallelLoopState]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_1[ForEach_1_TSource]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_1_TSource], parallelOptions: ParallelOptions, body: Action_2[ForEach_1_TSource, ParallelLoopState]) -> ParallelLoopResult:...

        @typing.overload
        def __getitem__(self, t:typing.Tuple[typing.Type[ForEach_2_T1], typing.Type[ForEach_2_T2]]) -> ForEach_2[ForEach_2_T1, ForEach_2_T2]: ...

        ForEach_2_T1 = typing.TypeVar('ForEach_2_T1')
        ForEach_2_T2 = typing.TypeVar('ForEach_2_T2')
        class ForEach_2(typing.Generic[ForEach_2_T1, ForEach_2_T2]):
            ForEach_2_TSource = Parallel.ForEach_MethodGroup.ForEach_2_T1
            ForEach_2_TLocal = Parallel.ForEach_MethodGroup.ForEach_2_T2
            @typing.overload
            def __call__(self, source: OrderablePartitioner_1[ForEach_2_TSource], localInit: Func_1[ForEach_2_TLocal], body: Func_5[ForEach_2_TSource, ParallelLoopState, int, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_2_TSource], localInit: Func_1[ForEach_2_TLocal], body: Func_5[ForEach_2_TSource, ParallelLoopState, int, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_2_TSource], localInit: Func_1[ForEach_2_TLocal], body: Func_4[ForEach_2_TSource, ParallelLoopState, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_2_TSource], localInit: Func_1[ForEach_2_TLocal], body: Func_4[ForEach_2_TSource, ParallelLoopState, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: OrderablePartitioner_1[ForEach_2_TSource], parallelOptions: ParallelOptions, localInit: Func_1[ForEach_2_TLocal], body: Func_5[ForEach_2_TSource, ParallelLoopState, int, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_2_TSource], parallelOptions: ParallelOptions, localInit: Func_1[ForEach_2_TLocal], body: Func_5[ForEach_2_TSource, ParallelLoopState, int, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEach_2_TSource], parallelOptions: ParallelOptions, localInit: Func_1[ForEach_2_TLocal], body: Func_4[ForEach_2_TSource, ParallelLoopState, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...
            @typing.overload
            def __call__(self, source: Partitioner_1[ForEach_2_TSource], parallelOptions: ParallelOptions, localInit: Func_1[ForEach_2_TLocal], body: Func_4[ForEach_2_TSource, ParallelLoopState, ForEach_2_TLocal, ForEach_2_TLocal], localFinally: Action_1[ForEach_2_TLocal]) -> ParallelLoopResult:...


    # Skipped ForEachAsync due to it being static, abstract and generic.

    ForEachAsync : ForEachAsync_MethodGroup
    class ForEachAsync_MethodGroup:
        def __getitem__(self, t:typing.Type[ForEachAsync_1_T1]) -> ForEachAsync_1[ForEachAsync_1_T1]: ...

        ForEachAsync_1_T1 = typing.TypeVar('ForEachAsync_1_T1')
        class ForEachAsync_1(typing.Generic[ForEachAsync_1_T1]):
            ForEachAsync_1_TSource = Parallel.ForEachAsync_MethodGroup.ForEachAsync_1_T1
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEachAsync_1_TSource], body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
            @typing.overload
            def __call__(self, source: IAsyncEnumerable_1[ForEachAsync_1_TSource], body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEachAsync_1_TSource], cancellationToken: CancellationToken, body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
            @typing.overload
            def __call__(self, source: IEnumerable_1[ForEachAsync_1_TSource], parallelOptions: ParallelOptions, body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
            @typing.overload
            def __call__(self, source: IAsyncEnumerable_1[ForEachAsync_1_TSource], cancellationToken: CancellationToken, body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
            @typing.overload
            def __call__(self, source: IAsyncEnumerable_1[ForEachAsync_1_TSource], parallelOptions: ParallelOptions, body: Func_3[ForEachAsync_1_TSource, CancellationToken, ValueTask]) -> Task:...
    ...
    class Invoke_MethodGroup:
        @typing.overload
        def __call__(self, actions: Array_1[Action]) -> None:...
        @typing.overload
        def __call__(self, parallelOptions: ParallelOptions, actions: Array_1[Action]) -> None:...
...
class ParallelLoopResult:
    ...
    @property
    def LowestBreakIteration(self) -> typing.Optional[int]: ...
...
class ParallelOptions:
    ...
    def MaxDegreeOfParallelism(self, value: int) -> int: ...
    @property
...
class Task_1(typing.Generic[Task_1_TResult], Task_0):
    ...
    class ConfigureAwait_MethodGroup(typing.Generic[ConfigureAwait_MethodGroup_Task_1_TResult]):
        ...
        # Method ConfigureAwait(continueOnCapturedContext : Boolean) was skipped since it collides with above method
    ...
    class ContinueWith_MethodGroup(typing.Generic[ContinueWith_MethodGroup_Task_1_TResult]):
        ...
        class ContinueWith_1(typing.Generic[ContinueWith_1_Task_1_TResult, ContinueWith_1_T1]):
            ...
            ContinueWith_1_TResult = Task_1.ContinueWith_MethodGroup.ContinueWith_1_T1
            @typing.overload
    ...
    # Skipped GetAwaiter due to it being static, abstract and generic.

    GetAwaiter : GetAwaiter_MethodGroup[Task_1_TResult]
    GetAwaiter_MethodGroup_Task_1_TResult = typing.TypeVar('GetAwaiter_MethodGroup_Task_1_TResult')
    class GetAwaiter_MethodGroup(typing.Generic[GetAwaiter_MethodGroup_Task_1_TResult]):
        GetAwaiter_MethodGroup_Task_1_TResult = Task_1.GetAwaiter_MethodGroup_Task_1_TResult
        def __call__(self) -> TaskAwaiter_1[GetAwaiter_MethodGroup_Task_1_TResult]:...
        # Method GetAwaiter() was skipped since it collides with above method
    ...
    class WaitAsync_MethodGroup(typing.Generic[WaitAsync_MethodGroup_Task_1_TResult]):
        ...
        # Method WaitAsync(timeout : TimeSpan) was skipped since it collides with above method
        @typing.overload
        def __call__(self, cancellationToken: CancellationToken) -> Task_1[WaitAsync_MethodGroup_Task_1_TResult]:...
        # Method WaitAsync(cancellationToken : CancellationToken) was skipped since it collides with above method
        @typing.overload
        def __call__(self, timeout: TimeSpan, cancellationToken: CancellationToken) -> Task_1[WaitAsync_MethodGroup_Task_1_TResult]:...
        # Method WaitAsync(timeout : TimeSpan, cancellationToken : CancellationToken) was skipped since it collides with above method
