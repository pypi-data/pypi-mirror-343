...
from System import SystemException, Exception, IDisposable, IEquatable_1, Action_1, TimeSpan, Action, Action_2, IAsyncDisposable, Array_1, MulticastDelegate, IAsyncResult, AsyncCallback, Func_1, MarshalByRefObject, LocalDataStoreSlot, AppDomain, UIntPtr, EventArgs, ApplicationException
...
class Barrier(IDisposable):
    ...
    @typing.overload
    def __init__(self, participantCount: int, postPhaseAction: Action_1[Barrier]) -> None: ...
    @property
    def CurrentPhaseNumber(self) -> int: ...
    @CurrentPhaseNumber.setter
    def CurrentPhaseNumber(self, value: int) -> int: ...
    @property
...
class CountdownEvent(IDisposable):
    ...
    def WaitHandle(self) -> WaitHandle: ...
    def Dispose(self) -> None: ...
    # Skipped AddCount due to it being static, abstract and generic.

    AddCount : AddCount_MethodGroup
    class AddCount_MethodGroup:
        @typing.overload
        def __call__(self) -> None:...
        @typing.overload
        def __call__(self, signalCount: int) -> None:...
    ...
    # Skipped Signal due to it being static, abstract and generic.

    Signal : Signal_MethodGroup
    class Signal_MethodGroup:
        @typing.overload
        def __call__(self) -> bool:...
        @typing.overload
        def __call__(self, signalCount: int) -> bool:...

    # Skipped TryAddCount due to it being static, abstract and generic.

    TryAddCount : TryAddCount_MethodGroup
    class TryAddCount_MethodGroup:
        @typing.overload
        def __call__(self) -> bool:...
        @typing.overload
        def __call__(self, signalCount: int) -> bool:...
...
class HostExecutionContext(IDisposable):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class HostExecutionContextManager:
    ...
    def Revert(self, previousState: typing.Any) -> None: ...
    def SetHostExecutionContext(self, hostExecutionContext: HostExecutionContext) -> typing.Any: ...
...
class LockCookie:
    def GetHashCode(self) -> int: ...
    def __eq__(self, a: LockCookie, b: LockCookie) -> bool: ...
    def __ne__(self, a: LockCookie, b: LockCookie) -> bool: ...
    # Skipped Equals due to it being static, abstract and generic.

    Equals : Equals_MethodGroup
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, obj: LockCookie) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
...
class ReaderWriterLock(CriticalFinalizerObject):
    ...
    def DowngradeFromWriterLock(self, lockCookie: clr.Reference[LockCookie]) -> None: ...
    def ReleaseLock(self) -> LockCookie: ...
    def ReleaseReaderLock(self) -> None: ...
    def ReleaseWriterLock(self) -> None: ...
    def RestoreLock(self, lockCookie: clr.Reference[LockCookie]) -> None: ...
    # Skipped AcquireReaderLock due to it being static, abstract and generic.

    AcquireReaderLock : AcquireReaderLock_MethodGroup
    class AcquireReaderLock_MethodGroup:
        @typing.overload
        def __call__(self, millisecondsTimeout: int) -> None:...
        @typing.overload
        def __call__(self, timeout: TimeSpan) -> None:...

    # Skipped AcquireWriterLock due to it being static, abstract and generic.

    AcquireWriterLock : AcquireWriterLock_MethodGroup
    class AcquireWriterLock_MethodGroup:
        @typing.overload
        def __call__(self, millisecondsTimeout: int) -> None:...
        @typing.overload
        def __call__(self, timeout: TimeSpan) -> None:...

    # Skipped UpgradeToWriterLock due to it being static, abstract and generic.

    UpgradeToWriterLock : UpgradeToWriterLock_MethodGroup
    class UpgradeToWriterLock_MethodGroup:
        @typing.overload
        def __call__(self, millisecondsTimeout: int) -> LockCookie:...
        @typing.overload
        def __call__(self, timeout: TimeSpan) -> LockCookie:...
