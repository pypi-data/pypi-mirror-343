...
class DATADIR(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
...
class DVASPECT(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
...
class IAdviseSink(typing.Protocol):
    @abc.abstractmethod
    def OnClose(self) -> None: ...
    @abc.abstractmethod
    def OnDataChange(self, format: clr.Reference[FORMATETC], stgmedium: clr.Reference[STGMEDIUM]) -> None: ...
    @abc.abstractmethod
...
class IDataObject(typing.Protocol):
    @abc.abstractmethod
    def DAdvise(self, pFormatetc: clr.Reference[FORMATETC], advf: ADVF, adviseSink: IAdviseSink, connection: clr.Reference[int]) -> int: ...
    @abc.abstractmethod
    def DUnadvise(self, connection: int) -> None: ...
    @abc.abstractmethod
    def EnumDAdvise(self, enumAdvise: clr.Reference[IEnumSTATDATA]) -> int: ...
    @abc.abstractmethod
    def EnumFormatEtc(self, direction: DATADIR) -> IEnumFORMATETC: ...
    @abc.abstractmethod
    def GetCanonicalFormatEtc(self, formatIn: clr.Reference[FORMATETC], formatOut: clr.Reference[FORMATETC]) -> int: ...
    @abc.abstractmethod
    def GetData(self, format: clr.Reference[FORMATETC], medium: clr.Reference[STGMEDIUM]) -> None: ...
    @abc.abstractmethod
    def GetDataHere(self, format: clr.Reference[FORMATETC], medium: clr.Reference[STGMEDIUM]) -> None: ...
    @abc.abstractmethod
    def QueryGetData(self, format: clr.Reference[FORMATETC]) -> int: ...
    @abc.abstractmethod
    def SetData(self, formatIn: clr.Reference[FORMATETC], medium: clr.Reference[STGMEDIUM], release: bool) -> None: ...
...
class IEnumFORMATETC(typing.Protocol):
    @abc.abstractmethod
    def Clone(self, newEnum: clr.Reference[IEnumFORMATETC]) -> None: ...
    @abc.abstractmethod
    def Next(self, celt: int, rgelt: Array_1[FORMATETC], pceltFetched: Array_1[int]) -> int: ...
    @abc.abstractmethod
    def Reset(self) -> int: ...
    @abc.abstractmethod
    def Skip(self, celt: int) -> int: ...
...
class IEnumSTATDATA(typing.Protocol):
    @abc.abstractmethod
    def Clone(self, newEnum: clr.Reference[IEnumSTATDATA]) -> None: ...
    @abc.abstractmethod
    def Next(self, celt: int, rgelt: Array_1[STATDATA], pceltFetched: Array_1[int]) -> int: ...
    @abc.abstractmethod
    def Reset(self) -> int: ...
    @abc.abstractmethod
    def Skip(self, celt: int) -> int: ...
...
class TYMED(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
