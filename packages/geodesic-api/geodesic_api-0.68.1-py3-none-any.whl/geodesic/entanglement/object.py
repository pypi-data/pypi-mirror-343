...
def get_objects(
    *,
    ...
    Args:
        ...
        project: a Project or project name/alias to get objects for. A query can only be for a
            single project. If you want objects for multiple projects, break up into separate
            queries.  Will be removed in v1.0.0. Use `projects` instead.
    ...
    if projects is None:
        ...
        if project is not None:
            raise ValueError(
                "cannot specify both project and projects. project will be deprecated,"
...
def add_connections(
    ...
    Args:
        connections: list of Connections or dicts of connections to add. Every object must exist
            and have a UID.
        overwrite: (deprecated) Overwrite this edge/connection if it exists. This parameter is
            ignored
