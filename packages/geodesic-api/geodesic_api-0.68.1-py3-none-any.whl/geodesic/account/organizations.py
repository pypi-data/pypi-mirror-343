...
class Organization(_APIObject):
    ...
    @property
    @deprecated("v1.0.0", "Organization.members()")
    def members(self) -> Dict[str, User]:
        """DEPRECATED: Use Organization.members()."""
    ...
    @property
    @deprecated("v1.0.0", "Organization.remaining_seats()")
    def remaining_seats(self):
        """DEPRECATED: Use Organization.remaining_seats()."""
        return self.get_remaining_seats()
