...
from .....types.enterprises.code_security import (
...
from .....types.enterprises.code_security.configuration_list_response import ConfigurationListResponse
...
class ConfigurationsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ConfigurationsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/fluent-api-generator-sdks/github_fluent_api-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ConfigurationsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/fluent-api-generator-sdks/github_fluent_api-python#with_streaming_response
        """
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/enterprises/{enterprise}/code-security/configurations",
    ...
    def update(
        ...
        *,
        ...
        Args:
          advanced_security: The enablement status of GitHub Advanced Security. Must be set to enabled if you
              want to enable any GHAS settings.
          ...
          name: The name of the code security configuration. Must be unique across the
              enterprise.
    ...
    def delete(
        ...
        *,
        ...
        to the configuration will retain their settings but will no longer be associated
    ...
    def attach(
        ...
        *,
        ...
        """Attaches an enterprise code security configuration to repositories.
        ...
        if not enterprise:
            raise ValueError(f"Expected a non-empty value for `enterprise` but received {enterprise!r}")
        return self._post(
            f"/enterprises/{enterprise}/code-security/configurations/{configuration_id}/attach",
            body=maybe_transform({"scope": scope}, configuration_attach_params.ConfigurationAttachParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=object,
        )
...
class AsyncConfigurationsResource(AsyncAPIResource):
    ...
    async def attach(
        ...
        *,
        ...
        return await self._post(
            f"/enterprises/{enterprise}/code-security/configurations/{configuration_id}/attach",
            body=await async_maybe_transform({"scope": scope}, configuration_attach_params.ConfigurationAttachParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=object,
        )
...
class ConfigurationsResourceWithRawResponse:
    ...
    def repositories(self) -> RepositoriesResourceWithRawResponse:
        return RepositoriesResourceWithRawResponse(self._configurations.repositories)
...
class AsyncConfigurationsResourceWithRawResponse:
    ...
    def repositories(self) -> AsyncRepositoriesResourceWithRawResponse:
        return AsyncRepositoriesResourceWithRawResponse(self._configurations.repositories)
...
class ConfigurationsResourceWithStreamingResponse:
    ...
    def repositories(self) -> RepositoriesResourceWithStreamingResponse:
        return RepositoriesResourceWithStreamingResponse(self._configurations.repositories)
...
class AsyncConfigurationsResourceWithStreamingResponse:
    ...
    def repositories(self) -> AsyncRepositoriesResourceWithStreamingResponse:
        return AsyncRepositoriesResourceWithStreamingResponse(self._configurations.repositories)
