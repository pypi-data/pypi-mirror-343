...
from ...types.enterprises import dependabot_list_alerts_params
from ...types.enterprises.dependabot_list_alerts_response import DependabotListAlertsResponse
...
class DependabotResource(SyncAPIResource):
    ...
    def list_alerts(
        ...
        *,
        ...
        Alerts are only returned for organizations in the enterprise for which you are
        an organization owner or a security manager. For more information about security
        managers, see
        ...
        return self._get(
            f"/enterprises/{enterprise}/dependabot/alerts",
