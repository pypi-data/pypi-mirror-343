...
from ....types.repos.codespaces import secret_create_or_update_params, secret_list_params
from ....types.repos.codespaces.repo_codespaces_secret import RepoCodespacesSecret
from ....types.repos.codespaces.secret_list_response import SecretListResponse
...
class SecretsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/repos/{owner}/{repo}/codespaces/secrets/{secret_name}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=RepoCodespacesSecret,
        )
    ...
    def list(
        ...
        *,
        ...
        if not repo:
            raise ValueError(f"Expected a non-empty value for `repo` but received {repo!r}")
        return self._get(
            f"/repos/{owner}/{repo}/codespaces/secrets",
    ...
    def delete(
        ...
        *,
        ...
        OAuth app tokens and personal access tokens (classic) need the `repo` scope to
        use this endpoint. The associated user must be a repository admin.
    ...
    def create_or_update(
        ...
        *,
        ...
        """
        Creates or updates a repository development environment secret with an encrypted
        value. Encrypt your secret using
    ...
    def get_public_key(
        ...
        *,
        ...
        if not repo:
            raise ValueError(f"Expected a non-empty value for `repo` but received {repo!r}")
        return self._get(
            f"/repos/{owner}/{repo}/codespaces/secrets/public-key",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
