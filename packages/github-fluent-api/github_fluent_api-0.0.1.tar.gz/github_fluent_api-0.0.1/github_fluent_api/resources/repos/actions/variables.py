...
from ....types.repos.actions import variable_create_params, variable_list_params, variable_update_params
from ....types.repos.actions.actions_variable import ActionsVariable
from ....types.repos.actions.variable_list_response import VariableListResponse
...
class VariablesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/repos/{owner}/{repo}/actions/variables/{path_name}",
            body=maybe_transform(
                {
                    "body_name": body_name,
                    "value": value,
