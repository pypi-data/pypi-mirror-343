...
from ...types.repos import fork_create_params, fork_list_params
from ...types.repos.fork_list_response import ForkListResponse
...
class ForksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        owner: str,
        default_branch_only: bool | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
        organization: str | NotGiven = NOT_GIVEN,
        ...
        > longer than 5 minutes, be sure to contact
        > [GitHub Support](https://support.github.com/contact?tags=dotcom-rest-api).

        > [!NOTE] Although this endpoint works with GitHub Apps, the GitHub App must be
        ...
        Args:
          ...
          organization: Optional parameter to specify the organization name if forking into an
              organization.
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                fork_create_params.ForkCreateParams,
            ),
    ...
    def list(
        ...
        *,
        ...
        sort: Literal["newest", "oldest", "stargazers", "watchers"] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
