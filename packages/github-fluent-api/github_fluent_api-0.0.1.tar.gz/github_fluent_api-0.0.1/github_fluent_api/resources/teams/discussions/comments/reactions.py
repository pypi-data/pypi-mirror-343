...
from .....types.teams.discussions.comments import reaction_create_params, reaction_list_params
from .....types.teams.discussions.comments.reaction_list_response import ReactionListResponse
...
class ReactionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        > "[Create reaction for a team discussion comment](https://docs.github.com/rest/reactions/reactions#create-reaction-for-a-team-discussion-comment)"
        > endpoint.
    ...
    def list(
        ...
        *,
        ...
        > down and will be removed from the Teams API. We recommend migrating your
        > existing code to use the new
        > [`List reactions for a team discussion comment`](https://docs.github.com/rest/reactions/reactions#list-reactions-for-a-team-discussion-comment)
        > endpoint.
