...
from ....types.applications.hook import delivery_list_params
from ....types.applications.hook.delivery import Delivery
from ....types.applications.hook.delivery_list_response import DeliveryListResponse
...
class DeliveriesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/app/hook/deliveries/{delivery_id}",
