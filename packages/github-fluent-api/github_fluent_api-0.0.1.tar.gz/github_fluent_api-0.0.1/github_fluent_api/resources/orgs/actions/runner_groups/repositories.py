...
from .....types.orgs.actions.runner_groups import repository_list_params, repository_set_params
from .....types.orgs.actions.runner_groups.repository_list_response import RepositoryListResponse
...
class RepositoriesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Lists the repositories with access to a self-hosted runner group configured in
        an organization.
        ...
        return self._get(
            f"/orgs/{org}/actions/runner-groups/{runner_group_id}/repositories",
    ...
    def add(
        ...
        *,
        ...
        """
        Adds a repository to the list of repositories that can access a self-hosted
        runner group. The runner group must have `visibility` set to `selected`. For
