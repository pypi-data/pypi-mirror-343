...
from ....types.orgs.hooks import config_update_params
...
class ConfigResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """Returns the webhook configuration for an organization.
        ...
        return self._get(
            f"/orgs/{org}/hooks/{hook_id}/config",
    ...
    def update(
        ...
        *,
        ...
        """Updates the webhook configuration for an organization.

        To update more
        information about the webhook, including the `active` state and `events`, use
