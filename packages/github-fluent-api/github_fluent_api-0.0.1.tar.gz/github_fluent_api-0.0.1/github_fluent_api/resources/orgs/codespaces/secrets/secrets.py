...
from .....types.orgs.codespaces import secret_create_or_update_params, secret_list_params
from .....types.orgs.codespaces.codespaces_org_secret import CodespacesOrgSecret
from .....types.orgs.codespaces.codespaces_public_key import CodespacesPublicKey
from .....types.orgs.codespaces.secret_list_response import SecretListResponse
...
class SecretsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/orgs/{org}/codespaces/secrets/{secret_name}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=CodespacesOrgSecret,
        )
    ...
    def create_or_update(
        ...
        *,
        ...
        """
        Creates or updates an organization development environment secret with an
    ...
    def get_public_key(
        ...
        *,
        ...
        secrets. You need to encrypt the value of a secret before you can create or
        update secrets. OAuth app tokens and personal access tokens (classic) need the
        ...
        if not org:
            raise ValueError(f"Expected a non-empty value for `org` but received {org!r}")
        return self._get(
            f"/orgs/{org}/codespaces/secrets/public-key",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=CodespacesPublicKey,
        )
