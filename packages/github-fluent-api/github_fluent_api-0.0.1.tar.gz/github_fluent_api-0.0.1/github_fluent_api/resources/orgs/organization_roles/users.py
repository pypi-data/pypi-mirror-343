...
from ....types.orgs.organization_roles import user_list_params
from ....types.orgs.organization_roles.user_list_response import UserListResponse
...
class UsersResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/orgs/{org}/organization-roles/{role_id}/users",
    ...
    def remove_all(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._delete(
            f"/orgs/{org}/organization-roles/users/{username}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=NoneType,
        )
