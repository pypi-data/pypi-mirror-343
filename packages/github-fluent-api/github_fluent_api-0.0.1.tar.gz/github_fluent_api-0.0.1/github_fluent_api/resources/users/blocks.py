...
from ...types.users import block_list_params
from ...types.users.block_list_response import BlockListResponse
...
class BlocksResource(SyncAPIResource):
    ...
    def block(
        ...
        *,
        ...
        """Blocks the given user and returns a 204.

        If the authenticated user cannot block
        the given user a 422 is returned.
    ...
    def check(
        ...
        *,
        ...
        Returns a
        404 if the given user is not blocked by the authenticated user, or if the given
