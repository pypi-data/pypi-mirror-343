...
from .....types.orgs.actions.variables import repository_list_params, repository_set_params
from .....types.orgs.actions.variables.repository_list_response import RepositoryListResponse
...
class RepositoriesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Lists all repositories that can access an organization variable that is
        ...
        return self._get(
            f"/orgs/{org}/actions/variables/{name}/repositories",
    ...
    def add(
        ...
        *,
        ...
        have their `visibility` field set to `selected`.
        ...
        return self._put(
            f"/orgs/{org}/actions/variables/{name}/repositories/{repository_id}",
