...
from .....types.orgs.codespaces.secrets import repository_list_params, repository_set_params
from .....types.orgs.codespaces.secrets.repository_list_response import RepositoryListResponse
...
class RepositoriesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/orgs/{org}/codespaces/secrets/{secret_name}/repositories",
    ...
    def add(
        ...
        *,
        ...
        """
        Adds a repository to an organization development environment secret when the
        `visibility` for repository access is set to `selected`. The visibility is set
        when you
    ...
    def remove(
        ...
        *,
        ...
        the `visibility` for repository access is set to `selected`. The visibility is
        set when you
        [Create or update an organization secret](https://docs.github.com/rest/codespaces/organization-secrets#create-or-update-an-organization-secret).
    ...
    def set(
        ...
        *,
        ...
        when the `visibility` for repository access is set to `selected`. The visibility
        is set when you
        [Create or update an organization secret](https://docs.github.com/rest/codespaces/organization-secrets#create-or-update-an-organization-secret).
