...
from ....types.repos.comments import reaction_create_params, reaction_list_params
from ....types.repos.comments.reaction_list_response import ReactionListResponse
...
class ReactionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/repos/{owner}/{repo}/comments/{comment_id}/reactions",
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=NoneType,
        )
