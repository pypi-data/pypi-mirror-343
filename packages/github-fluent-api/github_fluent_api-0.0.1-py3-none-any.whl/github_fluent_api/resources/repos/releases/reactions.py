...
from ....types.repos.releases import reaction_create_params, reaction_list_params
from ....types.repos.releases.reaction_list_response import ReactionListResponse
...
class ReactionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        response with a `Status: 200 OK` means that you already added the reaction type
        to this release.
        ...
        return self._post(
            f"/repos/{owner}/{repo}/releases/{release_id}/reactions",
    ...
    def list(
        ...
        *,
        owner: str,
        repo: str,
        content: Literal["+1", "laugh", "heart", "hooray", "rocket", "eyes"] | NotGiven = NOT_GIVEN,
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/repos/{owner}/{repo}/releases/{release_id}/reactions/{reaction_id}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=NoneType,
        )
