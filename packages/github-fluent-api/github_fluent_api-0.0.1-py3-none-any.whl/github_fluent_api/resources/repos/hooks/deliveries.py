...
from ....types.repos.hooks import delivery_list_params
from ....types.repos.hooks.delivery_list_response import DeliveryListResponse
...
class DeliveriesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}",
