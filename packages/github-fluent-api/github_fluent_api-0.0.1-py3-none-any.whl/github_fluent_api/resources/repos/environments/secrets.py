...
from ....types.repos.actions.actions_secret import ActionsSecret
from ....types.repos.environments import secret_create_or_update_params, secret_list_params
from ....types.repos.environments.secret_list_response import SecretListResponse
...
class SecretsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/repos/{owner}/{repo}/environments/{environment_name}/secrets/{secret_name}",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=ActionsSecret,
        )
    ...
    def list(
        ...
        *,
        ...
        if not environment_name:
            raise ValueError(f"Expected a non-empty value for `environment_name` but received {environment_name!r}")
        return self._get(
            f"/repos/{owner}/{repo}/environments/{environment_name}/secrets",
