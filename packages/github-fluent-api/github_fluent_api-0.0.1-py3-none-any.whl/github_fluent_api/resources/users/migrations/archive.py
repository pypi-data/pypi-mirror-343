...
class ArchiveResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        Downloadable migration archives are
        automatically deleted after seven days. Migration metadata, which is returned in
        the
        [List user migrations](https://docs.github.com/rest/migrations/users#list-user-migrations)
        and
        [Get a user migration status](https://docs.github.com/rest/migrations/users#get-a-user-migration-status)
        ...
        return self._delete(
            f"/user/migrations/{migration_id}/archive",
    ...
    def download(
        ...
        *,
        ...
        Depending
        on the resources your repository uses, the migration archive can contain JSON
        files with data for these objects:
        ...
        The archive will also contain an `attachments` directory that includes all
