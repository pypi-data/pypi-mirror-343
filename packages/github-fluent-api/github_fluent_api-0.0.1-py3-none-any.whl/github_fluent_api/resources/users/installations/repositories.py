...
from ....types.users.installations import repository_list_params
from ....types.users.installations.repository_list_response import RepositoryListResponse
...
class RepositoriesResource(SyncAPIResource):
    ...
    def remove(
        ...
        *,
        ...
        have admin access to the repository. The installation must have the
