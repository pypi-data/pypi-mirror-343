...
class BillingResource(SyncAPIResource):
    ...
    def get_actions_billing(
        ...
        *,
        ...
        return self._get(
            f"/users/{username}/settings/billing/actions",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=ActionsBillingUsage,
        )

    def get_packages_billing(
        self,
        username: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        ...
        if not username:
            raise ValueError(f"Expected a non-empty value for `username` but received {username!r}")
        return self._get(
            f"/users/{username}/settings/billing/packages",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=PackagesBillingUsage,
        )

    def get_shared_storage_billing(
        self,
        username: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        ...
        if not username:
            raise ValueError(f"Expected a non-empty value for `username` but received {username!r}")
        return self._get(
            f"/users/{username}/settings/billing/shared-storage",
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
...
class AsyncBillingResource(AsyncAPIResource):
    ...
    async def get_packages_billing(
        self,
        username: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    ...
    async def get_shared_storage_billing(
        self,
        username: str,
        *,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
...
class BillingResourceWithRawResponse:
    def __init__(self, billing: BillingResource) -> None:
        ...
        self.get_actions_billing = to_raw_response_wrapper(
            billing.get_actions_billing,
        )
        self.get_packages_billing = to_raw_response_wrapper(
            billing.get_packages_billing,
        )
        self.get_shared_storage_billing = to_raw_response_wrapper(
            billing.get_shared_storage_billing,
        )
...
class AsyncBillingResourceWithRawResponse:
    def __init__(self, billing: AsyncBillingResource) -> None:
        ...
        self.get_actions_billing = async_to_raw_response_wrapper(
            billing.get_actions_billing,
        )
        self.get_packages_billing = async_to_raw_response_wrapper(
            billing.get_packages_billing,
        )
        self.get_shared_storage_billing = async_to_raw_response_wrapper(
            billing.get_shared_storage_billing,
        )
...
class BillingResourceWithStreamingResponse:
    def __init__(self, billing: BillingResource) -> None:
        ...
        self.get_actions_billing = to_streamed_response_wrapper(
            billing.get_actions_billing,
        )
        self.get_packages_billing = to_streamed_response_wrapper(
            billing.get_packages_billing,
        )
        self.get_shared_storage_billing = to_streamed_response_wrapper(
            billing.get_shared_storage_billing,
        )
...
class AsyncBillingResourceWithStreamingResponse:
    def __init__(self, billing: AsyncBillingResource) -> None:
        ...
        self.get_actions_billing = async_to_streamed_response_wrapper(
            billing.get_actions_billing,
        )
        self.get_packages_billing = async_to_streamed_response_wrapper(
            billing.get_packages_billing,
        )
        self.get_shared_storage_billing = async_to_streamed_response_wrapper(
            billing.get_shared_storage_billing,
        )
