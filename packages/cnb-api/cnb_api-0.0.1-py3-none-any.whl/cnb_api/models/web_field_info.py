...
class WebFieldInfo(BaseModel):
    """
    WebFieldInfo
    """ # noqa: E501
    priority: Optional[WebFieldInfoPriority] = None
    status: Optional[WebFieldInfoStatus] = None
    __properties: ClassVar[List[str]] = ["priority", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "priority": WebFieldInfoPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "status": WebFieldInfoStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
