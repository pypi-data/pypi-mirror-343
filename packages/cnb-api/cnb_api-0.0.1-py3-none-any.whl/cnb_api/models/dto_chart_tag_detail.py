...
class DtoChartTagDetail(BaseModel):
    """
    DtoChartTagDetail
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["address", "is_deprecated", "last_pusher", "metadata", "package", "pull_count", "recent_pull_count", "size", "slug", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ChartMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
