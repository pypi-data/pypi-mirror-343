...
class DtoUsersWithAccessLevelInSlug(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access_level", "avatar", "created_at", "email", "email_verification", "freeze", "id", "inviter", "join_time", "nickname", "type", "username", "verified", "verified_expire_in"]
