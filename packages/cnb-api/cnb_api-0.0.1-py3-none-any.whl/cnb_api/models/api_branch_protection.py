...
class ApiBranchProtection(BaseModel):
    """
    ApiBranchProtection
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["allow_creation", "allow_deletions", "allow_force_pushes", "allow_master_creation", "allow_master_deletions", "allow_master_force_pushes", "allow_master_pushes", "allow_pushes", "id", "required_approved_review_count", "required_approved_review_ratio", "required_commit_signatures", "required_linear_history", "required_master_approve", "required_must_auto_merge", "required_must_push_via_pull_request", "required_pull_request_reviews", "required_status_checks", "rule"]
