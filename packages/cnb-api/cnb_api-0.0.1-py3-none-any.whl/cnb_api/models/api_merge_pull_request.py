...
class ApiMergePullRequest(BaseModel):
    """
    ApiMergePullRequest
    """ # noqa: E501
    commit_message: Optional[StrictStr] = None
    commit_title: Optional[StrictStr] = None
    merge_style: Optional[StrictStr] = Field(default=None, description="The merge method to use. Can be one of: `merge`, `squash`, `rebase`")
    __properties: ClassVar[List[str]] = ["commit_message", "commit_title", "merge_style"]
