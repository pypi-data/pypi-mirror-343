...
class DtoOhpmTagDetail(BaseModel):
    """
    DtoOhpmTagDetail
    """ # noqa: E501
    ...
    tags: Optional[List[DtoOhpmTag]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "tags": [DtoOhpmTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
