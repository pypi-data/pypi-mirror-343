...
class WebLastPushBranch(BaseModel):
    """
    WebLastPushBranch
    """ # noqa: E501
    date_time: Optional[StrictStr] = None
    is_head: Optional[StrictBool] = None
    pull_number: Optional[StrictInt] = None
    ref: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date_time", "is_head", "pull_number", "ref"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pull_number": obj.get("pull_number"),
            "ref": obj.get("ref")
        })
        return _obj
