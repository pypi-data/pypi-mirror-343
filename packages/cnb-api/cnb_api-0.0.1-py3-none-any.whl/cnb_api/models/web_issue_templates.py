...
class WebIssueTemplates(BaseModel):
    """
    WebIssueTemplates
    """ # noqa: E501
    templates: Optional[List[WebIssueTemplate]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [WebIssueTemplate.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
