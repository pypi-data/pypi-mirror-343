...
class ApiTag(BaseModel):
    ...
    ApiTag
    """ # noqa: E501
    commit: Optional[ApiCommit] = None
    name: Optional[StrictStr] = None
    target: Optional[StrictStr] = None
    target_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["commit", "name", "target", "target_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commit": ApiCommit.from_dict(obj["commit"]) if obj.get("commit") is not None else None,
            "name": obj.get("name"),
