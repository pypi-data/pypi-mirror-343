...
class DtoMemberAccessLevelInSlugUnion(BaseModel):
    """
    DtoMemberAccessLevelInSlugUnion
    """ # noqa: E501
    access_level: Optional[ConstantAccessRole] = None
    inherit: Optional[StrictBool] = None
    read_privilege: Optional[StrictBool] = None
    write_privilege: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["access_level", "inherit", "read_privilege", "write_privilege"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "read_privilege": obj.get("read_privilege"),
            "write_privilege": obj.get("write_privilege")
        })
        return _obj
