...
class DtoSlugs(BaseModel):
    ...
    root_freeze: Optional[StrictBool] = None
    root_id: Optional[StrictInt] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "freeze", "path", "resource_id", "resource_type", "root_freeze", "root_id", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "root_freeze": obj.get("root_freeze"),
