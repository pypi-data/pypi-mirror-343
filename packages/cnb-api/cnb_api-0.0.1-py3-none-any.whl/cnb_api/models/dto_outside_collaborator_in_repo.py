...
class DtoOutsideCollaboratorInRepo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access_level", "avatar", "created_at", "email", "freeze", "id", "join_time", "nickname", "type", "username", "verified", "verified_expire_in"]
