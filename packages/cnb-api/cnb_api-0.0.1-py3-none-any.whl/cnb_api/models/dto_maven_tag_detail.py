...
class DtoMavenTagDetail(BaseModel):
    """
    DtoMavenTagDetail
    """ # noqa: E501
    ...
    tags: Optional[List[DtoMavenTag]] = None
    __properties: ClassVar[List[str]] = ["address", "desc", "files", "last_pusher", "package", "pull_count", "recent_pull_count", "size", "slug", "status", "tag", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "tags": [DtoMavenTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
