...
class WebapiPostReleaseForm(BaseModel):
    """
    ...
    make_latest: Optional[StrictStr] = None
    tag_name: Optional[StrictStr] = None
    target_commitish: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["body", "is_draft", "is_prerelease", "make_latest", "tag_name", "target_commitish", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "make_latest": obj.get("make_latest"),
