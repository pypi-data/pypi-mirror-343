...
class WebIssue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assignees", "author", "comment_count", "created_at", "ended_at", "labels", "last_acted_at", "number", "priority", "started_at", "state", "state_reason", "title", "updated_at"]
