...
class DtoBoolResponseWithDataMapConstantSlugTypeInt64(BaseModel):
    """
    DtoBoolResponseWithDataMapConstantSlugTypeInt64
    """ # noqa: E501
    data: Optional[Dict[str, StrictInt]] = None
    message: Optional[StrictStr] = None
    result: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["data", "message", "result"]
