...
class ApiCommitObject(BaseModel):
    """
    ApiCommitObject
    """ # noqa: E501
    author: Optional[ApiSignature] = None
    comment_count: Optional[StrictInt] = None
    committer: Optional[ApiSignature] = None
    message: Optional[StrictStr] = None
    tree: Optional[ApiCommitObjectTree] = None
    verification: Optional[ApiCommitObjectVerification] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": ApiSignature.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "comment_count": obj.get("comment_count"),
            "committer": ApiSignature.from_dict(obj["committer"]) if obj.get("committer") is not None else None,
            "message": obj.get("message"),
            "tree": ApiCommitObjectTree.from_dict(obj["tree"]) if obj.get("tree") is not None else None,
            "verification": ApiCommitObjectVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None
        })
        return _obj
