...
class WebGetCommitAnnotationsInBatchForm(BaseModel):
    """
    WebGetCommitAnnotationsInBatchForm
    """ # noqa: E501
    commit_hashes: Optional[List[StrictStr]] = None
    keys: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["commit_hashes", "keys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commit_hashes": obj.get("commit_hashes"),
            "keys": obj.get("keys")
        })
        return _obj
