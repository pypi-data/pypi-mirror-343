...
class OpenapiPutTagAnnotationsForm(BaseModel):
    """
    OpenapiPutTagAnnotationsForm
    """ # noqa: E501
    annotations: Optional[List[OpenapiPutTagAnnotation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotations": [OpenapiPutTagAnnotation.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None
        })
        return _obj
