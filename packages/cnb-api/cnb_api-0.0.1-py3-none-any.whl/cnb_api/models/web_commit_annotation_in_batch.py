...
class WebCommitAnnotationInBatch(BaseModel):
    """
    WebCommitAnnotationInBatch
    """ # noqa: E501
    annotations: Optional[List[WebCommitAnnotation]] = None
    commit_hash: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["annotations", "commit_hash"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotations": [WebCommitAnnotation.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None,
