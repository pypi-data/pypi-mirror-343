...
class DtoInheritMembersUser(BaseModel):
    """
    ...
    self_member: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["access_level", "avatar", "created_at", "email", "email_verification", "freeze", "id", "inviter", "join_time", "nickname", "self_member", "type", "username", "verified", "verified_expire_in"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "self_member": obj.get("self_member"),
            "type": obj.get("type"),
