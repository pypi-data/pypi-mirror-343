...
class DtoCNBRegistry(BaseModel):
    """
    DtoCNBRegistry
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["artifact_policy", "created_at", "description", "freeze", "id", "kind", "last_push_time", "last_push_user", "name", "overwrite_policy", "pkg_count", "updated_at", "used_size", "visibility_level"]
