...
class WebTagObject(BaseModel):
    """
    WebTagObject
    """ # noqa: E501
    message: Optional[StrictStr] = None
    tag: Optional[StrictStr] = None
    tagger: Optional[WebSignature] = None
    __properties: ClassVar[List[str]] = ["message", "tag", "tagger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "tagger": WebSignature.from_dict(obj["tagger"]) if obj.get("tagger") is not None else None
        })
        return _obj
