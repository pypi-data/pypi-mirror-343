...
class WebPullRequestBranchProtection(BaseModel):
    """
    ...
    dismiss_stale_review: Optional[StrictBool] = None
    ...
    required_conversation_resolution: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["allow_deletions", "allow_force_pushes", "allow_master_deletions", "allow_master_force_pushes", "dismiss_stale_review", "required_approved_review_count", "required_approved_review_ratio", "required_commit_signatures", "required_conversation_resolution", "required_linear_history", "required_master_approve", "required_must_auto_merge", "required_must_push_via_pull_request", "required_pull_request_reviews", "required_status_checks", "rule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dismiss_stale_review": obj.get("dismiss_stale_review"),
