...
class DtoCreateInvitationResponse(BaseModel):
    """
    DtoCreateInvitationResponse
    """ # noqa: E501
    link_token: Optional[StrictStr] = None
    resource_name: Optional[StrictStr] = None
    resource_type: Optional[ConstantSlugType] = None
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["link_token", "resource_name", "resource_type", "username"]
