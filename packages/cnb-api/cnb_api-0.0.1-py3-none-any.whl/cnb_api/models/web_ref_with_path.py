...
class WebRefWithPath(BaseModel):
    """
    WebRefWithPath
    """ # noqa: E501
    ...
    ref_simple_name: Optional[StrictStr] = None
    ref_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["initialized", "path", "ref", "ref_simple_name", "ref_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "ref": obj.get("ref"),
            "ref_simple_name": obj.get("ref_simple_name"),
