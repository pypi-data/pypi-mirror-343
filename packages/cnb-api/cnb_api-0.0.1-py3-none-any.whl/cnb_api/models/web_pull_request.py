...
class WebPullRequest(BaseModel):
    ...
    WebPullRequest
    """ # noqa: E501
    assignees: Optional[List[GitWoaComCnbMonorepoGitInternalDtoWebUserInfo]] = None
    ...
    reviewers: Optional[List[GitWoaComCnbMonorepoGitInternalDtoWebUserInfo]] = None
    state: Optional[StrictStr] = None
    status_check_commit_sha: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["assignees", "author", "base_repo_ref", "blocked_on", "comment_count", "commit_count", "commit_statuses", "created_at", "file_count", "head_deleted", "head_repo_ref", "head_repo_slug", "is_merged", "is_ready_for_merge", "labels", "last_acted_at", "merge_style", "mergeable_state", "number", "review_comment_count", "review_count", "reviewers", "state", "status_check_commit_sha", "title", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignees": [GitWoaComCnbMonorepoGitInternalDtoWebUserInfo.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None,
            ...
            "reviewers": [GitWoaComCnbMonorepoGitInternalDtoWebUserInfo.from_dict(_item) for _item in obj["reviewers"]] if obj.get("reviewers") is not None else None,
            "state": obj.get("state"),
