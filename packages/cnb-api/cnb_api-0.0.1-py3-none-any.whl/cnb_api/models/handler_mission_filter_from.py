...
class HandlerMissionFilterFrom(BaseModel):
    """
    HandlerMissionFilterFrom
    """ # noqa: E501
    selectors: Optional[List[HandlerMissionFilter]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selectors": [HandlerMissionFilter.from_dict(_item) for _item in obj["selectors"]] if obj.get("selectors") is not None else None
        })
        return _obj
