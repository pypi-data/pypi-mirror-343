...
class DtoContainerImage(BaseModel):
    """
    DtoContainerImage
    """ # noqa: E501
    arch: Optional[StrictStr] = None
    digest: Optional[StrictStr] = None
    layers: Optional[List[DtoContainerImageLayer]] = None
    os: Optional[StrictStr] = None
    size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["arch", "digest", "layers", "os", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "layers": [DtoContainerImageLayer.from_dict(_item) for _item in obj["layers"]] if obj.get("layers") is not None else None,
            "os": obj.get("os"),
            "size": obj.get("size")
        })
        return _obj
