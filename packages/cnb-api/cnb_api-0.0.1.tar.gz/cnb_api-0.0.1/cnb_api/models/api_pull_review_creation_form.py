...
class ApiPullReviewCreationForm(BaseModel):
    """
    ApiPullReviewCreationForm
    """ # noqa: E501
    body: Optional[StrictStr] = None
    comments: Optional[List[ApiPullReviewCommentCreationForm]] = None
    event: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["body", "comments", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": obj.get("body"),
            "comments": [ApiPullReviewCommentCreationForm.from_dict(_item) for _item in obj["comments"]] if obj.get("comments") is not None else None,
            "event": obj.get("event")
        })
        return _obj
