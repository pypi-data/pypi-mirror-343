...
class WebapiPostPullRequestReviewCommentForm(BaseModel):
    """
    ...
    subject_type: Optional[StrictStr] = Field(default=None, description="can be one of: line, file")
    __properties: ClassVar[List[str]] = ["body", "end_line", "end_side", "path", "start_line", "start_side", "subject_type"]
