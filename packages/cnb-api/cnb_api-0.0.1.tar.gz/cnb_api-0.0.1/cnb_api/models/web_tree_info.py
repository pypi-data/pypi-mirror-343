...
class WebTreeInfo(BaseModel):
    """
    WebTreeInfo
    """ # noqa: E501
    entries: Optional[List[WebTreeInfoEntry]] = None
    path: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["entries", "path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [WebTreeInfoEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "path": obj.get("path")
        })
        return _obj
