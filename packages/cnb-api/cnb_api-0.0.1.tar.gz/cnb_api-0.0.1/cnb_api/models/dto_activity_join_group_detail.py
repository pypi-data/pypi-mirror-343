...
class DtoActivityJoinGroupDetail(BaseModel):
    """
    DtoActivityJoinGroupDetail
    """ # noqa: E501
    create_at: Optional[StrictStr] = None
    detail: Optional[DtoOrganizationUnion] = Field(default=None, description="组织详情，组织被删后为 null")
    remark: Optional[StrictStr] = Field(default=None, description="组织别名，组织被删除后才有值")
    __properties: ClassVar[List[str]] = ["create_at", "detail", "remark"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detail": DtoOrganizationUnion.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
