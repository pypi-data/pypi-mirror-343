...
class WebEntry(BaseModel):
    ...
    WebEntry
    """ # noqa: E501
    entries: Optional[List[WebSubEntry]] = None
    name: Optional[StrictStr] = None
    path: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["entries", "name", "path", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [WebSubEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "name": obj.get("name"),
            "path": obj.get("path"),
            "type": obj.get("type")
        })
