...
class DtoChartPackageDetail(BaseModel):
    """
    ...
    tags: Optional[List[DtoChartTag]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": [DtoChartTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
