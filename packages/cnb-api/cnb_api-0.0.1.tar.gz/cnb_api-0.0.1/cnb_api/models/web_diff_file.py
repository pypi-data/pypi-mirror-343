...
class WebDiffFile(BaseModel):
    """
    WebDiffFile
    """ # noqa: E501
    change_type: Optional[StrictStr] = None
    deletions: Optional[StrictInt] = None
    file_index: Optional[StrictInt] = None
    insertions: Optional[StrictInt] = None
    is_bin: Optional[StrictBool] = None
    old_path: Optional[StrictStr] = None
    path: Optional[StrictStr] = None
    sections: Optional[List[WebDiffSection]] = None
    __properties: ClassVar[List[str]] = ["change_type", "deletions", "file_index", "insertions", "is_bin", "old_path", "path", "sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_bin": obj.get("is_bin"),
            "old_path": obj.get("old_path"),
            "path": obj.get("path"),
            "sections": [WebDiffSection.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
