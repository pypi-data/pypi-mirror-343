...
class ApiCommitObjectVerification(BaseModel):
    """
    ApiCommitObjectVerification
    """ # noqa: E501
    payload: Optional[StrictStr] = None
    resone: Optional[StrictStr] = None
    signature: Optional[StrictStr] = None
    verified: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["payload", "resone", "signature", "verified"]
