...
class ApiReleaseAsset(BaseModel):
    """
    ApiReleaseAsset
    """ # noqa: E501
    ...
    uploader: Optional[GitWoaComCnbMonorepoGitInternalAppGitServiceBffApiUserInfo] = None
    __properties: ClassVar[List[str]] = ["content_type", "created_at", "id", "name", "path", "size", "updated_at", "uploader"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploader": GitWoaComCnbMonorepoGitInternalAppGitServiceBffApiUserInfo.from_dict(obj["uploader"]) if obj.get("uploader") is not None else None
        })
        return _obj
