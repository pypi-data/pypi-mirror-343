...
class WebapiCreatePullRequestForm(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assignees", "base_branch", "body", "head_branch", "head_repo_slug", "labels", "reviewers", "title"]
