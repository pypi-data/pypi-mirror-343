...
class OpenapiPutCommitAnnotationsForm(BaseModel):
    """
    OpenapiPutCommitAnnotationsForm
    """ # noqa: E501
    annotations: Optional[List[OpenapiPutCommitAnnotation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annotations": [OpenapiPutCommitAnnotation.from_dict(_item) for _item in obj["annotations"]] if obj.get("annotations") is not None else None
        })
        return _obj
