...
class DtoBuildResult(BaseModel):
    """
    DtoBuildResult
    """ # noqa: E501
    build_log_url: Optional[StrictStr] = Field(default=None, description="构建链接", alias="buildLogUrl")
    ...
    __properties: ClassVar[List[str]] = ["buildLogUrl", "message", "sn"]
