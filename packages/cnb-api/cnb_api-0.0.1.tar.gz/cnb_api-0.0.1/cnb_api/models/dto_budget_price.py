...
class DtoBudgetPrice(BaseModel):
    """
    DtoBudgetPrice
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["charge_type_ci_price", "charge_type_dev_price", "charge_type_git_price", "charge_type_object_price"]
