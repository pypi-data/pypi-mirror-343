...
class WebDiffSection(BaseModel):
    """
    WebDiffSection
    """ # noqa: E501
    lines: Optional[List[WebDiffLine]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lines": [WebDiffLine.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None
        })
        return _obj
