...
class WebPullRequestReviewer(BaseModel):
    """
    WebPullRequestReviewer
    """ # noqa: E501
    review_state: Optional[StrictStr] = None
    user: Optional[GitWoaComCnbMonorepoGitInternalDtoWebUserInfo] = None
    __properties: ClassVar[List[str]] = ["review_state", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": GitWoaComCnbMonorepoGitInternalDtoWebUserInfo.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
