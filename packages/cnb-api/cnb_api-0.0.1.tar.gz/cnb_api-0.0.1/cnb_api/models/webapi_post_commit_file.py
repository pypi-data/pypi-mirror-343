...
class WebapiPostCommitFile(BaseModel):
    """
    ...
    is_executable: Optional[StrictBool] = None
    path: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["content", "encoding", "is_deleted", "is_executable", "path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_executable": obj.get("is_executable"),
            "path": obj.get("path")
        })
        return _obj
