...
class DtoPullRequestData(BaseModel):
    """
    DtoPullRequestData
    """ # noqa: E501
    associated_issue_counts: Optional[StrictInt] = None
    ...
    src_ref: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    target_ref: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    todo_id: Optional[StrictStr] = None
    updated_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["associated_issue_counts", "build_status", "comment_counts", "created_time", "label", "mergeable_state", "number", "pinned", "slug", "slug_freeze", "src_ref", "state", "target_ref", "title", "todo_id", "updated_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associated_issue_counts": obj.get("associated_issue_counts"),
