...
class DtoUsersResultForSelf(BaseModel):
    """
    ...
    editable: Optional[ConstantUserEditable] = None
    ...
    next_updated_name_at: Optional[StrictStr] = None
    ...
    updated_name_at: Optional[StrictStr] = None
    updated_nick_at: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["address", "appreciate_status", "avatar", "bio", "company", "created_at", "editable", "email", "follow_count", "follow_mission_count", "follow_repo_count", "follower_count", "freeze", "gender", "group_count", "id", "language", "last_login_at", "last_login_ip", "location", "mission_count", "next_updated_name_at", "nickname", "registry_count", "repo_count", "reward_amount", "reward_count", "site", "stars_count", "type", "updated_name_at", "updated_nick_at", "username", "verified", "verified_expire_in", "wechat_mp", "wechat_mp_qrcode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "next_updated_name_at": obj.get("next_updated_name_at"),
            ...
            "type": obj.get("type"),
            "updated_name_at": obj.get("updated_name_at"),
            "updated_nick_at": obj.get("updated_nick_at"),
