...
class DtoActivityRepoDetail(BaseModel):
    """
    DtoActivityRepoDetail
    """ # noqa: E501
    detail: Optional[DtoActivitySlugDetail] = Field(default=None, description="公仓转私仓或仓库被删除后为 null")
    ...
    __properties: ClassVar[List[str]] = ["detail", "exposed_repo_path", "freeze", "repo_unaccessible", "time", "visibility_level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "detail": DtoActivitySlugDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
