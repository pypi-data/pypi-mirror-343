...
class WebReleaseTag(BaseModel):
    """
    WebReleaseTag
    """ # noqa: E501
    release: Optional[WebRelease] = None
    tag: Optional[WebTag] = None
    __properties: ClassVar[List[str]] = ["release", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "release": WebRelease.from_dict(obj["release"]) if obj.get("release") is not None else None,
            "tag": WebTag.from_dict(obj["tag"]) if obj.get("tag") is not None else None
        })
        return _obj
