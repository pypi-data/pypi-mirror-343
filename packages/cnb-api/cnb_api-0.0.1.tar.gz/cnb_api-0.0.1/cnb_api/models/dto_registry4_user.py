...
class DtoRegistry4User(BaseModel):
    """
    DtoRegistry4User
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["access", "artifact_policy", "created_at", "description", "freeze", "id", "kind", "last_push_time", "last_push_user", "name", "overwrite_policy", "path", "pkg_count", "star_time", "stared", "updated_at", "used_size", "visibility_level"]
