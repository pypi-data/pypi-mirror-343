...
class ScopeGroupItem(BaseModel):
    """
    ScopeGroupItem
    """ # noqa: E501
    codes: Optional[List[ScopeRawItem]] = None
    group: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["codes", "group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "codes": [ScopeRawItem.from_dict(_item) for _item in obj["codes"]] if obj.get("codes") is not None else None,
            "group": obj.get("group")
        })
        return _obj
