...
class TestWebComparedFiles(unittest.TestCase):
    """WebComparedFiles unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebComparedFiles:
        """Test WebComparedFiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebComparedFiles`
        """
        model = WebComparedFiles()
        if include_optional:
            return WebComparedFiles(
                base_commit = '',
