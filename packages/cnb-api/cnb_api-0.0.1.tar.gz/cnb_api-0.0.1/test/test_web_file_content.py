...
class TestWebFileContent(unittest.TestCase):
    """WebFileContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebFileContent:
        """Test WebFileContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebFileContent`
        """
        model = WebFileContent()
        if include_optional:
