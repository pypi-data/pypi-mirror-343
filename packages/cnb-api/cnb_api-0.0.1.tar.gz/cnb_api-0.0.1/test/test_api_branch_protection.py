...
class TestApiBranchProtection(unittest.TestCase):
    """ApiBranchProtection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiBranchProtection:
        """Test ApiBranchProtection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiBranchProtection`
        """
        model = ApiBranchProtection()
        if include_optional:
    ...
    def testApiBranchProtection(self):
        """Test ApiBranchProtection"""
