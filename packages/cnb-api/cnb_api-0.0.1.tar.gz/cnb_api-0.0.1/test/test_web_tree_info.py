...
class TestWebTreeInfo(unittest.TestCase):
    """WebTreeInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebTreeInfo:
        """Test WebTreeInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebTreeInfo`
        """
        model = WebTreeInfo()
        if include_optional:
            return WebTreeInfo(
                entries = [
                    cnb_api.models.web/tree_info_entry.web.TreeInfoEntry(
