...
class TestWebTagList(unittest.TestCase):
    """WebTagList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebTagList:
        """Test WebTagList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebTagList`
        """
        model = WebTagList()
        if include_optional:
            return WebTagList(
                ...
                tag_count = 56,
                tags = [
                    cnb_api.models.web/tag.web.Tag(
