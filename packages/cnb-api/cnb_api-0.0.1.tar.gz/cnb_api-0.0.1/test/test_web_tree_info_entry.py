...
class TestWebTreeInfoEntry(unittest.TestCase):
    """WebTreeInfoEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebTreeInfoEntry:
        """Test WebTreeInfoEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebTreeInfoEntry`
        """
        model = WebTreeInfoEntry()
        if include_optional:
            return WebTreeInfoEntry(
