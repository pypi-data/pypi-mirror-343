...
class TestWebBranchListItem(unittest.TestCase):
    """WebBranchListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebBranchListItem:
        """Test WebBranchListItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBranchListItem`
        """
        model = WebBranchListItem()
        if include_optional:
            return WebBranchListItem(
                ahead = 56,
    ...
    def testWebBranchListItem(self):
        """Test WebBranchListItem"""
