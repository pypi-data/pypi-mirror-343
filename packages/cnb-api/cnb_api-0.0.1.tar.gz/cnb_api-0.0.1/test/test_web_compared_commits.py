...
class TestWebComparedCommits(unittest.TestCase):
    """WebComparedCommits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebComparedCommits:
        """Test WebComparedCommits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebComparedCommits`
        """
        model = WebComparedCommits()
        if include_optional:
            return WebComparedCommits(
                base_commit = '',
                commit_count = 56,
                commits = [
                    cnb_api.models.web/commit.web.Commit(
    ...
    def testWebComparedCommits(self):
        """Test WebComparedCommits"""
