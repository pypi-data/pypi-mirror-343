...
class TestWebBranch(unittest.TestCase):
    """WebBranch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebBranch:
        """Test WebBranch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBranch`
        """
        model = WebBranch()
        if include_optional:
            return WebBranch(
