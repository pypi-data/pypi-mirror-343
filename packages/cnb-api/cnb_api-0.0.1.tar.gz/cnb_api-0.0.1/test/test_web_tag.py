...
class TestWebTag(unittest.TestCase):
    """WebTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebTag:
        """Test WebTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebTag`
        """
        model = WebTag()
        if include_optional:
            return WebTag(
                ...
                tag_object = cnb_api.models.web/tag_object.web.TagObject(
                    ...
                    tagger = cnb_api.models.web/signature.web.Signature(
                        ...
                        email = '', 
                        name = '', ), ),
                tagger = cnb_api.models.git_woa_com_cnb_monorepo_git_internal_app_git_service_bff_web/user_info.git_woa_com_cnb_monorepo_git_internal_app_git_service_bff_web.UserInfo(
                    freeze = True, 
                    nickname = '', 
                    username = '', )
            )
