...
class TestWebBlames(unittest.TestCase):
    """WebBlames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebBlames:
        """Test WebBlames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebBlames`
        """
        model = WebBlames()
        if include_optional:
            return WebBlames(
                ...
                file_size_limit = 56,
                ranges = [
                    cnb_api.models.web/blame_range.web.BlameRange(
                        age = 56, 
