...
To provide this functionality, `typer-repyt` provides a cache manager and the `cache` subcommand to manage your app's
cache.


## Overview

The `typer-repyt` package provides the functionality to store, retrieve, and clear three types of data:
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:110:100"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:130:130"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:138:138"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:141:141"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:144:144"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:150:150"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:153:153"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:158:158"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:167:167"
```
...
```python {linenums="1"}
--8<-- "src/typer_repyt/cache/manager.py:171:171"
```
