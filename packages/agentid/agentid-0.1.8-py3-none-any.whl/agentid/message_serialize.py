...
class InviteMessageReq:
    ...
    def serialize(self, buf: io.BytesIO) -> None:
        ...
        #序列化MessageServer
        message_server_bytes = message_server.encode('utf-8')  
...
if __name__ == "__main__":
    ...
    print("HeartbeatReq:", vars(deser_req.header), deser_req.AgentId, deser_req.SignCookie)
    ...
    print("HeartbeatResp:", vars(deser_resp.header), deser_resp.NextBeat)
    ...
    print("InviteReq:", vars(deser_invite_req.header), deser_invite_req.InviterAgentId, 
          deser_invite_req.InviteCode, deser_invite_req.InviteCodeExpire, deser_invite_req.SessionId)
    ...
    print("InviteResp:", vars(deser_invite_resp.header), deser_invite_resp.AgentId, deser_invite_resp.SignCookie)