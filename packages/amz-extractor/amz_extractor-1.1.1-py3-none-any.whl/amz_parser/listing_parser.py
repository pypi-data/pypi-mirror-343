...
class ListingParser:
    ...
    def get_price(self):
        css_list = [
            'div.offersConsistencyEnabled > #apex_desktop_newAccordionRow:nth-child(1) .priceToPay .a-offscreen',
            'div.offersConsistencyEnabled > #apex_desktop_newAccordionRow .priceToPay .a-offscreen',
