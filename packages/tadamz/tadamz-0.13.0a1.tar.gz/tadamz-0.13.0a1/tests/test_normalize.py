...
@pytest.fixture
def t_is():
    columns = ["pid", "std_id", "normalize_by_std_id", "area_chromatogram", "filename"]
...
def test__normalize_0(t0):
    normalize._normalize(
        t0, peak_group_col="pid", sample_wise=False, value_col="area_chromatogram"
    )
...
def test__normalize_1(t0, t1):
    ...
    normalize._normalize(t0, peak_group_col="pid", value_col="area_chromatogram")
    normalize._normalize(t1, peak_group_col="pid", value_col="area_chromatogram")
    normalize._normalize(t, peak_group_col="pid", value_col="area_chromatogram")
    res = Table.stack_tables([t0, t1])
    comp = t.join(res, (t.pid == res.pid) & (t.filename == res.filename))
    print(comp.col_names)
    comp = comp.filter(comp.normalized_area_chromatogram.is_not_none())

    colnames = [
        "pid_area_chromatogram",
...
def test_normalize_2(t2):
    normalize._normalize(t2, peak_group_col="pid", value_col="area_chromatogram")
...
def test_normalize_3(t3):
    normalize._normalize(t3, peak_group_col="pid", value_col="area_chromatogram")
...
def test_normalize_4(t3):
    normalize._normalize(
        t3, peak_group_col="pid", sample_wise=False, value_col="area_chromatogram"
    )
    is_ = t3.normalized_area_chromatogram.to_list()
    print(t3)
...
def test_normalize_6(t_is):
    normalize._normalize(t_is, peak_group_col="pid", value_col="area_chromatogram")
...
def test_normalize_9(t4):
    normalize._normalize(t4, peak_group_col="pid", value_col="area_chromatogram")
...
def test_normalize_10(t4):
    normalize._normalize(
        t4, peak_group_col="pid", sample_wise=False, value_col="area_chromatogram"
    )
    is_ = t4.normalized_area_chromatogram.to_list()
    print(t4)
    expected = [0.625, None, 0.625, None, None]
...
def test_normalize_11(t5):
    normalize._normalize(t5, peak_group_col="pid", value_col="area_chromatogram")
...
def test_normalize_12(t5):
    normalize._normalize(
        t5, peak_group_col="pid", sample_wise=False, value_col="area_chromatogram"
    )
    is_ = t5.normalized_area_chromatogram.to_list()
    print(t5)
    expected = [0.625, None, 0.625, None, None]
...
def test_normalize_15(t6):
    normalize._normalize(t6, peak_group_col="pid", value_col="area_chromatogram")
