...
from daytona_api_client import CreateBuildInfo
...
class Daytona:
    ...
    def create_image(self, name: str, image: Image, *, verbose: bool = False, timeout: Optional[float] = 0) -> None:
        ...
        previous_state = None
        while built_image.state != ImageState.ACTIVE and built_image.state != ImageState.ERROR:
