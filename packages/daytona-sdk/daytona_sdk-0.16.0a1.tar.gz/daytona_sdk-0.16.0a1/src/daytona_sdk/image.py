...
from typing import Literal, Union, Optional, Sequence, List, Tuple, get_args
...
class Image(BaseModel):
    ...
    def pip_install_from_requirements(
        ...
        archive_path = ObjectStorage._compute_archive_base_path(requirements_txt)
    ...
    def pip_install_from_pyproject(
        ...
        return self.pip_install(*dependencies, find_links=find_links, index_url=index_url, extra_index_urls=extra_index_url, pre=pre, extra_options=extra_options)
    ...
    def add_local_file(self, local_path: Union[str, Path], remote_path: str) -> "Image":
        ...
        archive_path = ObjectStorage._compute_archive_base_path(local_path)
    ...
    @staticmethod
    def __process_python_version(
        python_version: Optional[str], allow_micro_granularity: bool = True
    ) -> str:
        ...
        python_series_requested = "{}.{}".format(*components)
