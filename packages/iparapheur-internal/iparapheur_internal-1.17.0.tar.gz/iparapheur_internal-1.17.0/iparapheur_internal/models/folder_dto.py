...
class FolderDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "dueDate", "metadata", "draftCreationDate", "type", "subtype", "originUser", "originDesk", "finalDesk", "isReadByCurrentUser", "legacyId", "typeId", "subtypeId", "stepList", "documentList", "signatureProofList", "readByUserIds", "readByCurrentUser"]
