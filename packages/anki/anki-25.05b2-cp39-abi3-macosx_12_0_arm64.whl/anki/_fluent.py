...
this option. '''
    ...
    def deck_config_ignore_before_info(self, included: str, total_cards: str) -> str:
        ...
        return self._translate(11, 93, {"included": included, "totalCards": total_cards})
...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 101, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 141, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_input(self, pct: str) -> str:
        r''' {$pct}% '''
        return self._translate(11, 143, {"pct": pct})


    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        r''' {$pct}% of {$reviews} reviews '''
        return self._translate(11, 144, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 146, {"num": num})


    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Minimum recommended retention: {$num} '''
        return self._translate(11, 147, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 167, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 213, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 214, {"decks": decks})
...
Please select  before proceeding. '''
    ...
    def statistics_memorized(self, memorized: str) -> str:
        ...
        return self._translate(32, 82, {"memorized": memorized})


    def statistics_minutes_per_day(self, count: int) -> str:
        r''' {$count} minutes/day '''
        return self._translate(32, 83, {"count": count})
    ...
    def statistics_notes(self, notes: int) -> str:
        r''' {$notes} notes '''
        return self._translate(32, 85, {"notes": notes})
    ...
    def statistics_retrievability_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 93, {"cards": cards, "percent": percent})


    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(32, 94, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(32, 96, {"count": count})
    ...
    def statistics_stability_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 103, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_stability_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day stability '''
        return self._translate(32, 104, {"cards": cards, "day": day})
...
({$secs-per-card}s/card) '''
        return self._translate(32, 106, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 109, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 113, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 54)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 55)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 56)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 57)
    DECK_CONFIG_DO_NOT_BURY = (11, 58)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 59)
    DECK_CONFIG_EASY_DAYS_CHANGE = (11, 60)
    DECK_CONFIG_EASY_DAYS_FRIDAY = (11, 61)
    DECK_CONFIG_EASY_DAYS_MINIMUM = (11, 62)
    DECK_CONFIG_EASY_DAYS_MONDAY = (11, 63)
    DECK_CONFIG_EASY_DAYS_NO_NORMAL_DAYS = (11, 64)
    DECK_CONFIG_EASY_DAYS_NORMAL = (11, 65)
    DECK_CONFIG_EASY_DAYS_REDUCED = (11, 66)
    DECK_CONFIG_EASY_DAYS_SATURDAY = (11, 67)
    DECK_CONFIG_EASY_DAYS_SUNDAY = (11, 68)
    DECK_CONFIG_EASY_DAYS_THURSDAY = (11, 69)
    DECK_CONFIG_EASY_DAYS_TITLE = (11, 70)
    DECK_CONFIG_EASY_DAYS_TUESDAY = (11, 71)
    DECK_CONFIG_EASY_DAYS_WEDNESDAY = (11, 72)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 73)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 74)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 75)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 76)
    DECK_CONFIG_FSRS_PARAMS_NO_REVIEWS = (11, 77)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 78)
    DECK_CONFIG_FSRS_SIMULATOR_EXPERIMENTAL = (11, 79)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_COUNT = (11, 80)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_MEMORIZED = (11, 81)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_COUNT = (11, 82)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_MEMORIZED = (11, 83)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_TIME = (11, 84)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 85)
    DECK_CONFIG_GET_PARAMS = (11, 86)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 87)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 88)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 89)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 90)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 91)
    DECK_CONFIG_IGNORE_BEFORE = (11, 92)
    DECK_CONFIG_IGNORE_BEFORE_INFO = (11, 93)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 94)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP_2 = (11, 95)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 96)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 97)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 98)
    DECK_CONFIG_INVALID_PARAMETERS = (11, 99)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 100)
    DECK_CONFIG_ITERATIONS = (11, 101)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 102)
    DECK_CONFIG_LEARNING_STEPS = (11, 103)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 104)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 105)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 106)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 107)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 108)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 109)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 110)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 111)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 112)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 113)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 114)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 115)
    DECK_CONFIG_NAME_PROMPT = (11, 116)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 117)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 118)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 119)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 120)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 121)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 122)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 123)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 124)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 125)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 126)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 127)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 128)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 129)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 130)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 131)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 132)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 133)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 134)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 135)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 136)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 137)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 138)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 139)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 140)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 141)
    DECK_CONFIG_ORDERING_TITLE = (11, 142)
    DECK_CONFIG_PERCENT_INPUT = (11, 143)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 144)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 145)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 146)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 147)
    DECK_CONFIG_QUESTION_ACTION = (11, 148)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 149)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 150)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 151)
    DECK_CONFIG_RELEARNING_STEPS = (11, 152)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 153)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 154)
    DECK_CONFIG_REMOVE_GROUP = (11, 155)
    DECK_CONFIG_RENAME_GROUP = (11, 156)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 157)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 158)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 159)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 160)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 161)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 162)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 163)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 164)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 165)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 166)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 167)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 168)
    DECK_CONFIG_SAVE_BUTTON = (11, 169)
    DECK_CONFIG_SAVE_OPTIONS_TO_PRESET = (11, 170)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 171)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 172)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 173)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 174)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 175)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 176)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 177)
    DECK_CONFIG_SHARED_PRESET = (11, 178)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 179)
    DECK_CONFIG_SHOW_REMINDER = (11, 180)
    DECK_CONFIG_SIMULATE = (11, 181)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 182)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 183)
    DECK_CONFIG_SMOOTH_GRAPH = (11, 184)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 185)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 186)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 187)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 188)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 189)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 190)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 191)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 192)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 193)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 194)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 195)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 196)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 197)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 198)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 199)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 200)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 201)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 202)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 203)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 204)
    DECK_CONFIG_SUSPEND_LEECHES = (11, 205)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 206)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 207)
    DECK_CONFIG_TIMER_TITLE = (11, 208)
    DECK_CONFIG_TITLE = (11, 209)
    DECK_CONFIG_TODAY_ONLY = (11, 210)
    DECK_CONFIG_TOO_SHORT_MAXIMUM_INTERVAL = (11, 211)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 212)
    DECK_CONFIG_UPDATING_CARDS = (11, 213)
    DECK_CONFIG_USED_BY_DECKS = (11, 214)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 215)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 216)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 217)
    DECK_CONFIG_WEIGHTS = (11, 218)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 219)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 220)
    DECK_CONFIG_WHICH_DECK = (11, 221)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 222)
    ...
    STATISTICS_MEDIAN_DIFFICULTY = (32, 78)
    STATISTICS_MEDIAN_EASE = (32, 79)
    STATISTICS_MEDIAN_INTERVAL = (32, 80)
    STATISTICS_MEDIAN_STABILITY = (32, 81)
    STATISTICS_MEMORIZED = (32, 82)
    STATISTICS_MINUTES_PER_DAY = (32, 83)
    STATISTICS_NO_DATA = (32, 84)
    STATISTICS_NOTES = (32, 85)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 86)
    STATISTICS_RANGE_ALL_HISTORY = (32, 87)
    STATISTICS_RANGE_ALL_TIME = (32, 88)
    STATISTICS_RANGE_COLLECTION = (32, 89)
    STATISTICS_RANGE_DECK = (32, 90)
    STATISTICS_RANGE_SEARCH = (32, 91)
    STATISTICS_RETRIEVABILITY_SUBTITLE = (32, 92)
    STATISTICS_RETRIEVABILITY_TOOLTIP = (32, 93)
    STATISTICS_REVIEWS = (32, 94)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 95)
    STATISTICS_REVIEWS_PER_DAY = (32, 96)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 97)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 98)
    STATISTICS_REVIEWS_TITLE = (32, 99)
    STATISTICS_RUNNING_TOTAL = (32, 100)
    STATISTICS_SAVE_PDF = (32, 101)
    STATISTICS_SAVED = (32, 102)
    STATISTICS_STABILITY_DAY_RANGE = (32, 103)
    STATISTICS_STABILITY_DAY_SINGLE = (32, 104)
    STATISTICS_STATS = (32, 105)
    STATISTICS_STUDIED_TODAY = (32, 106)
    STATISTICS_TITLE = (32, 107)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 108)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 109)
    STATISTICS_TODAY_NO_CARDS = (32, 110)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 111)
    STATISTICS_TODAY_TITLE = (32, 112)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 113)
    STATISTICS_TOTAL = (32, 114)
    STATISTICS_TRUE_RETENTION_ALL = (32, 115)
    STATISTICS_TRUE_RETENTION_ALL_TIME = (32, 116)
    STATISTICS_TRUE_RETENTION_COUNT = (32, 117)
    STATISTICS_TRUE_RETENTION_FAIL = (32, 118)
    STATISTICS_TRUE_RETENTION_MATURE = (32, 119)
    STATISTICS_TRUE_RETENTION_MONTH = (32, 120)
    STATISTICS_TRUE_RETENTION_NOT_APPLICABLE = (32, 121)
    STATISTICS_TRUE_RETENTION_PASS = (32, 122)
    STATISTICS_TRUE_RETENTION_RANGE = (32, 123)
    STATISTICS_TRUE_RETENTION_RETENTION = (32, 124)
    STATISTICS_TRUE_RETENTION_SUBTITLE = (32, 125)
    STATISTICS_TRUE_RETENTION_TITLE = (32, 126)
    STATISTICS_TRUE_RETENTION_TODAY = (32, 127)
    STATISTICS_TRUE_RETENTION_TOOLTIP = (32, 128)
    STATISTICS_TRUE_RETENTION_TOTAL = (32, 129)
    STATISTICS_TRUE_RETENTION_WEEK = (32, 130)
    STATISTICS_TRUE_RETENTION_YEAR = (32, 131)
    STATISTICS_TRUE_RETENTION_YESTERDAY = (32, 132)
    STATISTICS_TRUE_RETENTION_YOUNG = (32, 133)
    STUDYING_AGAIN = (33, 0)
