...
def get_full_objective_list():
    ...
    return get_last_story_objectives() + [
        ...
        KH2Objective("Reach Valor Level 7",formlevel.CheckLocation.Valor7,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATEST),
        ...
        KH2Objective("Reach Wisdom Level 7",formlevel.CheckLocation.Wisdom7,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATEST),
        ...
        KH2Objective("Reach Limit Level 7",formlevel.CheckLocation.Limit7,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATEST),
        ...
        KH2Objective("Reach Master Level 7",formlevel.CheckLocation.Master7,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATEST),
        ...
        KH2Objective("Reach Final Level 7",formlevel.CheckLocation.Final7,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATEST),
        # Puzzle
        ...
        KH2Objective("Complete the Daylight Puzzle",puzzlereward.CheckLocation.DaylightExecutivesRing,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATE),
        KH2Objective("Complete the Sunset Puzzle",puzzlereward.CheckLocation.SunsetGrandRibbon,ObjectiveType.WORLDPROGRESS,ObjectiveDifficulty.LATE),
        # Superbosses
