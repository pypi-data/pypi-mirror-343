...
class ServiceMixin(ClientABC):
    ...
    def get_service(self, **filterargs: Dict[str, Any]) -> APIResponse:
    ...
    def restart_dhcpd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def start_dnsmasq_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def stop_dnsmasq_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def restart_dpinger_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def start_dpinger_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def stop_dpinger_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def get_ntpd_service(self, *filterargs: Dict[str, Any]) -> APIResponse:
        """https://github.com/jaredhendrickson13/pfsense-api/blob/master/README.md#1-read-ntpd-service_"""
        url = "/api/v1/services/ntpd"
        return self.call(url=url, method="GET", payload=filterargs)

    def restart_ntpd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def create_ntpd_time_server(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def delete_ntpd_time_server(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def get_sshd_configuration(self, *filterargs: Dict[str, Any]) -> APIResponse:
        """https://github.com/jaredhendrickson13/pfsense-api/blob/master/README.md#1-read-sshd-configuration"""
        url = "/api/v1/services/sshd"
        return self.call(url=url, method="GET", payload=filterargs)

    def restart_sshd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def update_sshd_configuration(self, **args: Dict[str, Any]) -> APIResponse:
        """https://github.com/jaredhendrickson13/pfsense-api/blob/master/README.md#5-update-sshd-configuration"""
        url = "/api/v1/services/sshd"
        method = "PUT"
        return self.call(url=url, method=method, payload=args)

    def restart_syslogd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def start_syslogd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def stop_syslogd_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def restart_unbound_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def start_unbound_service(self, **args: Dict[str, Any]) -> APIResponse:
    ...
    def stop_unbound_service(self, **args: Dict[str, Any]) -> APIResponse:
