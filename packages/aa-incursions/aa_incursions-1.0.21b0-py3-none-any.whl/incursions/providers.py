...
APP_INFO_TEXT = f"AA-Incursions/{__version__} (+https://gitlab.com/tactical-supremacy/aa-incursions) AllianceAuth/{aa__version__} (+https://gitlab.com/allianceauth/allianceauth) DjangoESI/{esi__version__}"
