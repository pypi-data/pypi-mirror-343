...
class Questionnaire:
    ...
    def run_pipeline_on_questions(self, questions_ordinals, pipe, result_path, softmax, filters: Dict[str, dict], merge_filtered_positiveonly):
    ...
    def merge_unfiltered_into_positive_only(self, df_path: str) -> pd.DataFrame:
        ...
        merged = merged.rename(columns={"silhouette_score": "silhouette_score(unfiltered)"})
