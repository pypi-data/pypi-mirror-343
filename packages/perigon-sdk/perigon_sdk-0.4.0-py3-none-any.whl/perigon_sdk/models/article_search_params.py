...
class ArticleSearchParams(BaseModel):
    ...
    size: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(
        default=None,
        description="The number of items per page.   _Must be at least 1_.   _Default value 10_.",
    )
    page: Optional[Annotated[int, Field(le=10000, strict=True, ge=0)]] = Field(
        default=None,
        description="The page number to retrieve.   _Starting from 0_.   _Default value 0_.",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "filter": ArticleSearchFilter.from_dict(obj["filter"])
