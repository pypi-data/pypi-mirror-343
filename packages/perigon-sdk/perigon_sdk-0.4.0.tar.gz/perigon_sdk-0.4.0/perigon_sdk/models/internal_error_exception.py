...
class InternalErrorException(BaseModel):
    ...
    suppressed: Optional[List[AuthExceptionCause]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "cause": AuthExceptionCause.from_dict(obj["cause"])
                ...
                "suppressed": [
                    AuthExceptionCause.from_dict(_item) for _item in obj["suppressed"]
                ]
