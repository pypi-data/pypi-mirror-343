...
def parse_args(args=None):
    ...
    parser.add_argument('--model_path',
                        default=r'D:\Code\deep-learning-code\classification\yms_class\run\output\models\best_model.pt')
    parser.add_argument('--save_dir', default=r'D:\Code\deep-learning-code\classification\yms_class\run\output2')
