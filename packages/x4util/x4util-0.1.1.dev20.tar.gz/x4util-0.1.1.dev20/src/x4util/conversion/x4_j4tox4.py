...
def main():
  args=get_args(ver)
  j4_to_exfor(*get_input(args))


def j4_to_exfor(file_j4,file_dict,file_x4,force0):
  global dict_json
  global force
      ...
      if item["pointer"]==pointer:
        ...
        if keyword=="ANG-SEC" or\
          ...
          if item["coded_information"] is not None:
            ...
            if "institute" in item["coded_information"]:
          ...
          if item["coded_information"] is not None:
            ...
            if item["coded_information"]["reaction"] is not None:
              f.write("("+item["coded_information"]["incident_source"]+"="+\
                          item["coded_information"]["reaction"]+")")
          ...
          if item["coded_information"] is not None:
            if item["coded_information"]["flag"] is not None:
              f.write("("+coded_information["flag"]+")")
            f.write(item["coded_information"]["nuclide"])
          ...
          if item["coded_information"] is not None:
            ...
            if item["coded_information"]["subaccession_number"] is not None:
              f.write(item["coded_information"]["code"]["subaccession_number"]+",")
            else:
              f.write(",")
            if item["coded_information"]["author"] is not None:
              f.write(item["coded_information"]["author"]+",")
...
def read_x4json(file_x4):
  ...
  if x4_json["name"][0:18]!="J4 - EXFOR in JSON":
...
def get_args(ver):
  ...
  parser=argparse.ArgumentParser(\
   ...
   epilog="example: x4_j4tox4.py -i exfor.json -d dict_9130.json -o exfor.txt")
  ...
  parser.add_argument("-o", "--file_x4",\
   help="name of output EXFOR file")
...
def get_input(args):
  ...
  if file_j4 is None:
    file_j4=input("JSON file [exfor.json] ------------------> ")
    if file_j4=="":
      file_j4="exfor.json"
