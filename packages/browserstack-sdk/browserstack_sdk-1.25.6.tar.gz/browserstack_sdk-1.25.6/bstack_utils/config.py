...
conf = {
    bstack1l11lll_opy_ (u"ࠧࡢࡲࡳࡣࡦࡻࡴࡰ࡯ࡤࡸࡪ࠭ᙬ"): False,
    bstack1l11lll_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫ࡠࡵࡨࡷࡸ࡯࡯࡯ࠩ᙭"): True,
    bstack1l11lll_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨ᙮"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack1lll1l1lll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11lll111l11_opy_=None):
        return self._11lll1111ll_opy_.get(property_name, bstack11lll111l11_opy_)
    def bstack111111l1l_opy_(self, property_name, bstack11lll111l1l_opy_):
        self._11lll1111ll_opy_[property_name] = bstack11lll111l1l_opy_
    def bstack1l1ll1111_opy_(self, val):
        self._11lll1111ll_opy_[bstack1l11lll_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᙯ")] = bool(val)
    def bstack1111llll11_opy_(self):
        return self._11lll1111ll_opy_.get(bstack1l11lll_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪᙰ"), False)