...
def test_generate_data_success(tmp_path: str, synthex: Synthex, generate_data_params: dict[Any, Any]):
    """
...
@pytest.mark.integration
def test_generate_data_check_number_of_samples(
    tmp_path: str, synthex: Synthex, generate_data_params: dict[Any, Any]
):
    """
    Test case for validating the number of datapoints generated by the `generate_data` method of
    the `Synthex` class. This test ensures that the number of datapoints in the generated output 
    is either grater than the `number_of_samples` parameter, or, if less than `number_of_samples`,
    it differs from it by no more than 5.
    Args:
...
def test_generate_data_output_path_no_filename(
    ...
    correct_output_path = f"{tmp_path}/test_data/{OUTPUT_FILE_DEFAULT_NAME(generate_data_params["output_type"])}"
