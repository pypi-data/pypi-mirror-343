...
@pytest.mark.unit
@responses.activate
def test_create_job_success(synthex: Synthex, generate_data_params: dict[Any, Any]):
    """
...
@pytest.mark.unit
@responses.activate
def test_create_job_service_validation_error(synthex: Synthex, generate_data_params: dict[Any, Any]):
    """
    ...
    try:
        ...
        pytest.fail("Expected ValidationError when the job ID is None")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"field": {"type": "string"}}, [{"field": "key"}], [], 1200), # wrong number of samples, too high
    ]
)
def test_create_job_argument_validation_error(
    ...
    try:
        ...
        pytest.fail("Expected ValidationError when an incorrect parameter is provided")