...
@pytest.mark.unit
@responses.activate
def test_get_job_data_206_success(synthex: Synthex):
    """
...
@pytest.mark.unit
@responses.activate
def test_get_job_data_200_success(synthex: Synthex):
    """
...
@pytest.mark.unit
@responses.activate
def test_get_job_data_validation_error(synthex: Synthex):
    """
    ...
    try:
        ...
        pytest.fail("Expected ValidationError when response data is None")