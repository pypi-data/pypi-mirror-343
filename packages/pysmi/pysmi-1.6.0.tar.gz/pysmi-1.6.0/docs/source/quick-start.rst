...
.. note::
   ...
   The output file format can also be Python, if you prefer. You can use
   ``--destination-format pysnmp`` option to generate Python files. Those files
   can be used with PySNMP library to build SNMP agents or managers.
