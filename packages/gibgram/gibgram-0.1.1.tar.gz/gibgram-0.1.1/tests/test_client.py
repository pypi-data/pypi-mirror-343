"""
Tests for the TGrab client module.
"""
...
from tgrab.client import TGrabClient

class TestTGrabClient(unittest.TestCase):
    """Tests for the TGrabClient class."""
    
    def setUp(self):
        """Set up test fixtures."""
        self.client = TGrabClient(
            api_id=123456,
            api_hash="test_hash",
            phone="+1234567890",
