...
class AgentGeoSearchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "direction", "cutoff", "search_text", "semantic_search", "prioritise_asi1_agents", "offset", "limit", "geo_filter", "search_id", "source"]
