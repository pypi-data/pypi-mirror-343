...
class AgentSearchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "direction", "cutoff", "search_text", "semantic_search", "prioritise_asi1_agents", "offset", "limit", "search_id", "source", "only_current_campaign_eligible"]
