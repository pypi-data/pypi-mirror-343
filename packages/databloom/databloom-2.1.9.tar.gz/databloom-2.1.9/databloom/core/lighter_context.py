...
class LighterContext:
    ...
    def _create_session(self, executors=None, env_vars={}):
        ...
        config = {
            ...
            "name": "PySpark Job",
            "conf": {
                "spark.kubernetes.container.image": "registry.ird.vng.vn/databloom/databloom-worker:2.1.6",
                ...
                "spark.sql.catalog.nessie.uri": os.getenv("NESSIE_URI", "https://nessie-api.ird.vng.vn/api/v1"),
