...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_url=None, content_guard=None, hidden=False, name=None, base_path=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
