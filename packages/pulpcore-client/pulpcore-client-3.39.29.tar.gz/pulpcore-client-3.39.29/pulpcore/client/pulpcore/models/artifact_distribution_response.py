...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, hidden=False, name=None, pulp_href=None, base_path=None, content_guard=None, base_url=None, local_vars_configuration=None):  # noqa: E501
