...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_href=None, pulp_last_updated=None, pulp_labels=None, no_content_change_since=None, name=None, pulp_created=None, base_path=None, hidden=False, content_guard=None, prn=None, local_vars_configuration=None):  # noqa: E501
