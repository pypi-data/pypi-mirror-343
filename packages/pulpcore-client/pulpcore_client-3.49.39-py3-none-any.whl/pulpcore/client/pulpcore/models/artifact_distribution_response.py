...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, hidden=False, pulp_labels=None, name=None, pulp_created=None, pulp_href=None, pulp_last_updated=None, base_url=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
