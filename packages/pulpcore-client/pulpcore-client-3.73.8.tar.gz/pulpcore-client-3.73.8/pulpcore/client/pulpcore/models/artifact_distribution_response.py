...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "name", "content_guard", "no_content_change_since", "hidden", "pulp_last_updated", "base_url", "pulp_labels", "base_path", "pulp_href", "prn"]
