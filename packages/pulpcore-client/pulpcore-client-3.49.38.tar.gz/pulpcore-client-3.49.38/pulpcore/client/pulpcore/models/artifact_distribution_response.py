...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_created=None, pulp_labels=None, pulp_last_updated=None, name=None, hidden=False, base_path=None, pulp_href=None, base_url=None, local_vars_configuration=None):  # noqa: E501
