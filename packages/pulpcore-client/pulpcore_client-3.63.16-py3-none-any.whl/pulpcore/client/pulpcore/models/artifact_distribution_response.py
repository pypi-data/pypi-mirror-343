...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_last_updated=None, base_path=None, hidden=False, pulp_href=None, name=None, no_content_change_since=None, pulp_labels=None, content_guard=None, pulp_created=None, prn=None, local_vars_configuration=None):  # noqa: E501
