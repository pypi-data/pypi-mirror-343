...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "no_content_change_since", "pulp_last_updated", "pulp_labels", "base_path", "base_url", "pulp_created", "name", "content_guard", "hidden", "pulp_href"]
