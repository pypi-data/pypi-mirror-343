...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "base_path", "pulp_last_updated", "prn", "no_content_change_since", "pulp_href", "name", "content_guard", "pulp_labels", "base_url", "pulp_created"]
