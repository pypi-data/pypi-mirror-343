...
def classify(name,
    ...
    if search == False:
        ...
        if force_search:
            return response.output[1].content[0].text, response.output[1].content[0].annotations
        else:
            try:
                return response.output[0].content[0].text, response.output[0].content[0].annotations
            except:
                return response.output[1].content[0].text, response.output[1].content[0].annotations