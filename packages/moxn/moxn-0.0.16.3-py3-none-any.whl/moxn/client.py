...
class MoxnClient(TelemetryTransportBackend):
    ...
    def __init__(self) -> None:
        ...
        transport = APITelemetryTransport(
            backend=self, user_id=self.settings.user_id, org_id=self.settings.org_id
        )
    ...
    def log_event(
        self,
    ) -> Callable[[LLMEvent, Optional[UUID]], Coroutine[None, None, None]]:
