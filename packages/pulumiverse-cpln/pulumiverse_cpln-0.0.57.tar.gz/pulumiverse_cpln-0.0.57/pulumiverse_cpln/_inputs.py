...
if not MYPY:
    class Mk8sTritonProviderArgsDict(TypedDict):
        ...
        Default image for all nodes.
        """
        load_balancer: pulumi.Input['Mk8sTritonProviderLoadBalancerArgsDict']
        location: pulumi.Input[str]
        """
...
class Mk8sTritonProviderArgs:
    def __init__(__self__, *,
                 ...
                 image_id: pulumi.Input[str],
                 load_balancer: pulumi.Input['Mk8sTritonProviderLoadBalancerArgs'],
                 location: pulumi.Input[str],
    ...
    def load_balancer(self) -> pulumi.Input['Mk8sTritonProviderLoadBalancerArgs']:
        return pulumi.get(self, "load_balancer")

    @load_balancer.setter
    def load_balancer(self, value: pulumi.Input['Mk8sTritonProviderLoadBalancerArgs']):
...
if not MYPY:
    class Mk8sTritonProviderLoadBalancerManualArgsDict(TypedDict):
        cns_internal_domain: pulumi.Input[str]
        cns_public_domain: pulumi.Input[str]
        count: pulumi.Input[int]
        image_id: pulumi.Input[str]
        package_id: pulumi.Input[str]
        public_network_id: pulumi.Input[str]
        """
...
class Mk8sTritonProviderLoadBalancerManualArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] metadata: Extra tags to attach to instances from a node pool.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] private_network_ids: More private networks to join.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Extra tags to attach to instances from a node pool.
        """
    ...
    def public_network_id(self) -> pulumi.Input[str]:
        """
        If set, machine will also get a public IP.
        """
    ...
    def public_network_id(self, value: pulumi.Input[str]):
